  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_oauth_scopes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_oauth_scopes_mob_form();
	}
...
?>
  ...
  // ---------- Validate scope
  function do_ajax_form_oauth_scopes_mob_validate_scope()
  {
    var nomeCampo_scope = "scope";
    var var_scope = scAjaxGetFieldText(nomeCampo_scope);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_scopes_mob_validate_scope(var_scope, var_script_case_init, do_ajax_form_oauth_scopes_mob_validate_scope_cb);
  } // do_ajax_form_oauth_scopes_mob_validate_scope

  function do_ajax_form_oauth_scopes_mob_validate_scope_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_scopes_mob_validate_scope_cb

  // ---------- Validate is_default
  function do_ajax_form_oauth_scopes_mob_validate_is_default()
  {
    var nomeCampo_is_default = "is_default";
    var var_is_default = scAjaxGetFieldText(nomeCampo_is_default);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_scopes_mob_validate_is_default(var_is_default, var_script_case_init, do_ajax_form_oauth_scopes_mob_validate_is_default_cb);
  } // do_ajax_form_oauth_scopes_mob_validate_is_default

  function do_ajax_form_oauth_scopes_mob_validate_is_default_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "is_default";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_scopes_mob_validate_is_default_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_oauth_scopes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_oauth_scopes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_scope = scAjaxGetFieldText("scope");
    var var_is_default = scAjaxGetFieldText("is_default");
    ...
    scAjaxProcOn();
    x_ajax_form_oauth_scopes_mob_submit_form(var_scope, var_is_default, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_oauth_scopes_mob_submit_form_cb);
  } // do_ajax_form_oauth_scopes_mob_submit_form

  function do_ajax_form_oauth_scopes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("is_default");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_oauth_scopes_mob_submit_form_cb_after_alert);
  } // do_ajax_form_oauth_scopes_mob_submit_form_cb
  function do_ajax_form_oauth_scopes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_oauth_scopes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_oauth_scopes_mob_navigate_form()
  {
    perform_ajax_form_oauth_scopes_mob_navigate_form();
  }

  function perform_ajax_form_oauth_scopes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("scope");
    scAjaxHideErrorDisplay("is_default");
    var var_scope = document.F2.scope.value;
    ...
    scAjaxProcOn();
    x_ajax_form_oauth_scopes_mob_navigate_form(var_scope, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_oauth_scopes_mob_navigate_form_cb);
  } // do_ajax_form_oauth_scopes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_oauth_scopes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_oauth_scopes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.scope.value = scAjaxGetKeyValue("scope");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_oauth_scopes_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_oauth_scopes_mob_navigate_form_cb
  function do_ajax_form_oauth_scopes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_oauth_scopes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_oauth_scopes_mob_navigate_form_cb_after_alert
  function sc_hide_form_oauth_scopes_mob_form()
  {
  ...
  ajax_field_list[0] = "scope";
  ajax_field_list[1] = "is_default";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "scope": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_scopes_fld_scope'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "is_default": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_scopes_fld_is_default'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["is_default"][1] = "is_default";

  var ajax_field_id = {
    "scope": new Array("hidden_field_label_scope", "hidden_field_data_scope"),
    "is_default": new Array("hidden_field_label_is_default", "hidden_field_data_is_default")
  };
