...
class grid_ado_records_bck1_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_gender = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['arr_total']['gender'];
      }
      else
      {
          $this->array_total_gender = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['arr_total']['gender'] = $this->array_total_gender;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['labels']['gender'] = $Lab_gender; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['summarizing_fields_order']['Gender']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['summarizing_fields_order']['Gender'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['summarizing_fields_order']['Gender'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['summarizing_fields_display']['Gender'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['summarizing_fields_display']['Gender'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['summarizing_fields_display']['Gender'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['summarizing_fields_display']['Gender'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['summarizing_fields_display']['Gender'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['summarizing_fields_display']['Gender'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['summarizing_fields_display']['Gender'] as $i_sum => $d_sum)
           {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_Gender("res");
