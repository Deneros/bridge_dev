...
class grid_ado_records_bck1_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_ado_records_bck1.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_ado_records_bck1']['contr_erro'] = 'off'; 
   ...
   function NM_export_btnimagenes()
   {
         ...
         $this->btnimagenes = str_replace('<', '&lt;', $this->btnimagenes);
         $this->btnimagenes = str_replace('>', '&gt;', $this->btnimagenes);
         $this->Texto_tag .= "<td>" . $this->btnimagenes . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
