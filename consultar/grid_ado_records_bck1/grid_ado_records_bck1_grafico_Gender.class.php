...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['contr_label_graf']['gender']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['contr_label_graf']['gender']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck1']['contr_label_graf']['gender'];
      }
   }
