...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_public_key_cond" name="public_key_cond" onChange="nm_campos_between(document.getElementById('id_vis_public_key'), this, 'public_key')">
      ...
      <br><span id="id_hide_public_key"  <?php echo $str_hide_public_key?>><?php
      if ($public_key != "")
      {
      $public_key_look = substr($this->Db->qstr($public_key), 1, -1); 
      $nmgp_def_dados = array(); 
