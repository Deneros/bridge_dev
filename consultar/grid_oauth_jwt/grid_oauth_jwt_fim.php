...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_oauth_jwt"]))
   {
      unset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_oauth_jwt"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_oauth_jwt'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_jwt']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_oauth_jwt']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_jwt']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_oauth_jwt']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_oauth_jwt']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_jwt']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_oauth_jwt']['embutida_filho'] as $ind => $sc_init)
          {
