...
<?php
   ...
   $Ord_Cmp = new grid_ado_records_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_ado_records_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["record"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["record"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["record"] : "" . $this->Nm_lang['lang_ado_records_fld_Record'] . "";
   $tab_ger_campos['startingdate'] = "on";
   $tab_def_campos['startingdate'] = "StartingDate";
   $tab_labels["startingdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["startingdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["startingdate"] : "" . $this->Nm_lang['lang_ado_records_fld_StartingDate'] . "";
   $tab_ger_campos['creationip'] = "on";
   $tab_def_campos['creationip'] = "CreationIP";
   $tab_labels["creationip"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["creationip"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["creationip"] : "" . $this->Nm_lang['lang_ado_records_fld_CreationIP'] . "";
   $tab_ger_campos['idnumber'] = "on";
   $tab_def_campos['idnumber'] = "IdNumber";
   $tab_labels["idnumber"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["idnumber"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["idnumber"] : "" . $this->Nm_lang['lang_ado_records_fld_IdNumber'] . "";
   $tab_ger_campos['firstname'] = "on";
   $tab_def_campos['firstname'] = "FirstName";
   $tab_labels["firstname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["firstname"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["firstname"] : "" . $this->Nm_lang['lang_ado_records_fld_FirstName'] . "";
   $tab_ger_campos['secondname'] = "on";
   $tab_def_campos['secondname'] = "SecondName";
   $tab_labels["secondname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["secondname"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["secondname"] : "" . $this->Nm_lang['lang_ado_records_fld_SecondName'] . "";
   $tab_ger_campos['firstsurname'] = "on";
   $tab_def_campos['firstsurname'] = "FirstSurname";
   $tab_labels["firstsurname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["firstsurname"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["firstsurname"] : "" . $this->Nm_lang['lang_ado_records_fld_FirstSurname'] . "";
   $tab_ger_campos['secondsurname'] = "on";
   $tab_def_campos['secondsurname'] = "SecondSurname";
   $tab_labels["secondsurname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["secondsurname"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["secondsurname"] : "" . $this->Nm_lang['lang_ado_records_fld_SecondSurname'] . "";
   $tab_ger_campos['gender'] = "on";
   $tab_def_campos['gender'] = "Gender";
   $tab_labels["gender"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["gender"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["gender"] : "" . $this->Nm_lang['lang_ado_records_fld_Gender'] . "";
   $tab_ger_campos['issuedate'] = "on";
   $tab_def_campos['issuedate'] = "IssueDate";
   $tab_labels["issuedate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["issuedate"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["issuedate"] : "" . $this->Nm_lang['lang_ado_records_fld_IssueDate'] . "";
   $tab_ger_campos['birthdate'] = "on";
   $tab_def_campos['birthdate'] = "BirthDate";
   $tab_labels["birthdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["birthdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["birthdate"] : "" . $this->Nm_lang['lang_ado_records_fld_BirthDate'] . "";
   $tab_ger_campos['placebirth'] = "on";
   $tab_def_campos['placebirth'] = "PlaceBirth";
   $tab_labels["placebirth"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["placebirth"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["placebirth"] : "" . $this->Nm_lang['lang_ado_records_fld_PlaceBirth'] . "";
   $tab_ger_campos['transactiontypename'] = "on";
   $tab_def_campos['transactiontypename'] = "TransactionTypeName";
   $tab_labels["transactiontypename"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["transactiontypename"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["transactiontypename"] : "" . $this->Nm_lang['lang_ado_records_fld_TransactionTypeName'] . "";
   $tab_ger_campos['transactionid'] = "on";
   $tab_def_campos['transactionid'] = "TransactionId";
   $tab_labels["transactionid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["transactionid"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["transactionid"] : "" . $this->Nm_lang['lang_ado_records_fld_TransactionId'] . "";
   $tab_ger_campos['extras'] = "on";
   $tab_def_campos['extras'] = "Extras";
   $tab_labels["extras"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["extras"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["extras"] : "" . $this->Nm_lang['lang_ado_records_fld_Extras'] . "";
   ...
   $tab_labels["btnimagenes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["btnimagenes"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["btnimagenes"] : "" . $this->Nm_lang['lang_ado_records_btn_img'] . "";
   $tab_ger_campos['btnficha'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['btnficha'] = "btnficha";
   }
   else
   {
       $tab_def_campos['btnficha'] = "";
   }
   $tab_labels["btnficha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["btnficha"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['labels']["btnficha"] : "" . $this->Nm_lang['lang_ado_records_btn_ficha'] . "";
   $tab_ger_campos['btnimagenes'] = "none";
   $tab_ger_campos['btnficha'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_ado_records']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ado_records']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_ado_records_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_ado_records']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
