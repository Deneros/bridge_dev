...
class grid_ado_records_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_creationip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['arr_total']['creationip'];
      }
      else
      {
          $this->array_total_creationip = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['arr_total']['creationip'] = $this->array_total_creationip;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['labels']['creationip'] = $Lab_creationip; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['summarizing_fields_order']['CreationIP']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['summarizing_fields_order']['CreationIP'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['summarizing_fields_order']['CreationIP'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['summarizing_fields_display']['CreationIP'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['summarizing_fields_display']['CreationIP'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['summarizing_fields_display']['CreationIP'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['summarizing_fields_display']['CreationIP'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['summarizing_fields_display']['CreationIP'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['summarizing_fields_display']['CreationIP'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['summarizing_fields_display']['CreationIP'] as $i_sum => $d_sum)
           {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['pivot_order_level'] = -1;
       }
