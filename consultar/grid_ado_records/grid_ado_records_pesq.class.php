...
class grid_ado_records_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_ado_records_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_ado_records_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_ado_records_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_ado_records/grid_ado_records_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_ado_records_ajax_search.js"></script>
 <script type="text/javascript" src="grid_ado_records_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_ado_records_message.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $idnumber = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['idnumber']; 
          $idnumber_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['idnumber_cond']; 
          $firstname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['firstname']; 
          $firstname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['firstname_cond']; 
          $secondname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['secondname']; 
          $secondname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['secondname_cond']; 
          $gender = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['gender']; 
          $gender_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['gender_cond']; 
          $issuedate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_dia']; 
          $issuedate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_mes']; 
          $issuedate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_ano']; 
          $issuedate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_input_2_dia']; 
          $issuedate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_input_2_mes']; 
          $issuedate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_input_2_ano']; 
          $issuedate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_cond']; 
          $birthdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_dia']; 
          $birthdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_mes']; 
          $birthdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_ano']; 
          $birthdate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_input_2_dia']; 
          $birthdate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_input_2_mes']; 
          $birthdate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_input_2_ano']; 
          $birthdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_cond']; 
          $placebirth = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['placebirth']; 
          $placebirth_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['placebirth_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['NM_operador']; 
      } 
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_ado_records_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_birthdate_dia').bind('change', function() {sc_grid_ado_records_valida_dia(this)});
    $('#SC_birthdate_input_2_dia').bind('change', function() {sc_grid_ado_records_valida_dia(this)});
    $('#SC_birthdate_input_2_mes').bind('change', function() {sc_grid_ado_records_valida_mes(this)});
    $('#SC_birthdate_mes').bind('change', function() {sc_grid_ado_records_valida_mes(this)});
    $('#SC_issuedate_dia').bind('change', function() {sc_grid_ado_records_valida_dia(this)});
    $('#SC_issuedate_input_2_dia').bind('change', function() {sc_grid_ado_records_valida_dia(this)});
    $('#SC_issuedate_input_2_mes').bind('change', function() {sc_grid_ado_records_valida_mes(this)});
    $('#SC_issuedate_mes').bind('change', function() {sc_grid_ado_records_valida_mes(this)});
 }
 function sc_grid_ado_records_valida_dia(obj)
 {
 ...
 function sc_grid_ado_records_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['psq_check_ret']['gender'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['idnumber'] = $idnumber; 
      if (is_array($idnumber) && !empty($idnumber))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0] = $idnumber;
      }
      elseif ($idnumber_cond_salva == "nu" || $idnumber_cond_salva == "nn" || $idnumber_cond_salva == "ep" || $idnumber_cond_salva == "ne" || !empty($idnumber))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0][0] = $idnumber;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['idnumber_cond'] = $idnumber_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['cmp'] = "idnumber"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['opc'] = $idnumber_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq']['idnumber'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['firstname'] = $firstname; 
      if (is_array($firstname) && !empty($firstname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0] = $firstname;
      }
      elseif ($firstname_cond_salva == "nu" || $firstname_cond_salva == "nn" || $firstname_cond_salva == "ep" || $firstname_cond_salva == "ne" || !empty($firstname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0][0] = $firstname;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['firstname_cond'] = $firstname_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['cmp'] = "firstname"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['opc'] = $firstname_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq']['firstname'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['secondname'] = $secondname; 
      if (is_array($secondname) && !empty($secondname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0] = $secondname;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0][0] = $secondname;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['secondname_cond'] = $secondname_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['cmp'] = "secondname"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['opc'] = $secondname_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq']['secondname'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['gender'] = $gender; 
      if (is_array($gender) && !empty($gender))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0] = $gender;
      }
      elseif ($gender_cond_salva == "nu" || $gender_cond_salva == "nn" || $gender_cond_salva == "ep" || $gender_cond_salva == "ne" || !empty($gender))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0][0] = $gender;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['gender_cond'] = $gender_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['cmp'] = "gender"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['opc'] = $gender_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq']['gender'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_dia'] = $issuedate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_mes'] = $issuedate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_ano'] = $issuedate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_input_2_dia'] = $issuedate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_input_2_mes'] = $issuedate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_input_2_ano'] = $issuedate_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $issuedate_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $issuedate_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $issuedate_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $issuedate_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $issuedate_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $issuedate_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_cond'] = $issuedate_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['cmp'] = "issuedate"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['opc'] = $issuedate_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq']['issuedate'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_dia'] = $birthdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_mes'] = $birthdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_ano'] = $birthdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_input_2_dia'] = $birthdate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_input_2_mes'] = $birthdate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_input_2_ano'] = $birthdate_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $birthdate_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $birthdate_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $birthdate_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $birthdate_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $birthdate_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $birthdate_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_cond'] = $birthdate_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['cmp'] = "birthdate"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['opc'] = $birthdate_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq']['birthdate'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['placebirth'] = $placebirth; 
      if (is_array($placebirth) && !empty($placebirth))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0] = $placebirth;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['val'][0][0] = $placebirth;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['placebirth_cond'] = $placebirth_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['cmp'] = "placebirth"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid]['opc'] = $placebirth_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq']['placebirth'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($placebirth != '') {
      ...
      if ($issuedate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate'] = $val[0];
          ...
          if ($issuedate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['issuedate_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq']['issuedate']['label'] = $nmgp_tab_label['issuedate'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq']['issuedate']['descr'] = $nmgp_tab_label['issuedate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq']['issuedate']['hint']  = $nmgp_tab_label['issuedate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      if ($birthdate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate'] = $val[0];
          ...
          if ($birthdate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']['birthdate_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq']['birthdate']['label'] = $nmgp_tab_label['birthdate'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq']['birthdate']['descr'] = $nmgp_tab_label['birthdate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['grid_pesq']['birthdate']['hint']  = $nmgp_tab_label['birthdate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records']['cond_pesq'] .= $this->NM_operador;
