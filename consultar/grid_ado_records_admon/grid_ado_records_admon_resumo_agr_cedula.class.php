...
class grid_ado_records_admon_resumo
{
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_idnumber = array();
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_idnumber = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['arr_total']['idnumber'];
      }
      else
      {
          $this->array_total_idnumber = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['tot_geral'][1];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['arr_total']['idnumber'] = $this->array_total_idnumber;
   ...
   function completeMatrix()
   {
       ...
       {
          $Lab_idnumber = "IdNumber";
       }
       else
       {
       $Lab_idnumber = "" . $this->Ini->Nm_lang['lang_ado_records_fld_IdNumber'] . "";
       }
       $this->comp_field = array(
           $Lab_idnumber,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['idnumber'] = $Lab_idnumber; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_order']['agr_cedula']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_order']['agr_cedula'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_order']['agr_cedula'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['agr_cedula'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['agr_cedula'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['agr_cedula'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['agr_cedula'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['agr_cedula'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['agr_cedula'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['agr_cedula'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_idnumber as $i_idnumber => $d_idnumber) {
           if (!in_array($i_idnumber, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_idnumber[3] ] = $d_idnumber[2];
               $this->comp_label[0][ $d_idnumber[3] ] = $d_idnumber[2];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'idnumber', 'prot' => '@aspass@'),
       );
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_level'] = -1;
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_idnumber => $l_idnumber) {
           if (isset($this->array_total_idnumber[$i_idnumber])) {
               $this->comp_group[$i_idnumber] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_idnumber;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_idnumber)),
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_agr_cedula("res");
      ...
      ksort($this->array_total_idnumber);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_ado_records_admon/grid_ado_records_admon_config_graf_flash.php?nome_apl=grid_ado_records_admon&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_idnumber, $quebra_idnumber_orig)
   {
      //----- idnumber
      if (!isset($this->array_total_idnumber[$quebra_idnumber_orig]))
      {
         $this->array_total_idnumber[$quebra_idnumber_orig][0] = 1;
         $this->array_total_idnumber[$quebra_idnumber_orig][1] = 1;
         $this->array_total_idnumber[$quebra_idnumber_orig][2] = $quebra_idnumber;
         $this->array_total_idnumber[$quebra_idnumber_orig][3] = $quebra_idnumber_orig;
      }
      else
      {
         $this->array_total_idnumber[$quebra_idnumber_orig][0]++;
         $this->array_total_idnumber[$quebra_idnumber_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'idnumber');
     $campos_order = $this->Ini->Get_date_order_groupby("IdNumber", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->idnumber_orig = $this->idnumber;
            $this->gender = $this->look_gender ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->idnumber, $this->idnumber_orig);
            }
   }
//
