...
class grid_ado_records_admon_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_gender = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['arr_total']['gender'];
      }
      else
      {
          $this->array_total_gender = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['arr_total']['gender'] = $this->array_total_gender;
   ...
   function completeMatrix()
   {
       ...
       {
       $Lab_gender = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Gender'] . "";
       }
       $this->comp_field = array(
           $Lab_gender,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['gender'] = $Lab_gender; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_order']['agr_genero']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_order']['agr_genero'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_order']['agr_genero'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['agr_genero'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['agr_genero'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['agr_genero'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['agr_genero'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['agr_genero'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['agr_genero'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['agr_genero'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_gender as $i_gender => $d_gender) {
           if (!in_array($i_gender, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_gender[3] ] = $d_gender[2];
               $this->comp_label[0][ $d_gender[3] ] = $d_gender[2];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_gender => $l_gender) {
           if (isset($this->array_total_gender[$i_gender])) {
               $this->comp_group[$i_gender] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_gender;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_agr_genero("res");
...
//--- 
   ...
   {
      //----- gender
      if (!isset($this->array_total_gender[$quebra_gender_orig]))
      {
         $this->array_total_gender[$quebra_gender_orig][0] = 1;
         $this->array_total_gender[$quebra_gender_orig][1] = 1;
         $this->array_total_gender[$quebra_gender_orig][2] = $quebra_gender;
         $this->array_total_gender[$quebra_gender_orig][3] = $quebra_gender_orig;
      }
      else
      {
         $this->array_total_gender[$quebra_gender_orig][0]++;
         $this->array_total_gender[$quebra_gender_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'gender');
     $campos_order = $this->Ini->Get_date_order_groupby("Gender", 'asc', $format, $campos_order);
