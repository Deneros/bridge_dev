<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_ado_records_admon']['glo_nm_path_imag_temp'] . "/sc_apl_default_OpenIdConnect.txt"))
       {
?>
...
<?php
   ...
   $Sel_Groupby = new grid_ado_records_admon_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class grid_ado_records_admon_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   if ($this->restore) {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['dados_orig_gb']['all']['SC_Ind_Groupby'];
   }
   else {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Ind_Groupby'];
   }
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['Page_break_PDF']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['pivot_order_start']);
       unset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['pivot_tabular']);
           ...
           $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Gb_Free_cmp']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Gb_Free_sql']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Gb_date_format']['sc_free_group_by'] = array();
           $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Gb_Free_orig'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Gb_Free_sql'][$cada_cmp][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
                   $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Gb_date_format']['sc_free_group_by'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['format'];
               }
           }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo" && !empty($this->summ_fields))
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       if(isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_fields_display'][ $sel_groupby ]))
       {
           foreach ($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_fields_display'][ $sel_groupby ] as $i_sum => $d_sum)
           {
               $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_fields_display'][ $sel_groupby ][$i_sum]['display'] = in_array($i_sum, $summ_fields);
           }
       }
       $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_fields_order'][ $sel_groupby ] = $summ_fields;
       $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_drill_down'] = $this->drill_down;
   }
?>
    <script language="javascript"> 
<?php
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "grid_ado_records_admon_sel_groupby.php",
    data: {
...
<?php
if ($this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['dados_orig_gb']['res']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['dados_orig_gb']['res']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
...
elseif (!$this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
        if(is_array($_arr_fields))
        {
            foreach ($_arr_fields as $_key_total => $d_field)
...
{
  $max_height = 1;
  if ($this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['dados_orig_gb']['res']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['dados_orig_gb']['res']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
  ...
  elseif (!$this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
      if (count($_i_sum) > $max_height)
      {
          $max_height = count($_i_sum);
...
<?php
if ($bSummaryPage && $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Ind_Groupby'] == "sc_free_group_by") {
?>
   if (fieldList == "") {
...
<?php
    ...
    $iTabCount            = 1;
    foreach ($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_All_Groupby'] as $QB => $Tp)
    {
        if (!in_array($QB, $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Groupby_hide']))
        {
...
<?php
     if (!in_array("agr_genero", $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Groupby_hide']))
     {
         $this->static_gb_ok = "sc_id_sel_groupby_agr_genero";
        if ($groupby_atual == "agr_genero")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_agr_genero";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_agr_genero");display_btn_restore_gb();' name="sel_groupby" value="agr_genero" id="sc_id_sel_groupby_agr_genero"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_agr_genero">
        <?php echo $this->Nm_lang['lang_ado_records_fld_Gender'] ?>
<?php
    $prep_labels = array();
...
?>
<?php
     if (!in_array("agr_cedula", $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "agr_cedula")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_agr_cedula";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_agr_cedula");display_btn_restore_gb();' name="sel_groupby" value="agr_cedula" id="sc_id_sel_groupby_agr_cedula"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_agr_cedula">
        <?php echo $this->Nm_lang['lang_ado_records_fld_IdNumber'] ?>
<?php
    $prep_labels = array();
...
?>
<?php
     if (!in_array("_NM_SC_", $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Groupby_hide']))
     {
        if ($opc_ret != "resumo")
        {
...
?>
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Groupby_hide']))
     {
...
<?php
        ...
        $arr_tmp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] : $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Gb_Free_cmp'];
...
<?php
        ...
        {
            if ($this->restore) {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['dados_orig_gb']['res']['pivot_x_axys']);
            }
            else {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['pivot_x_axys']);
            }
        }
...
<?php
        if ($bSummaryPage)
        {
            ...
            {
                $arr_pivot_x_axys = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['dados_orig_gb']['res']['pivot_x_axys'] : $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['pivot_x_axys'];
...
<?php
   ...
   if ($bSummaryPage)
   {
       ...
       if (!isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_fields_control'])) {
           $arr_filds = array();
       }
       else {
           $arr_filds = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['dados_orig_gb']['res']['summarizing_fields_control'] : $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_fields_control'];
       }
    if (isset($arr_filds))
    {
?>
...
<?php
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_fields_display'])) {
              $arr_disp = array();
          }
          else {
                 $arr_disp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['dados_orig_gb']['res']['summarizing_fields_display'] : $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_fields_display'];
          }
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_fields_order'])) {
              $arr_ord = array();
          }
          else {
              $arr_ord  = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['dados_orig_gb']['res']['summarizing_fields_order']   : $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['summarizing_fields_order'];
          }
...
<script type="text/javascript">
   ...
   if ($this->restore) {
       $oJson = new Services_JSON();
        ob_end_clean();
        if ($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['dados_orig_gb']['all']['SC_Ind_Groupby'] == "sc_free_group_by") {
           $this->Arr_result['run_js'][] = "scShowFree()";
        } else {
           $this->Arr_result['set_var'][] = array('var' => 'actual_static_gb', 'value' => $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['dados_orig_gb']['all']['SC_Ind_Groupby']);
...
<?php
   $disp_rest = "none";
   foreach ($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['dados_orig_gb'] as $tp => $fields) {
       foreach ($fields as $name => $data) {
           if (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_admon'][$name])) {
               if ($tp == "all" && ($name != "SC_Gb_Free_cmp" || $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon']['SC_Ind_Groupby'] == "sc_free_group_by")) {
                   if ($data != $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon'][$name]) {
                       $disp_rest = "";
                       break;
                   }
               }
               elseif ($tp == "res" && $bSummaryPage && $data != $_SESSION['sc_session'][$sc_init]['grid_ado_records_admon'][$name]) {
                   $disp_rest = "";
                   break;
               }
           }
