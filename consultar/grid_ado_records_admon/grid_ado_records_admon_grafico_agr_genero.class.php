...
<?php
   ...
   function inicializa_vars()
   {
      ...
      //---- Label
      $this->label    = array();
      $this->label[0] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Gender'] . "";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['contr_label_graf']['gender']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['contr_label_graf']['gender']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['contr_label_graf']['gender'];
      }
   }
