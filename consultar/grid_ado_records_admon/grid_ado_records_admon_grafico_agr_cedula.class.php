...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['contr_label_graf']['idnumber']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['contr_label_graf']['idnumber']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['contr_label_graf']['idnumber'];
      }
   }
