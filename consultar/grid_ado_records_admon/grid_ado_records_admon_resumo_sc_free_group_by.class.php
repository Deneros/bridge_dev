...
class grid_ado_records_admon_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_transactiontypename;
   var $array_total_extras;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_transactiontypename = array();
      $this->array_total_extras              = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_ado_records_admon']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_ado_records_admon']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['arr_total']['transactiontypename'] = $this->array_total_transactiontypename;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['arr_total']['extras'] = $this->array_total_extras;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['json_use_label'])
       {
          $Lab_transactiontypename = "TransactionTypeName";
          $Lab_extras = "Extras";
       }
       else
       {
       $Lab_transactiontypename = "" . $this->Ini->Nm_lang['lang_ado_records_fld_TransactionTypeName'] . "";
       $Lab_extras = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Extras'] . "";
       }
       $prep_field = array();
       $prep_field['transactiontypename'] = $Lab_transactiontypename;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['transactiontypename'] = $Lab_transactiontypename; 
       $prep_field['extras'] = $Lab_extras;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['extras'] = $Lab_extras; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['record']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['record'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Record'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['uid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['uid'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Uid'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['startingdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['startingdate'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_StartingDate'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['creationdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['creationdate'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_CreationDate'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['creationip']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['creationip'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_CreationIP'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['documenttype']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['documenttype'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_DocumentType'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['idnumber']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['idnumber'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_IdNumber'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['firstname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['firstname'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_FirstName'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['secondname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['secondname'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_SecondName'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['firstsurname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['firstsurname'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_FirstSurname'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['gender']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['gender'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Gender'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['transactionid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['transactionid'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_TransactionId'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['transactiontypename']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['transactiontypename'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_TransactionTypeName'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['extras']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['extras'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Extras'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['response_ani']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['response_ani'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Response_ANI'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['secondsurname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['secondsurname'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_SecondSurname'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['birthdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['birthdate'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_BirthDate'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['street']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['street'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Street'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['cedulatecondition']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['cedulatecondition'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_CedulateCondition'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['spouse']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['spouse'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Spouse'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['home']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['home'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Home'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['maritalstatus']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['maritalstatus'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_MaritalStatus'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['dateofidentification']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['dateofidentification'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_DateOfIdentification'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['dateofdeath']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['dateofdeath'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_DateOfDeath'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['marriagedate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['marriagedate'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_MarriageDate'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['instruction']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['instruction'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Instruction'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['placebirth']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['placebirth'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_PlaceBirth'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['nationality']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['nationality'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Nationality'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['mothername']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['mothername'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_MotherName'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['fathername']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['fathername'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_FatherName'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['housenumber']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['housenumber'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_HouseNumber'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['profession']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['profession'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Profession'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['expeditioncity']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['expeditioncity'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_ExpeditionCity'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['expeditiondepartment']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['expeditiondepartment'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_ExpeditionDepartment'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['birthcity']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['birthcity'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_BirthCity'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['birthdepartment']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['birthdepartment'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_BirthDepartment'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['transactiontype']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['transactiontype'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_TransactionType'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['issuedate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['issuedate'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_IssueDate'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['barcodetext']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['barcodetext'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_BarcodeText'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['ocrtextsideone']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['ocrtextsideone'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_OcrTextSideOne'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['ocrtextsidetwo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['ocrtextsidetwo'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_OcrTextSideTwo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['sideonewrongattempts']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['sideonewrongattempts'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_SideOneWrongAttempts'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['sidetwowrongattempts']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['sidetwowrongattempts'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_SideTwoWrongAttempts'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['foundonadoalert']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['foundonadoalert'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_FoundOnAdoAlert'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['adoprojectid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['adoprojectid'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_AdoProjectId'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['productid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['productid'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_ProductId'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['comparationfacessuccesful']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['comparationfacessuccesful'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_ComparationFacesSuccesful'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['facefound']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['facefound'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_FaceFound'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['facedocumentfrontfound']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['facedocumentfrontfound'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_FaceDocumentFrontFound'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['barcodefound']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['barcodefound'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_BarcodeFound'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['resultcomparationfaces']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['resultcomparationfaces'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_ResultComparationFaces'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['comparationfacesaproved']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['comparationfacesaproved'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_ComparationFacesAproved'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['numberphone']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['numberphone'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_NumberPhone'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['codfingerprint']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['codfingerprint'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_CodFingerprint'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['resultqrcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['resultqrcode'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_ResultQRCode'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['dactilarcode']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['dactilarcode'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_DactilarCode'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['reponsecontrollist']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['reponsecontrollist'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_ReponseControlList'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['images']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['images'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Images'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['signeddocuments']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['signeddocuments'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_SignedDocuments'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['scores']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['scores'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Scores'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['parameters']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['parameters'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Parameters'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['statesignaturedocument']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['statesignaturedocument'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_StateSignatureDocument'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['verifyupdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['verifyupdate'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_VerifyUpdate'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['estadoreg']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['estadoreg'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_EstadoReg'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['json_response']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['labels']['json_response'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_JSON_Response'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['transactiontypename']['alin'] = "''";
       $Arr_parms['transactiontypename']['link'] = "S";
       $Arr_parms['extras']['alin'] = "''";
       $Arr_parms['extras']['link'] = "S";
       $Arr_parms['transactiontypename']['fill'] = "true";
       $Arr_parms['transactiontypename']['order'] = "label";
       $Arr_parms['transactiontypename']['order_start'] = 'asc';
       $Arr_parms['transactiontypename']['order_invert'] = 'false';
       $Arr_parms['transactiontypename']['order_enabled'] = 'true';
       $Arr_parms['extras']['fill'] = "true";
       $Arr_parms['extras']['order'] = "label";
       $Arr_parms['extras']['order_start'] = 'asc';
       $Arr_parms['extras']['order_invert'] = 'false';
       $Arr_parms['extras']['order_enabled'] = 'true';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['transactiontypename'] = array(0 => 'transactiontypename', 1 => '@aspass@');
       $prep_links_fl['extras'] = array(0 => 'extras', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_ado_records_admon@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_ado_records_admon_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_ado_records_admon_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_ado_records_admon_total.class.php"); 
      }
      ...
      $this->Total   = new grid_ado_records_admon_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_ado_records_admon/grid_ado_records_admon_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_ado_records_admon_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_ado_records_admon_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_ado_records_admon_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "document.Fdoc_word.submit();", "document.Fdoc_word.submit();", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "nm_gp_move('xls_res', '0', 'resume');", "nm_gp_move('xls_res', '0', 'resume');", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "nm_gp_move('xml_res', '0', 'resume');", "nm_gp_move('xml_res', '0', 'resume');", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "nm_gp_move('csv_res', '0', 'resume');", "nm_gp_move('csv_res', '0', 'resume');", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "brtf", "nm_gp_move('rtf_res', '0');", "nm_gp_move('rtf_res', '0');", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + R)", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "nm_gp_res_print('resume');", "nm_gp_res_print('resume');", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_ado_records_admon/grid_ado_records_admon_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_ado_records_admon/grid_ado_records_admon_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      ...
      if ($this->nmgp_botoes['reload'] == 'on' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['opc_psq'] && !$this->grid_emb_form)
      {
         ...
         if (is_file("grid_ado_records_admon_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rword_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['word'][] = "Rword_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "document.Fdoc_word.submit();", "document.Fdoc_word.submit();", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "", "", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xls'][] = "Rxls_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "nm_gp_move('xls_res', '0', 'resume');", "nm_gp_move('xls_res', '0', 'resume');", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "", "", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "nm_gp_move('xml_res', '0', 'resume');", "nm_gp_move('xml_res', '0', 'resume');", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "", "", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "nm_gp_move('csv_res', '0', 'resume');", "nm_gp_move('csv_res', '0', 'resume');", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "", "", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rrtf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['rtf'][] = "Rrtf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "brtf", "nm_gp_move('rtf_res', '0');", "nm_gp_move('rtf_res', '0');", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + R)", "", "", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rprinttop\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['print'][] = "Rprint_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "nm_gp_res_print('resume');", "nm_gp_res_print('resume');", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "", "", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_ado_records_admon_config_pivot.php?nome_apl=grid_ado_records_admon&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
      ...
      $nm_saida->saida("           document.Fexport.nmgp_password.value = password;\r\n");
      $nm_saida->saida("           document.Fexport.SC_module_export.value = SC_module_export;\r\n");
      $nm_saida->saida("               document.Fexport.action = \"grid_ado_records_admon_export_ctrl.php\";\r\n");
      $nm_saida->saida("           document.Fexport.submit() ;\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("   }\r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_ado_records_admon/grid_ado_records_admon_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_ado_records_admon_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_ado_records_admon/grid_ado_records_admon_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $startingdate = $Busca_temp['startingdate']; 
          $tmp_pos = strpos($startingdate, "##@@");
          if ($tmp_pos !== false && !is_array($startingdate))
          {
              $startingdate = substr($startingdate, 0, $tmp_pos);
          }
          $startingdate_2 = $Busca_temp['startingdate_input_2']; 
          $creationdate = $Busca_temp['creationdate']; 
          $tmp_pos = strpos($creationdate, "##@@");
          if ($tmp_pos !== false && !is_array($creationdate))
          {
              $creationdate = substr($creationdate, 0, $tmp_pos);
          }
          $creationdate_2 = $Busca_temp['creationdate_input_2']; 
          $creationip = $Busca_temp['creationip']; 
          $tmp_pos = strpos($creationip, "##@@");
          if ($tmp_pos !== false && !is_array($creationip))
          {
              $creationip = substr($creationip, 0, $tmp_pos);
          }
          $firstname = $Busca_temp['firstname']; 
          $tmp_pos = strpos($firstname, "##@@");
          if ($tmp_pos !== false && !is_array($firstname))
          {
              $firstname = substr($firstname, 0, $tmp_pos);
          }
          $firstsurname = $Busca_temp['firstsurname']; 
          $tmp_pos = strpos($firstsurname, "##@@");
          if ($tmp_pos !== false && !is_array($firstsurname))
          {
          ...
          $transactiontypename = $Busca_temp['transactiontypename']; 
          $tmp_pos = strpos($transactiontypename, "##@@");
          if ($tmp_pos !== false && !is_array($transactiontypename))
          {
              $transactiontypename = substr($transactiontypename, 0, $tmp_pos);
          }
          $issuedate = $Busca_temp['issuedate']; 
          $tmp_pos = strpos($issuedate, "##@@");
          if ($tmp_pos !== false && !is_array($issuedate))
          {
              $issuedate = substr($issuedate, 0, $tmp_pos);
          }
          $issuedate_2 = $Busca_temp['issuedate_input_2']; 
          $extras = $Busca_temp['extras']; 
          $tmp_pos = strpos($extras, "##@@");
          if ($tmp_pos !== false && !is_array($extras))
          {
   ...
   //---- 
   function adiciona_registro($quebra_transactiontypename, $quebra_extras, $quebra_transactiontypename_orig, $quebra_extras_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_admon']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->record = $rs_res->fields[0] ;  
            $this->uid = $rs_res->fields[1] ;  
            $this->startingdate = $rs_res->fields[2] ;  
            $this->creationdate = $rs_res->fields[3] ;  
            $this->creationip = $rs_res->fields[4] ;  
            $this->documenttype = $rs_res->fields[5] ;  
            $this->idnumber = $rs_res->fields[6] ;  
            $this->firstname = $rs_res->fields[7] ;  
            $this->secondname = $rs_res->fields[8] ;  
            $this->firstsurname = $rs_res->fields[9] ;  
            $this->gender = $rs_res->fields[10] ;  
            $this->transactionid = $rs_res->fields[11] ;  
            $this->transactiontypename = $rs_res->fields[12] ;  
            $this->extras = $rs_res->fields[13] ;  
            $this->response_ani = $rs_res->fields[14] ;  
            $this->transactiontypename_orig = $this->transactiontypename;
            $this->extras_orig = $this->extras;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->transactiontypename, $this->extras, $this->transactiontypename_orig,  $this->extras_orig);
            }
   }
//
