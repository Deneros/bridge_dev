...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_ado_records_admon"]))
   {
      unset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_ado_records_admon"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_ado_records_admon'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ado_records_admon']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ado_records_admon']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ado_records_admon']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ado_records_admon']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ado_records_admon']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ado_records_admon</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ado_records_admon']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ado_records_admon']['embutida_filho'] as $ind => $sc_init)
          {
