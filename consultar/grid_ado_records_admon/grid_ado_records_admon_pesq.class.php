 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_startingdate_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['startingdate'])) ? $this->New_label['startingdate'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_StartingDate'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_startingdate_cond" name="startingdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_startingdate'), this, 'startingdate')">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_startingdate"  <?php echo $str_display_startingdate; ?> class="scFilterFieldFontOdd">
...
?>
      ...
      <TD id='SC_creationdate_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['creationdate'])) ? $this->New_label['creationdate'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_CreationDate'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_creationdate_cond" name="creationdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_creationdate'), this, 'creationdate')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_creationdate" <?php echo $str_hide_creationdate?> valign="top">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_creationdate"  <?php echo $str_display_creationdate; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>
         <BR>
...
?>
      ...
      <TD id='SC_creationip_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['creationip'])) ? $this->New_label['creationip'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_CreationIP'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_creationip_cond" name="creationip_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_creationip" <?php echo $str_hide_creationip?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_firstname" name="firstname_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_firstsurname_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['firstsurname'])) ? $this->New_label['firstsurname'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_FirstSurname'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_firstsurname_cond" name="firstsurname_cond" onChange="nm_campos_between(document.getElementById('id_vis_firstsurname'), this, 'firstsurname')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_firstsurname" <?php echo $str_hide_firstsurname?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
 ...
 <OPTION value="F##@@<?php echo $this->Ini->Nm_lang['lang_femenino'] ?>"<?php if ($gender == "F") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_femenino'] ?></option>
      ...
      <TD id='SC_transactiontypename_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['transactiontypename'])) ? $this->New_label['transactiontypename'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_TransactionTypeName'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_transactiontypename_cond" name="transactiontypename_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_transactiontypename" <?php echo $str_hide_transactiontypename?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_transactiontypename" name="transactiontypename_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_issuedate_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['issuedate'])) ? $this->New_label['issuedate'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_IssueDate'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_issuedate_cond" name="issuedate_cond" onChange="nm_campos_between(document.getElementById('id_vis_issuedate'), this, 'issuedate')">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_issuedate"  <?php echo $str_display_issuedate; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>
         <BR>
...
?>
      ...
      <TD id='SC_extras_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['extras'])) ? $this->New_label['extras'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_Extras'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_extras_cond" name="extras_cond" onChange="nm_campos_between(document.getElementById('id_vis_extras'), this, 'extras')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_extras" <?php echo $str_hide_extras?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
