...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_authorization_code_cond" name="authorization_code_cond" onChange="nm_campos_between(document.getElementById('id_vis_authorization_code'), this, 'authorization_code')">
      ...
      <br><span id="id_hide_authorization_code"  <?php echo $str_hide_authorization_code?>><?php
