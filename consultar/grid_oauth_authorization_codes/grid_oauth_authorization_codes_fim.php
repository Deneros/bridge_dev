...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_oauth_authorization_codes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_oauth_authorization_codes"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_authorization_codes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_oauth_authorization_codes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_authorization_codes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_oauth_authorization_codes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_oauth_authorization_codes']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_oauth_authorization_codes</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_authorization_codes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_oauth_authorization_codes']['embutida_filho'] as $ind => $sc_init)
          {
