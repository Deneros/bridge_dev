<?php
@session_start() ;
$_SESSION['scriptcase']['chart_ado_records']['sc_process_barr'] = true;
require_once('../chart_ado_records/index.php');
unset($_SESSION['scriptcase']['chart_ado_records']['sc_process_barr']);
$ExportCtrl = new chart_ado_records_export_control;
$ExportCtrl->Export_barr();

class chart_ado_records_export_control
{
