...
class chart_ado_records_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_ado_records'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_ado_records'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_ado_records']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chart_ado_records']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chart_ado_records']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_step']     = 'image';
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_step'] = 'end';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['chart_ado_records']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['campos_busca'];
         ...
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_x_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_y_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_combination_type']        = 'bar2d';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_combination_order_rule']  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_combination_order_field'] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_combination_order_rule_groupby']["gender"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_combination_order_field_groupby']["gender"] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_combination_order_rule_groupby']["idnumber"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_combination_order_field_groupby']["idnumber"] = 'label';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_y_axys'][0] = 0;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_y_axys'][1] = 1;
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['comb_field_display_type'][2] = '';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_display_values'][2] = true;


           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_fields_order']['sc_free_group_by'][] = 2;
       }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pesq_tab_label'] = "";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_search_add']);
          exit;
      }
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("chart_ado_records", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['arr_total']['gender'] = $this->array_total_gender;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['arr_total']['idnumber'] = $this->array_total_idnumber;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['json_use_label'])
       {
          $Lab_gender = "Gender";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['gender'] = $Lab_gender; 
       $prep_field['idnumber'] = $Lab_idnumber;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['idnumber'] = $Lab_idnumber; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['record']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['record'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Record'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['uid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['uid'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Uid'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['startingdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['startingdate'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_StartingDate'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['creationdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['creationdate'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_CreationDate'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['creationip']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['creationip'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_CreationIP'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['documenttype']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['documenttype'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_DocumentType'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['idnumber']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['idnumber'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_IdNumber'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['firstname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['firstname'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_FirstName'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['secondname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['secondname'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_SecondName'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['firstsurname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['firstsurname'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_FirstSurname'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['secondsurname']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['secondsurname'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_SecondSurname'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['gender']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['gender'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Gender'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['birthdate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['birthdate'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_BirthDate'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['cedulatecondition']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['cedulatecondition'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_CedulateCondition'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['spouse']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['spouse'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Spouse'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['dateofidentification']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['dateofidentification'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_DateOfIdentification'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['placebirth']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['placebirth'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_PlaceBirth'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['nationality']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['nationality'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Nationality'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['expeditioncity']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['expeditioncity'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_ExpeditionCity'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['birthcity']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['birthcity'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_BirthCity'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['transactiontype']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['transactiontype'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_TransactionType'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['transactiontypename']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['transactiontypename'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_TransactionTypeName'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['issuedate']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['issuedate'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_IssueDate'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['adoprojectid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['adoprojectid'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_AdoProjectId'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['transactionid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['transactionid'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_TransactionId'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['productid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['productid'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_ProductId'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['scores']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['labels']['scores'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Scores'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['idnumber']['alin'] = "''";
       $Arr_parms['idnumber']['link'] = "S";
       ...
       $Arr_parms['idnumber']['fill'] = "true";
       $Arr_parms['idnumber']['order'] = "label";
       $Arr_parms['idnumber']['order_start'] = 'asc';
       $Arr_parms['idnumber']['order_invert'] = 'false';
       $Arr_parms['idnumber']['order_enabled'] = 'true';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       $prep_links_fl['idnumber'] = array(0 => 'idnumber', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_ado_records@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function buildChart()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_fields_order']['sc_free_group_by'] as $i_summ_order)
       {
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_chart_ado_records_' . session_id() . '_!!!C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__!!!.json' : '',
                               'xml'         => 'sc_chart_ado_records_' . session_id() . '_!!!C_' . $i_index_group . '_' . $s_index_comb . '!!!.json',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
	...
	function filterChartsByMultiseries() {
		...
		if ($applyFilter && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['summarizing_drill_down'])) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_charts'] as $chartIndex => $chartData) {
				$indexParts = explode('|', $chartIndex);
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_chart_ado_records_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_chart_ado_records_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
      ...
      { 
         ...
         { 
             $seq_search = 1;
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_pesq'] as $cmp => $def)
             {
                $Seq_grid      = $seq_search;
                $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_ado_records']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_ado_records']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_ado_records']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_ado_records']) . "_";
               } 
           }
       }
   ...
   {
      global $nm_saida;
      $res_sem_reg = "SIN REGISTROS"; 
      $nm_saida->saida("  <TR id=\"summary_body\">\r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['ajax_nav'])
      { 
          $_SESSION['scriptcase']['saida_html'] = "";
      } 
      $nm_saida->saida("   <TD class=\"scGridFieldOdd scGridFieldOddFont\" align=\"center\" style=\"vertical-align: top;font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:11px;\">\r\n");
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_ado_records_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new chart_ado_records_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " " . $this->Ini->Nm_lang['lang_tbl_ado_records'] . "</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_ado_records_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_ado_records_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_ado_records_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_ado_records/chart_ado_records_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/thickbox.css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_ado_records_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_ado_records_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_ado_records_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['num_css'] . '.css');
...
$nm_saida->saida(".sc-chart-type-button.disabled img { filter: alpha(opacity=20); opacity:0.2 }\r\n");
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['embutida'])
      {
      ...
      $nm_saida->saida("function scChartImageExportShow(exportType) {\r\n");
          $nm_saida->saida("  scShowCombinationImage(" . count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['Labels_GB']) . ", exportType, '');\r\n");
      $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("          <input type=\"hidden\" id=\"sc-id-chart-word-color\" value=\"color\" />\r\n");
...
;
      ...
      if (1 < count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['Labels_GB'])) {
          $nm_saida->saida("  scBlockUI();\r\n");
          $nm_saida->saida("  $(\"#sc-id-print-export-type\").val(exportType);\r\n");
          $nm_saida->saida("  $(\"#sc-id-print-export-config\").css({\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_ado_records/chart_ado_records_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . n . "&nm_tem_gb=s&nm_res_cons=n&nm_ini_pdf_res=chart&nm_all_modules=chart&password=n&summary_export_columns=N&pdf_zip=N&origem=chart&language=es&conf_socor=N&is_chart_app=Y&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=2&script_case_init=" . $this->Ini->sc_page . "&app_name=chart_ado_records&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "scShowCombinationXls()", "scShowCombinationXls()", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['group_3'] == "on")
      {
         ...
         if (is_file("chart_ado_records_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chart_ado_records_help.txt"); 
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['group_5'] == "on")
      {
          ...
          $NM_btn  = true;
          $NM_Gbtn = false;
          $Cod_Btn = nmButtonGroupTableOutput($this->arr_buttons, "group_group_5", 'group_5', 'top', 'app', 'ini');
          $nm_saida->saida("           $Cod_Btn\r\n");
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rpdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_ado_records/chart_ado_records_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . n . "&nm_tem_gb=s&nm_res_cons=n&nm_ini_pdf_res=chart&nm_all_modules=chart&password=n&summary_export_columns=N&pdf_zip=N&origem=chart&language=es&conf_socor=N&is_chart_app=Y&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=2&script_case_init=" . $this->Ini->sc_page . "&app_name=chart_ado_records&KeepThis=true&TB_iframe=true&modal=true", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "scChartWordExportShow('direct')", "scChartWordExportShow('direct')", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xls'][] = "Rxls_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "scShowCombinationXls()", "scShowCombinationXls()", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "scShowCombinationXml()", "scShowCombinationXml()", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "scShowCombinationCsv()", "scShowCombinationCsv()", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rprinttop\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['print'][] = "Rprint_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "scChartPrintExportShow('direct')", "scChartPrintExportShow('direct')", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
          $Cod_Btn = nmButtonGroupTableOutput($this->arr_buttons, "group_group_5", 'group_5', 'top', 'app', 'fim');
          $nm_saida->saida("           $Cod_Btn\r\n");
          $nm_saida->saida("           <script type=\"text/javascript\">\r\n");
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['group_6'] == "on")
      {
          ...
          $NM_btn  = true;
          $NM_Gbtn = false;
          $Cod_Btn = nmButtonGroupTableOutput($this->arr_buttons, "group_group_6", 'group_6', 'top', 'app', 'ini');
          $nm_saida->saida("           $Cod_Btn\r\n");
          $Cod_Btn = nmButtonGroupTableOutput($this->arr_buttons, "group_group_6", 'group_6', 'top', 'app', 'fim');
          $nm_saida->saida("           $Cod_Btn\r\n");
          $nm_saida->saida("           <script type=\"text/javascript\">\r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($this->Ini->Export_html_zip || ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['graf_pdf'] == "S"))
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_ado_records_config_pivot.php?nome_apl=chart_ado_records&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"chart_ado_records_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
          ...
          $nm_saida->saida("       document.Fexport.action = \"chart_ado_records_export_ctrl.php\";\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_ado_records_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_ado_records@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
...
;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_ado_records_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_ado_records/chart_ado_records_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['skip_charts']))
   {
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_charts'] as $chart_index => $chart_data)
       {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               chart_ado_records_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['this_chart_label'] = '';
           $this->Graf->monta_grafico($chart_index, 'pdf');
           if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['this_chart_label']) {
               $nm_saida->saida("<script type=\"text/javascript\">$(\"#$random_id\").html(\"{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['this_chart_label']}\")</script>\r\n");
           }
       ...
       if ($bChartFP)
       {
           ...
           chart_ado_records_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_ado_records_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           chart_ado_records_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
           chart_ado_records_pdf_progress_call("\n", $this->Ini->Nm_lang);
           chart_ado_records_pdf_progress_call("\n", $this->Ini->Nm_lang);
           chart_ado_records_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   chart_ado_records_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['cond_pesq'], 0, $trab_pos);
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " " . $this->Ini->Nm_lang['lang_tbl_ado_records'] . "</div>\r\n");
   ...
   //---- 
   function adiciona_registro($quebra_gender, $quebra_idnumber, $quebra_gender_orig, $quebra_idnumber_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT Record, Uid, str_replace (convert(char(10),StartingDate,102), '.', '-') + ' ' + convert(char(8),StartingDate,20), str_replace (convert(char(10),CreationDate,102), '.', '-') + ' ' + convert(char(8),CreationDate,20), CreationIP, DocumentType, IdNumber, FirstName, SecondName, FirstSurname, SecondSurname, Gender, str_replace (convert(char(10),BirthDate,102), '.', '-') + ' ' + convert(char(8),BirthDate,20), CedulateCondition, Spouse, str_replace (convert(char(10),DateOfIdentification,102), '.', '-') + ' ' + convert(char(8),DateOfIdentification,20), PlaceBirth, Nationality, ExpeditionCity, BirthCity, TransactionType, TransactionTypeName, str_replace (convert(char(10),IssueDate,102), '.', '-') + ' ' + convert(char(8),IssueDate,20), AdoProjectId, TransactionId, ProductId, Scores from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT Record, Uid, StartingDate, CreationDate, CreationIP, DocumentType, IdNumber, FirstName, SecondName, FirstSurname, SecondSurname, Gender, BirthDate, CedulateCondition, Spouse, DateOfIdentification, PlaceBirth, Nationality, ExpeditionCity, BirthCity, TransactionType, TransactionTypeName, IssueDate, AdoProjectId, TransactionId, ProductId, Scores from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT Record, Uid, convert(char(23),StartingDate,121), convert(char(23),CreationDate,121), CreationIP, DocumentType, IdNumber, FirstName, SecondName, FirstSurname, SecondSurname, Gender, convert(char(23),BirthDate,121), CedulateCondition, Spouse, convert(char(23),DateOfIdentification,121), PlaceBirth, Nationality, ExpeditionCity, BirthCity, TransactionType, TransactionTypeName, convert(char(23),IssueDate,121), AdoProjectId, TransactionId, ProductId, Scores from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT Record, Uid, StartingDate, CreationDate, CreationIP, DocumentType, IdNumber, FirstName, SecondName, FirstSurname, SecondSurname, Gender, BirthDate, CedulateCondition, Spouse, DateOfIdentification, PlaceBirth, Nationality, ExpeditionCity, BirthCity, TransactionType, TransactionTypeName, IssueDate, AdoProjectId, TransactionId, ProductId, Scores from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['where_pesq']; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->secondsurname = $rs_res->fields[10] ;  
            $this->gender = $rs_res->fields[11] ;  
            $this->birthdate = $rs_res->fields[12] ;  
            $this->cedulatecondition = $rs_res->fields[13] ;  
            $this->spouse = $rs_res->fields[14] ;  
            $this->dateofidentification = $rs_res->fields[15] ;  
            $this->placebirth = $rs_res->fields[16] ;  
            $this->nationality = $rs_res->fields[17] ;  
            $this->expeditioncity = $rs_res->fields[18] ;  
            $this->birthcity = $rs_res->fields[19] ;  
            $this->transactiontype = $rs_res->fields[20] ;  
            $this->transactiontypename = $rs_res->fields[21] ;  
            $this->issuedate = $rs_res->fields[22] ;  
            $this->adoprojectid = $rs_res->fields[23] ;  
            $this->transactionid = $rs_res->fields[24] ;  
            $this->productid = $rs_res->fields[25] ;  
            $this->scores = $rs_res->fields[26] ;  
            $this->gender_orig = $this->gender;
            $this->idnumber_orig = $this->idnumber;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->gender, $this->idnumber, $this->gender_orig,  $this->idnumber_orig);
            }
   }
//
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_pesq']))
           { 
   ...
   function grid_search_add_tag()
   {
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_pesq']) < 0)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ado_records']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "OpenIdConnect/chart_ado_records";
