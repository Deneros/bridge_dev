...
<?php
   ...
   $Ord_Cmp = new grid_oauth_access_tokens_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_oauth_access_tokens_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['access_token'] = "access_token";
   $tab_labels["access_token"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['labels']["access_token"])) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['labels']["access_token"] : "" . $this->Nm_lang['lang_oauth_access_tokens_fld_access_token'] . "";
   $tab_ger_campos['client_id'] = "on";
   $tab_def_campos['client_id'] = "client_id";
   $tab_labels["client_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['labels']["client_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['labels']["client_id"] : "" . $this->Nm_lang['lang_oauth_access_tokens_fld_client_id'] . "";
   $tab_ger_campos['user_id'] = "on";
   $tab_def_campos['user_id'] = "user_id";
   $tab_labels["user_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['labels']["user_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['labels']["user_id"] : "" . $this->Nm_lang['lang_oauth_access_tokens_fld_user_id'] . "";
   $tab_ger_campos['expires'] = "on";
   $tab_def_campos['expires'] = "expires";
   $tab_labels["expires"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['labels']["expires"])) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['labels']["expires"] : "" . $this->Nm_lang['lang_oauth_access_tokens_fld_expires'] . "";
   $tab_ger_campos['scope'] = "on";
   $tab_def_campos['scope'] = "scope";
   $tab_labels["scope"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['labels']["scope"])) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['labels']["scope"] : "" . $this->Nm_lang['lang_oauth_access_tokens_fld_scope'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_oauth_access_tokens_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_oauth_access_tokens']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
