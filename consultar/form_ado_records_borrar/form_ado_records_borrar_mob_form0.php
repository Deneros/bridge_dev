...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_ado_records_borrar/form_ado_records_borrar_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_ado_records_borrar_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_ado_records_borrar_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    $vertical_center = '';
...
if (isset($_SESSION['scriptcase']['form_ado_records_borrar']['error_buffer']) && '' != $_SESSION['scriptcase']['form_ado_records_borrar']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_ado_records_borrar']['error_buffer'];
}
...
<?php
 include_once("form_ado_records_borrar_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_ado_records_borrar_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_ado_records_borrar_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_ado_records_borrar_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] != "R")
{
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_record_line" id="hidden_field_data_record" style="<?php echo $sStyleHidden_record; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_record_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_record_label" style=""><span id="id_label_record"><?php echo $this->nm_new_label['record']; ?></span></span><br><span id="id_read_on_record" class="css_record_line" style="<?php echo $sStyleReadLab_record; ?>"><?php echo $this->form_format_readonly("record", $this->form_encode_input($this->record)); ?></span><span id="id_read_off_record" class="css_read_off_record" style="<?php echo $sStyleReadInp_record; ?>"><input type="hidden" name="record" value="<?php echo $this->form_encode_input($record) . "\">"?><span id="id_ajax_label_record"><?php echo nl2br($record); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_startingdate_line" id="hidden_field_data_startingdate" style="<?php echo $sStyleHidden_startingdate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_startingdate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_startingdate_label" style=""><span id="id_label_startingdate"><?php echo $this->nm_new_label['startingdate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_creationdate_line" id="hidden_field_data_creationdate" style="<?php echo $sStyleHidden_creationdate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_creationdate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_creationdate_label" style=""><span id="id_label_creationdate"><?php echo $this->nm_new_label['creationdate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_creationip_line" id="hidden_field_data_creationip" style="<?php echo $sStyleHidden_creationip; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_creationip_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_creationip_label" style=""><span id="id_label_creationip"><?php echo $this->nm_new_label['creationip']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_documenttype_line" id="hidden_field_data_documenttype" style="<?php echo $sStyleHidden_documenttype; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_documenttype_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_documenttype_label" style=""><span id="id_label_documenttype"><?php echo $this->nm_new_label['documenttype']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idnumber_line" id="hidden_field_data_idnumber" style="<?php echo $sStyleHidden_idnumber; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idnumber_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idnumber_label" style=""><span id="id_label_idnumber"><?php echo $this->nm_new_label['idnumber']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_secondname_line" id="hidden_field_data_secondname" style="<?php echo $sStyleHidden_secondname; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_secondname_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_secondname_label" style=""><span id="id_label_secondname"><?php echo $this->nm_new_label['secondname']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_firstsurname_line" id="hidden_field_data_firstsurname" style="<?php echo $sStyleHidden_firstsurname; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_firstsurname_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_firstsurname_label" style=""><span id="id_label_firstsurname"><?php echo $this->nm_new_label['firstsurname']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_secondsurname_line" id="hidden_field_data_secondsurname" style="<?php echo $sStyleHidden_secondsurname; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_secondsurname_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_secondsurname_label" style=""><span id="id_label_secondsurname"><?php echo $this->nm_new_label['secondsurname']; ?></span></span><br>
...
<span class='trigger-picker-<?php echo $miniCalendarButton[1]; ?>' style='display: inherit; width: 100%'>
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=18"; } ?> alt="{datatype: 'datetime', dateSep: '<?php echo $this->field_config['birthdate']['date_sep']; ?>', dateFormat: '<?php echo $this->field_config['birthdate']['date_format']; ?>', timeSep: '<?php echo $this->field_config['birthdate']['time_sep']; ?>', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span>
&nbsp;<span class="scFormDataHelpOdd"><?php echo $tmp_form_data; ?></span></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_street_line" id="hidden_field_data_street" style="<?php echo $sStyleHidden_street; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_street_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_street_label" style=""><span id="id_label_street"><?php echo $this->nm_new_label['street']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cedulatecondition_line" id="hidden_field_data_cedulatecondition" style="<?php echo $sStyleHidden_cedulatecondition; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cedulatecondition_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cedulatecondition_label" style=""><span id="id_label_cedulatecondition"><?php echo $this->nm_new_label['cedulatecondition']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_spouse_line" id="hidden_field_data_spouse" style="<?php echo $sStyleHidden_spouse; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_spouse_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_spouse_label" style=""><span id="id_label_spouse"><?php echo $this->nm_new_label['spouse']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_home_line" id="hidden_field_data_home" style="<?php echo $sStyleHidden_home; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_home_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_home_label" style=""><span id="id_label_home"><?php echo $this->nm_new_label['home']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_maritalstatus_line" id="hidden_field_data_maritalstatus" style="<?php echo $sStyleHidden_maritalstatus; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_maritalstatus_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_maritalstatus_label" style=""><span id="id_label_maritalstatus"><?php echo $this->nm_new_label['maritalstatus']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dateofidentification_line" id="hidden_field_data_dateofidentification" style="<?php echo $sStyleHidden_dateofidentification; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dateofidentification_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dateofidentification_label" style=""><span id="id_label_dateofidentification"><?php echo $this->nm_new_label['dateofidentification']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dateofdeath_line" id="hidden_field_data_dateofdeath" style="<?php echo $sStyleHidden_dateofdeath; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dateofdeath_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dateofdeath_label" style=""><span id="id_label_dateofdeath"><?php echo $this->nm_new_label['dateofdeath']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_marriagedate_line" id="hidden_field_data_marriagedate" style="<?php echo $sStyleHidden_marriagedate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_marriagedate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_marriagedate_label" style=""><span id="id_label_marriagedate"><?php echo $this->nm_new_label['marriagedate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_instruction_line" id="hidden_field_data_instruction" style="<?php echo $sStyleHidden_instruction; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_instruction_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_instruction_label" style=""><span id="id_label_instruction"><?php echo $this->nm_new_label['instruction']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_placebirth_line" id="hidden_field_data_placebirth" style="<?php echo $sStyleHidden_placebirth; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_placebirth_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_placebirth_label" style=""><span id="id_label_placebirth"><?php echo $this->nm_new_label['placebirth']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nationality_line" id="hidden_field_data_nationality" style="<?php echo $sStyleHidden_nationality; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nationality_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nationality_label" style=""><span id="id_label_nationality"><?php echo $this->nm_new_label['nationality']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_mothername_line" id="hidden_field_data_mothername" style="<?php echo $sStyleHidden_mothername; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mothername_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_mothername_label" style=""><span id="id_label_mothername"><?php echo $this->nm_new_label['mothername']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fathername_line" id="hidden_field_data_fathername" style="<?php echo $sStyleHidden_fathername; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fathername_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fathername_label" style=""><span id="id_label_fathername"><?php echo $this->nm_new_label['fathername']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_housenumber_line" id="hidden_field_data_housenumber" style="<?php echo $sStyleHidden_housenumber; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_housenumber_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_housenumber_label" style=""><span id="id_label_housenumber"><?php echo $this->nm_new_label['housenumber']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_profession_line" id="hidden_field_data_profession" style="<?php echo $sStyleHidden_profession; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_profession_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_profession_label" style=""><span id="id_label_profession"><?php echo $this->nm_new_label['profession']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_expeditioncity_line" id="hidden_field_data_expeditioncity" style="<?php echo $sStyleHidden_expeditioncity; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_expeditioncity_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_expeditioncity_label" style=""><span id="id_label_expeditioncity"><?php echo $this->nm_new_label['expeditioncity']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_birthcity_line" id="hidden_field_data_birthcity" style="<?php echo $sStyleHidden_birthcity; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_birthcity_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_birthcity_label" style=""><span id="id_label_birthcity"><?php echo $this->nm_new_label['birthcity']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_birthdepartment_line" id="hidden_field_data_birthdepartment" style="<?php echo $sStyleHidden_birthdepartment; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_birthdepartment_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_birthdepartment_label" style=""><span id="id_label_birthdepartment"><?php echo $this->nm_new_label['birthdepartment']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_transactiontype_line" id="hidden_field_data_transactiontype" style="<?php echo $sStyleHidden_transactiontype; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_transactiontype_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_transactiontype_label" style=""><span id="id_label_transactiontype"><?php echo $this->nm_new_label['transactiontype']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_transactiontypename_line" id="hidden_field_data_transactiontypename" style="<?php echo $sStyleHidden_transactiontypename; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_transactiontypename_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_transactiontypename_label" style=""><span id="id_label_transactiontypename"><?php echo $this->nm_new_label['transactiontypename']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_issuedate_line" id="hidden_field_data_issuedate" style="<?php echo $sStyleHidden_issuedate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_issuedate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_issuedate_label" style=""><span id="id_label_issuedate"><?php echo $this->nm_new_label['issuedate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_barcodetext_line" id="hidden_field_data_barcodetext" style="<?php echo $sStyleHidden_barcodetext; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_barcodetext_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_barcodetext_label" style=""><span id="id_label_barcodetext"><?php echo $this->nm_new_label['barcodetext']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ocrtextsideone_line" id="hidden_field_data_ocrtextsideone" style="<?php echo $sStyleHidden_ocrtextsideone; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ocrtextsideone_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ocrtextsideone_label" style=""><span id="id_label_ocrtextsideone"><?php echo $this->nm_new_label['ocrtextsideone']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ocrtextsidetwo_line" id="hidden_field_data_ocrtextsidetwo" style="<?php echo $sStyleHidden_ocrtextsidetwo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ocrtextsidetwo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ocrtextsidetwo_label" style=""><span id="id_label_ocrtextsidetwo"><?php echo $this->nm_new_label['ocrtextsidetwo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sideonewrongattempts_line" id="hidden_field_data_sideonewrongattempts" style="<?php echo $sStyleHidden_sideonewrongattempts; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sideonewrongattempts_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sideonewrongattempts_label" style=""><span id="id_label_sideonewrongattempts"><?php echo $this->nm_new_label['sideonewrongattempts']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_foundonadoalert_line" id="hidden_field_data_foundonadoalert" style="<?php echo $sStyleHidden_foundonadoalert; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_foundonadoalert_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_foundonadoalert_label" style=""><span id="id_label_foundonadoalert"><?php echo $this->nm_new_label['foundonadoalert']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_adoprojectid_line" id="hidden_field_data_adoprojectid" style="<?php echo $sStyleHidden_adoprojectid; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_adoprojectid_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_adoprojectid_label" style=""><span id="id_label_adoprojectid"><?php echo $this->nm_new_label['adoprojectid']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_transactionid_line" id="hidden_field_data_transactionid" style="<?php echo $sStyleHidden_transactionid; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_transactionid_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_transactionid_label" style=""><span id="id_label_transactionid"><?php echo $this->nm_new_label['transactionid']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_productid_line" id="hidden_field_data_productid" style="<?php echo $sStyleHidden_productid; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_productid_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_productid_label" style=""><span id="id_label_productid"><?php echo $this->nm_new_label['productid']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_comparationfacessuccesful_line" id="hidden_field_data_comparationfacessuccesful" style="<?php echo $sStyleHidden_comparationfacessuccesful; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_comparationfacessuccesful_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_comparationfacessuccesful_label" style=""><span id="id_label_comparationfacessuccesful"><?php echo $this->nm_new_label['comparationfacessuccesful']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_facefound_line" id="hidden_field_data_facefound" style="<?php echo $sStyleHidden_facefound; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_facefound_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_facefound_label" style=""><span id="id_label_facefound"><?php echo $this->nm_new_label['facefound']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_barcodefound_line" id="hidden_field_data_barcodefound" style="<?php echo $sStyleHidden_barcodefound; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_barcodefound_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_barcodefound_label" style=""><span id="id_label_barcodefound"><?php echo $this->nm_new_label['barcodefound']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_resultcomparationfaces_line" id="hidden_field_data_resultcomparationfaces" style="<?php echo $sStyleHidden_resultcomparationfaces; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_resultcomparationfaces_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_resultcomparationfaces_label" style=""><span id="id_label_resultcomparationfaces"><?php echo $this->nm_new_label['resultcomparationfaces']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_extras_line" id="hidden_field_data_extras" style="<?php echo $sStyleHidden_extras; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_extras_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_extras_label" style=""><span id="id_label_extras"><?php echo $this->nm_new_label['extras']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_numberphone_line" id="hidden_field_data_numberphone" style="<?php echo $sStyleHidden_numberphone; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numberphone_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_numberphone_label" style=""><span id="id_label_numberphone"><?php echo $this->nm_new_label['numberphone']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_codfingerprint_line" id="hidden_field_data_codfingerprint" style="<?php echo $sStyleHidden_codfingerprint; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codfingerprint_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_codfingerprint_label" style=""><span id="id_label_codfingerprint"><?php echo $this->nm_new_label['codfingerprint']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_resultqrcode_line" id="hidden_field_data_resultqrcode" style="<?php echo $sStyleHidden_resultqrcode; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_resultqrcode_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_resultqrcode_label" style=""><span id="id_label_resultqrcode"><?php echo $this->nm_new_label['resultqrcode']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dactilarcode_line" id="hidden_field_data_dactilarcode" style="<?php echo $sStyleHidden_dactilarcode; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dactilarcode_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dactilarcode_label" style=""><span id="id_label_dactilarcode"><?php echo $this->nm_new_label['dactilarcode']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_reponsecontrollist_line" id="hidden_field_data_reponsecontrollist" style="<?php echo $sStyleHidden_reponsecontrollist; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_reponsecontrollist_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_reponsecontrollist_label" style=""><span id="id_label_reponsecontrollist"><?php echo $this->nm_new_label['reponsecontrollist']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_images_line" id="hidden_field_data_images" style="<?php echo $sStyleHidden_images; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_images_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_images_label" style=""><span id="id_label_images"><?php echo $this->nm_new_label['images']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_signeddocuments_line" id="hidden_field_data_signeddocuments" style="<?php echo $sStyleHidden_signeddocuments; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_signeddocuments_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_signeddocuments_label" style=""><span id="id_label_signeddocuments"><?php echo $this->nm_new_label['signeddocuments']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_scores_line" id="hidden_field_data_scores" style="<?php echo $sStyleHidden_scores; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_scores_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_scores_label" style=""><span id="id_label_scores"><?php echo $this->nm_new_label['scores']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_response_ani_line" id="hidden_field_data_response_ani" style="<?php echo $sStyleHidden_response_ani; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_response_ani_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_response_ani_label" style=""><span id="id_label_response_ani"><?php echo $this->nm_new_label['response_ani']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_parameters_line" id="hidden_field_data_parameters" style="<?php echo $sStyleHidden_parameters; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_parameters_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_parameters_label" style=""><span id="id_label_parameters"><?php echo $this->nm_new_label['parameters']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_statesignaturedocument_line" id="hidden_field_data_statesignaturedocument" style="<?php echo $sStyleHidden_statesignaturedocument; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_statesignaturedocument_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_statesignaturedocument_label" style=""><span id="id_label_statesignaturedocument"><?php echo $this->nm_new_label['statesignaturedocument']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_json_response_line" id="hidden_field_data_json_response" style="<?php echo $sStyleHidden_json_response; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_json_response_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_json_response_label" style=""><span id="id_label_json_response"><?php echo $this->nm_new_label['json_response']; ?></span></span><br>
...
<span id="id_read_on_json_response" class="sc-ui-readonly-json_response css_json_response_line" style="<?php echo $sStyleReadLab_json_response; ?>"><?php echo $this->form_format_readonly("json_response", $this->form_encode_input($this->json_response)); ?></span><span id="id_read_off_json_response" class="css_read_off_json_response<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_json_response; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=50"; } ?> maxlength=950000 alt="{datatype: 'text', maxLength: 950000, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_verifyupdate_line" id="hidden_field_data_verifyupdate" style="<?php echo $sStyleHidden_verifyupdate; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_verifyupdate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_verifyupdate_label" style=""><span id="id_label_verifyupdate"><?php echo $this->nm_new_label['verifyupdate']; ?></span></span><br>
...
<input type="hidden" name="estadoreg" value="<?php echo $this->form_encode_input($estadoreg) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_estadoreg_line" id="hidden_field_data_estadoreg" style="<?php echo $sStyleHidden_estadoreg; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_estadoreg_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_estadoreg_label" style=""><span id="id_label_estadoreg"><?php echo $this->nm_new_label['estadoreg']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["estadoreg"]) &&  $this->nmgp_cmp_readonly["estadoreg"] == "on") { 

 ?>
<input type="hidden" name="estadoreg" value="<?php echo $this->form_encode_input($estadoreg) . "\">" . $estadoreg . ""; ?>
<?php } else { ?>
<span id="id_read_on_estadoreg" class="sc-ui-readonly-estadoreg css_estadoreg_line" style="<?php echo $sStyleReadLab_estadoreg; ?>"><?php echo $this->form_format_readonly("estadoreg", $this->form_encode_input($this->estadoreg)); ?></span><span id="id_read_off_estadoreg" class="css_read_off_estadoreg<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_estadoreg; ?>">
 <input class="sc-js-input scFormObjectOdd css_estadoreg_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_estadoreg" type=text name="estadoreg" value="<?php echo $this->form_encode_input($estadoreg) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=1"; } ?> maxlength=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_ado_records_borrar_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_ado_records_borrar_mob");
 parent.scAjaxDetailHeight("form_ado_records_borrar_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_borrar_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
