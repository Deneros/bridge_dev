...
?>
  ...
  function do_ajax_form_parametros_validate_idparametro()
  {
    var nomeCampo_idparametro = "idparametro";
    var var_idparametro = scAjaxGetFieldText(nomeCampo_idparametro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_validate_idparametro(var_idparametro, var_script_case_init, do_ajax_form_parametros_validate_idparametro_cb);
  } // do_ajax_form_parametros_validate_idparametro

  function do_ajax_form_parametros_validate_idparametro_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_validate_idparametro_cb

  // ---------- Validate valor
  function do_ajax_form_parametros_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_validate_valor(var_valor, var_script_case_init, do_ajax_form_parametros_validate_valor_cb);
  } // do_ajax_form_parametros_validate_valor

  function do_ajax_form_parametros_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_validate_valor_cb

  // ---------- Validate descripcion
  function do_ajax_form_parametros_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_parametros_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_parametros_validate_descripcion_cb);
  } // do_ajax_form_parametros_validate_descripcion

  function do_ajax_form_parametros_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_parametros_validate_descripcion_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_form_parametros_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_parametros_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_parametros_submit_form(var_idparametro, var_valor, var_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_parametros_submit_form_cb);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_parametros_submit_form_cb_after_alert);
  } // do_ajax_form_parametros_submit_form_cb
  function do_ajax_form_parametros_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_parametros_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_parametros_navigate_form()
  {
    perform_ajax_form_parametros_navigate_form();
  }

  function perform_ajax_form_parametros_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_parametros_navigate_form(var_idparametro, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_parametros_navigate_form_cb);
  } // do_ajax_form_parametros_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_parametros']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_parametros_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_parametros_navigate_form_cb_after_alert);
  } // do_ajax_form_parametros_navigate_form_cb
  function do_ajax_form_parametros_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_parametros_navigate_form_cb_after_alert
  function sc_hide_form_parametros_form()
  {
