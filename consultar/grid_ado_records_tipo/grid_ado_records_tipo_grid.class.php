<?php
class grid_ado_records_tipo_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['charts_html'] = '';
   ...
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_Ind_Groupby'] != "sc_free_total")
      {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "grid_ado_records_tipo/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new grid_ado_records_tipo_resumo();
       $this->Res->Db     = $this->Db;
       $this->Res->Erro   = $this->Erro;
       $this->Res->Ini    = $this->Ini;
       $this->Res->Lookup = $this->Lookup;
      }
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_ado_records_tipo'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "pdf")
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_pdf']['label_group'] : "S";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_pdf']['all_cab'] : "N";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_pdf']['all_label'] : "N";
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_ado_records_tipo/grid_ado_records_tipo_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['pesq_tab_label'] .= "record?#?" . "" . $this->Ini->Nm_lang['lang_ado_records_fld_Record'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['pesq_tab_label'] .= "startingdate?#?" . "" . $this->Ini->Nm_lang['lang_ado_records_fld_StartingDate'] . "" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_search_add']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_ado_records_tipo", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] = "muda_qt_linhas";
   } 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_ado_records_tipo'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_ado_records_tipo'];
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_ado_records_tipo/grid_ado_records_tipo_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_ado_records_tipo_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_ado_records_tipo_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_select']['record'] = 'DESC'; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['tot_geral'][1] > 3)
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['tot_geral'][1] = 3;  
   } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['contr_array_resumo']))  
       { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, 3, 0);
   }
   else  
   {
       $Limit_grid = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['link_res_limit']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['link_res_limit'] > 0) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['link_res_limit'] :  3;
   ...
   { 
       ...
       $this->firstname = $this->rs_grid->fields[3] ;  
       $this->firstsurname = $this->rs_grid->fields[4] ;  
       $this->transactiontypename = $this->rs_grid->fields[5] ;  
       $this->transactionid = $this->rs_grid->fields[6] ;  
       $this->extras = $this->rs_grid->fields[7] ;  
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'])
   { 
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_ado_records_tipo_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_ado_records_tipo_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_ado_records_tipo_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_ado_records_tipo_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_ado_records_tipo_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   </form>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_ado_records_tipo_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_ado_records_tipo_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_ado_records_tipo_message.js\"></script>\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_reg_grid']) . ";\r\n");
           }
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_ado_records_tipo_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_ado_records_tipo_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_ado_records_tipo_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_ado_records_tipo/grid_ado_records_tipo_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".grid_ado_records_tipo_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf" && !$this->Print_All)
       { 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_ado_records_tipo']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_ado_records_tipo']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_ado_records_tipo']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_ado_records_tipo']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida']) ? "grid_ado_records_tipo_" : "";
   $this->css_sep = " ";
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $salva_htm_emb  = "";
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_label'])
   { 
       $this->New_label['record'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_Record'] . "";
       $this->New_label['startingdate'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_StartingDate'] . "";
       $this->New_label['creationip'] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_CreationIP'] . "";
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_ado_records_tipo__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_ado_records_tipo-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_extras_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_extras_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".grid_ado_records_tipo_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_record()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_cmp'] == 'Record')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_label'] == "desc")
          {
 ...
 function NM_label_startingdate()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_cmp'] == 'StartingDate')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_creationip()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_cmp'] == 'CreationIP')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_firstsurname()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_firstsurname_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_firstsurname_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_transactiontypename()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_transactiontypename_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_transactiontypename_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_transactionid()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_transactionid_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_transactionid_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_extras()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_extras_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_extras_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
// 
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ini_cor_grid']);
       }
   }
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['labels']['record'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['startingdate'])) ? $this->New_label['startingdate'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['labels']['startingdate'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['creationip'])) ? $this->New_label['creationip'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['labels']['creationip'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['firstname'])) ? $this->New_label['firstname'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['labels']['firstname'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['firstsurname'])) ? $this->New_label['firstsurname'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['labels']['firstsurname'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['transactiontypename'])) ? $this->New_label['transactiontypename'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['labels']['transactiontypename'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['transactionid'])) ? $this->New_label['transactionid'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['labels']['transactionid'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['extras'])) ? $this->New_label['extras'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['labels']['extras'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_ado_records_tipo#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['force_toolbar'] = true;
           } 
   ...
   { 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['proc_pdf'])
{
}
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_grid_ado_records_tipo#?#1\"";
   } 
   $TD_padding = "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['proc_pdf_vert'])
{
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-6e9e6d4a\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Config_Page_break_PDF'] = "N";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Page_break_PDF'] = array();
       }
   }
   ...
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          $this->NM_field_style = array();
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_ado_records_tipo_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_Ind_Groupby'] != "sc_free_total")
         {
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "pdf")
          {
              $this->Res->nm_acum_res_unit($this->rs_grid);
          }
         }
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['rows_emb']++;
...
$_SESSION['scriptcase']['grid_ado_records_tipo']['contr_erro'] = 'off';
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['dado_psq_ret'];
              eval("\$teste = \$this->$temp;");
          }
          $this->SC_ancora = $this->SC_seq_page;
          $nm_saida->saida("    <TR  class=\"" . $this->css_line_back . "\"" . $NM_destaque . " id=\"SC_ancor" . $this->SC_ancora . "\">\r\n");
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_extras_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_extras_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['final'] == 3)
          { 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_grid'])
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['print_navigator'] == "Netscape")
            {
        ...
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_geral_sc_free_total_bot() 
 {
   ...
   function nmgp_barra_top_mobile()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ajax_nav'])
          {
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $this->nm_btn_exist['sel_col'][] = "selcmp_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_ado_records_tipo/grid_ado_records_tipo_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_ado_records_tipo/grid_ado_records_tipo_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          else
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_ado_records_tipo/grid_ado_records_tipo_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_ado_records_tipo/grid_ado_records_tipo_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      ...
      if ($this->nmgp_botoes['group_3'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          $Xls_mod_export = "grid";
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          $Xml_mod_export = "grid";
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          $Csv_mod_export = "";
      ...
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_3_top = true;</script>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form)
      {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_Ind_Groupby'] != "sc_free_total")
        {
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
          ...
          if (is_file("grid_ado_records_tipo_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_ado_records_tipo_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['sc_modal'])
        {
   ...
   function nmgp_barra_bot_mobile()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao_print'] != "print") 
      {
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_lin_grid'] == 50) ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $nm_saida->saida("          </select>\r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_liga']['nav']))
          {
   ...
   function html_grid_search()
   {
       ...
       $tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'];
       $pos = strrpos($tmp, "##*@@");
       if ($pos !== false)
       {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "record")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "record";
                           $lin_obj = $this->grid_search_record($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "startingdate")
                        {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('record','startingdate');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq']) < 2)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_record($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_record_" . $ind . "' style='display:none'>";
       ...
       $lin_obj .= "       <select id='grid_search_record_cond_" . $ind . "' name='cond_grid_search_record_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"record\", $ind)'>";
       ...
       $lin_obj .= "       <span id=\"grid_record_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "OpenIdConnect/grid_ado_records_tipo";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_ado_records_tipo_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_ado_records_tipo_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_ado_records_tipo_valida_hora(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_ado_records_tipo_valida_min(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_ado_records_tipo_valida_seg(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       $nm_saida->saida("     if (obj.value != \"\" && (obj.value < 0 || obj.value > 59))\r\n");
       $nm_saida->saida("     {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['startingdate_mes'] =  'sc_grid_ado_records_tipo_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['startingdate_dia'] =  'sc_grid_ado_records_tipo_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['startingdate_hor'] =  'sc_grid_ado_records_tipo_valida_hora(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['startingdate_min'] =  'sc_grid_ado_records_tipo_valida_min(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['startingdate_seg'] =  'sc_grid_ado_records_tipo_valida_seg(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['startingdate_v2__mes'] =  'sc_grid_ado_records_tipo_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['startingdate_v2__dia'] =  'sc_grid_ado_records_tipo_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['startingdate_v2__hor'] =  'sc_grid_ado_records_tipo_valida_hora(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['startingdate_v2__min'] =  'sc_grid_ado_records_tipo_valida_min(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['startingdate_v2__seg'] =  'sc_grid_ado_records_tipo_valida_seg(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['startingdate_mes']", 'value' => 'sc_grid_ado_records_tipo_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['startingdate_dia']", 'value' => 'sc_grid_ado_records_tipo_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['startingdate_hor']", 'value' => 'sc_grid_ado_records_tipo_valida_hora(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['startingdate_min']", 'value' => 'sc_grid_ado_records_tipo_valida_min(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['startingdate_seg']", 'value' => 'sc_grid_ado_records_tipo_valida_seg(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['startingdate_v2__mes']", 'value' => 'sc_grid_ado_records_tipo_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['startingdate_v2__dia']", 'value' => 'sc_grid_ado_records_tipo_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['startingdate_v2__hor']", 'value' => 'sc_grid_ado_records_tipo_valida_hora(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['startingdate_v2__min']", 'value' => 'sc_grid_ado_records_tipo_valida_min(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['startingdate_v2__seg']", 'value' => 'sc_grid_ado_records_tipo_valida_seg(this)');
       } 
       ...
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'record')\r\n");
       $nm_saida->saida("                 {\r\n");
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </TABLE>\r\n");
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
       } 
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_ado_records_tipo', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_ado_records_tipo\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_ado_records_tipo_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"grid_ado_records_tipo_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_ado_records_tipo_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_ado_records_tipo@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_ado_records_tipo']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_ado_records_tipo_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_ado_records_tipo')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_ado_records_tipo', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
