...
class grid_ado_records_tipo_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_ado_records_tipo_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_ado_records_tipo_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_ado_records_tipo_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "StartingDate";$Nm_datas[] = "StartingDate";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_ado_records_tipo/grid_ado_records_tipo_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_ado_records_tipo_ajax_search.js"></script>
 <script type="text/javascript" src="grid_ado_records_tipo_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_ado_records_tipo_message.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_record_cond#NMF#' + search_get_sel_txt('SC_record_cond') + '@NMF@';
  str_out += 'SC_record#NMF#' + search_get_text('SC_record') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $record = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['record']; 
          $record_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['record_cond']; 
          $startingdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_dia']; 
          $startingdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_mes']; 
          $startingdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_ano']; 
          $startingdate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_input_2_dia']; 
          $startingdate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_input_2_mes']; 
          $startingdate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_input_2_ano']; 
          $startingdate_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_hor']; 
          $startingdate_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_min']; 
          $startingdate_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_seg']; 
          $startingdate_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_input_2_hor']; 
          $startingdate_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_input_2_min']; 
          $startingdate_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_input_2_seg']; 
          $startingdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['NM_operador']; 
          if (strtoupper($record_cond) != "II" && strtoupper($record_cond) != "QP" && strtoupper($record_cond) != "NP" && strtoupper($record_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($record, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($record_cond) || empty($record_cond))
      {
         $record_cond = "gt";
      }
      ...
      $str_hide_record = (in_array($record_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_startingdate = (in_array($startingdate_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_record = ('bw' == $record_cond) ? $display_aberto : $display_fechado;
      ...
      {
         $tmp_pos = strpos($record, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $record = substr($record, 0, $tmp_pos);
         }
      }
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_record_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['record'])) ? $this->New_label['record'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_Record'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_record_cond" name="record_cond" onChange="nm_campos_between(document.getElementById('id_vis_record'), this, 'record')">
       <OPTION value="gt" <?php if ("gt" == $record_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $record_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $record_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_record" <?php echo $str_hide_record?> valign="top">
 ...
 $nmgp_tab_label .= "record?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_record" name="record" value="<?php echo NM_encode_input($record) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_startingdate_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['startingdate'])) ? $this->New_label['startingdate'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_StartingDate'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_startingdate_cond" name="startingdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_startingdate'), this, 'startingdate')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_startingdate" <?php echo $str_hide_startingdate?> valign="top">
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_startingdate_dia" name="startingdate_dia" value="<?php echo NM_encode_input($startingdate_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_startingdate_mes" name="startingdate_mes" value="<?php echo NM_encode_input($startingdate_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_startingdate_ano" name="startingdate_ano" value="<?php echo NM_encode_input($startingdate_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_startingdate_hor" name="startingdate_hor" value="<?php echo NM_encode_input($startingdate_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_startingdate_min" name="startingdate_min" value="<?php echo NM_encode_input($startingdate_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_startingdate_seg" name="startingdate_seg" value="<?php echo NM_encode_input($startingdate_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
        <SPAN id="id_css_startingdate"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_startingdate"  <?php echo $str_display_startingdate; ?> class="scFilterFieldFontEven">
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_startingdate_input_2_dia" name="startingdate_input_2_dia" value="<?php echo NM_encode_input($startingdate_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_startingdate_input_2_mes" name="startingdate_input_2_mes" value="<?php echo NM_encode_input($startingdate_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_startingdate_input_2_ano" name="startingdate_input_2_ano" value="<?php echo NM_encode_input($startingdate_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_startingdate_input_2_hor" name="startingdate_input_2_hor" value="<?php echo NM_encode_input($startingdate_input_2_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_startingdate_input_2_min" name="startingdate_input_2_min" value="<?php echo NM_encode_input($startingdate_input_2_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_startingdate_input_2_seg" name="startingdate_input_2_seg" value="<?php echo NM_encode_input($startingdate_input_2_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_ado_records_tipo_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_tipo']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.record_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_record'), document.F1.record_cond, 'record');
   document.F1.record.value = "";
 ...
 {
    $('#SC_startingdate_dia').bind('change', function() {sc_grid_ado_records_tipo_valida_dia(this)});
    $('#SC_startingdate_hor').bind('change', function() {sc_grid_ado_records_tipo_valida_hora(this)});
    $('#SC_startingdate_input_2_dia').bind('change', function() {sc_grid_ado_records_tipo_valida_dia(this)});
    $('#SC_startingdate_input_2_hor').bind('change', function() {sc_grid_ado_records_tipo_valida_hora(this)});
    $('#SC_startingdate_input_2_mes').bind('change', function() {sc_grid_ado_records_tipo_valida_mes(this)});
    $('#SC_startingdate_input_2_min').bind('change', function() {sc_grid_ado_records_tipo_valida_min(this)});
    $('#SC_startingdate_input_2_seg').bind('change', function() {sc_grid_ado_records_tipo_valida_seg(this)});
    $('#SC_startingdate_mes').bind('change', function() {sc_grid_ado_records_tipo_valida_mes(this)});
    $('#SC_startingdate_min').bind('change', function() {sc_grid_ado_records_tipo_valida_min(this)});
    $('#SC_startingdate_seg').bind('change', function() {sc_grid_ado_records_tipo_valida_seg(this)});
 }
 function sc_grid_ado_records_tipo_valida_dia(obj)
 {
 ...
 function sc_grid_ado_records_tipo_valida_mes(obj)
 {
 ...
 function sc_grid_ado_records_tipo_valida_hora(obj)
 {
 ...
 function sc_grid_ado_records_tipo_valida_min(obj)
 {
 ...
 function sc_grid_ado_records_tipo_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_ado_records_tipo/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_record_cond'] = 'cond';
      $tp_fields['SC_record'] = 'text';
   ...
   {
      global $record_cond, $record,
             $startingdate_cond, $startingdate, $startingdate_dia, $startingdate_mes, $startingdate_ano, $startingdate_hor, $startingdate_min, $startingdate_seg, $startingdate_input_2_dia, $startingdate_input_2_mes, $startingdate_input_2_ano, $startingdate_input_2_min, $startingdate_input_2_hor, $startingdate_input_2_seg, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $record_cond_salva = $record_cond; 
      if (!isset($record_input_2) || $record_input_2 == "")
      {
          $record_input_2 = $record;
      }
      ...
      if ($record_cond != "in")
      {
          nm_limpa_numero($record, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['record'] = $record; 
      if (is_array($record) && !empty($record))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['val'][0] = $record;
      }
      elseif ($record_cond_salva == "nu" || $record_cond_salva == "nn" || $record_cond_salva == "ep" || $record_cond_salva == "ne" || !empty($record))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['val'][0][0] = $record;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['record_cond'] = $record_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['cmp'] = "record"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['opc'] = $record_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq']['record'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_dia'] = $startingdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_mes'] = $startingdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_ano'] = $startingdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_input_2_dia'] = $startingdate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_input_2_mes'] = $startingdate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_input_2_ano'] = $startingdate_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $startingdate_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $startingdate_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $startingdate_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $startingdate_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $startingdate_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $startingdate_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_hor'] = $startingdate_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_min'] = $startingdate_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_seg'] = $startingdate_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_input_2_hor'] = $startingdate_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_input_2_min'] = $startingdate_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_input_2_seg'] = $startingdate_input_2_seg; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $startingdate_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $startingdate_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $startingdate_seg;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['val'][1][] = "H:" . $startingdate_input_2_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['val'][1][] = "I:" . $startingdate_input_2_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['val'][1][] = "S:" . $startingdate_input_2_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_cond'] = $startingdate_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['cmp'] = "startingdate"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid]['opc'] = $startingdate_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq']['startingdate'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['record'] = $Conteudo;

      //----- $record
      $this->Date_part = false;
      if (isset($record) || $record_cond == "nu" || $record_cond == "nn" || $record_cond == "ep" || $record_cond == "ne")
      {
         $this->monta_condicao("Record", $record_cond, $record, "", "record");
      }
      ...
      if ($startingdate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate'] = $val[0];
          ...
          if ($startingdate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']['startingdate_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq']['startingdate']['label'] = $nmgp_tab_label['startingdate'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq']['startingdate']['descr'] = $nmgp_tab_label['startingdate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['grid_pesq']['startingdate']['hint']  = $nmgp_tab_label['startingdate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_tipo']['cond_pesq'] .= $this->NM_operador;
