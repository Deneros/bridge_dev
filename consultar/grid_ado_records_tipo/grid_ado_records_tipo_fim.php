...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_ado_records_tipo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_ado_records_tipo"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ado_records_tipo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ado_records_tipo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ado_records_tipo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ado_records_tipo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ado_records_tipo']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ado_records_tipo</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ado_records_tipo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ado_records_tipo']['embutida_filho'] as $ind => $sc_init)
          {
