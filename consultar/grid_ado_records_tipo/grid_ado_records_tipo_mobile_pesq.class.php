...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "StartingDate";$Nm_datas[] = "StartingDate";$Nm_numeric[] = "record";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_record_cond" name="record_cond" onChange="nm_campos_between(document.getElementById('id_vis_record'), this, 'record')">
      ...
      <br><span id="id_hide_record"  <?php echo $str_hide_record?>><INPUT  type="text" id="SC_record" name="record" value="<?php echo NM_encode_input($record) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_startingdate_cond" name="startingdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_startingdate'), this, 'startingdate')">
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_startingdate"  <?php echo $str_display_startingdate; ?> class="scFilterFieldFontEven">
