<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_ado_records_tipo']['glo_nm_path_imag_temp'] . "/sc_apl_default_OpenIdConnect.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_ado_records_tipo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_ado_records_tipo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["record"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["record"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["record"] : "" . $this->Nm_lang['lang_ado_records_fld_Record'] . "";
   $tab_ger_campos['startingdate'] = "on";
   $tab_def_campos['startingdate'] = "StartingDate";
   $tab_labels["startingdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["startingdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["startingdate"] : "" . $this->Nm_lang['lang_ado_records_fld_StartingDate'] . "";
   $tab_ger_campos['creationip'] = "on";
   $tab_def_campos['creationip'] = "CreationIP";
   $tab_labels["creationip"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["creationip"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["creationip"] : "" . $this->Nm_lang['lang_ado_records_fld_CreationIP'] . "";
   $tab_ger_campos['firstname'] = "on";
   $tab_def_campos['firstname'] = "FirstName";
   $tab_labels["firstname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["firstname"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["firstname"] : "" . $this->Nm_lang['lang_ado_records_fld_FirstName'] . "";
   $tab_ger_campos['firstsurname'] = "on";
   $tab_def_campos['firstsurname'] = "FirstSurname";
   $tab_labels["firstsurname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["firstsurname"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["firstsurname"] : "" . $this->Nm_lang['lang_ado_records_fld_FirstSurname'] . "";
   $tab_ger_campos['transactiontypename'] = "on";
   $tab_def_campos['transactiontypename'] = "TransactionTypeName";
   $tab_labels["transactiontypename"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["transactiontypename"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["transactiontypename"] : "" . $this->Nm_lang['lang_ado_records_fld_TransactionTypeName'] . "";
   $tab_ger_campos['transactionid'] = "on";
   $tab_def_campos['transactionid'] = "TransactionId";
   $tab_labels["transactionid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["transactionid"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["transactionid"] : "" . $this->Nm_lang['lang_ado_records_fld_TransactionId'] . "";
   $tab_ger_campos['extras'] = "on";
   $tab_def_campos['extras'] = "Extras";
   $tab_labels["extras"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["extras"])) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['labels']["extras"] : "" . $this->Nm_lang['lang_ado_records_fld_Extras'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_ado_records_tipo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_ado_records_tipo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
