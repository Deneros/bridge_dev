...
class grid_ado_records_bck_140123_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_idnumber = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['arr_total']['idnumber'];
      }
      else
      {
          $this->array_total_idnumber = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['arr_total']['idnumber'] = $this->array_total_idnumber;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['labels']['idnumber'] = $Lab_idnumber; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_order']['IdNumber']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_order']['IdNumber'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_order']['IdNumber'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_display']['IdNumber'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_display']['IdNumber'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_display']['IdNumber'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_display']['IdNumber'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_display']['IdNumber'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_display']['IdNumber'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_display']['IdNumber'] as $i_sum => $d_sum)
           {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_IdNumber("res");
