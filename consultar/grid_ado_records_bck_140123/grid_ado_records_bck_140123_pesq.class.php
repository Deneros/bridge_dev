...
class grid_ado_records_bck_140123_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_ado_records_bck_140123_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_ado_records_bck_140123_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_ado_records_bck_140123_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idnumber')
      {
          $idnumber = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idnumber($idnumber);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_secondname')
      {
          $secondname = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_secondname($secondname);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_placebirth')
      {
          $placebirth = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_placebirth($placebirth);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      $Nm_datas[] = "StartingDate";$Nm_datas[] = "StartingDate";$Nm_datas[] = "CreationDate";$Nm_datas[] = "CreationDate";$Nm_datas[] = "BirthDate";$Nm_datas[] = "BirthDate";$Nm_datas[] = "IssueDate";$Nm_datas[] = "IssueDate";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_ado_records'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_ado_records_bck_140123/grid_ado_records_bck_140123_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_ado_records_bck_140123_ajax_search.js"></script>
 <script type="text/javascript" src="grid_ado_records_bck_140123_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_ado_records_bck_140123_message.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idnumber_cond#NMF#' + search_get_sel_txt('SC_idnumber_cond') + '@NMF@';
  str_out += 'SC_idnumber#NMF#' + search_get_text('SC_idnumber') + '@NMF@';
  str_out += 'id_ac_idnumber#NMF#' + search_get_text('id_ac_idnumber') + '@NMF@';
  ...
  str_out += 'SC_secondname_cond#NMF#' + search_get_sel_txt('SC_secondname_cond') + '@NMF@';
  str_out += 'SC_secondname#NMF#' + search_get_text('SC_secondname') + '@NMF@';
  str_out += 'id_ac_secondname#NMF#' + search_get_text('id_ac_secondname') + '@NMF@';
  ...
  str_out += 'SC_placebirth_cond#NMF#' + search_get_sel_txt('SC_placebirth_cond') + '@NMF@';
  str_out += 'SC_placebirth#NMF#' + search_get_text('SC_placebirth') + '@NMF@';
  str_out += 'id_ac_placebirth#NMF#' + search_get_text('id_ac_placebirth') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_idnumber").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_idnumber").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_idnumber",
          max_itens: "10",
          cod_desc: "N",
   ...
   scClass = $("#id_ac_secondname").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_secondname").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_secondname",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_secondname").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_secondname").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_placebirth").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_placebirth").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_placebirth",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_placebirth").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $idnumber_cond, $idnumber, $idnumber_autocomp,
             $firstname_cond, $firstname, $firstname_autocomp,
             $secondname_cond, $secondname, $secondname_autocomp,
             $gender_cond, $gender,
             $issuedate_cond, $issuedate, $issuedate_dia, $issuedate_mes, $issuedate_ano, $issuedate_input_2_dia, $issuedate_input_2_mes, $issuedate_input_2_ano,
             $birthdate_cond, $birthdate, $birthdate_dia, $birthdate_mes, $birthdate_ano, $birthdate_input_2_dia, $birthdate_input_2_mes, $birthdate_input_2_ano,
             $placebirth_cond, $placebirth, $placebirth_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $idnumber = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['idnumber']; 
          $idnumber_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['idnumber_cond']; 
          $firstname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['firstname']; 
          $firstname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['firstname_cond']; 
          $secondname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['secondname']; 
          $secondname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['secondname_cond']; 
          $gender = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['gender']; 
          $gender_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['gender_cond']; 
          $issuedate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_dia']; 
          $issuedate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_mes']; 
          $issuedate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_ano']; 
          $issuedate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_input_2_dia']; 
          $issuedate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_input_2_mes']; 
          $issuedate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_input_2_ano']; 
          $issuedate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_cond']; 
          $birthdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_dia']; 
          $birthdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_mes']; 
          $birthdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_ano']; 
          $birthdate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_input_2_dia']; 
          $birthdate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_input_2_mes']; 
          $birthdate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_input_2_ano']; 
          $birthdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_cond']; 
          $placebirth = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['placebirth']; 
          $placebirth_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['placebirth_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['NM_operador']; 
      } 
      if (!isset($idnumber_cond) || empty($idnumber_cond))
      {
         $idnumber_cond = "qp";
      }
      ...
      if (!isset($secondname_cond) || empty($secondname_cond))
      {
         $secondname_cond = "qp";
      }
      ...
      if (!isset($placebirth_cond) || empty($placebirth_cond))
      {
         $placebirth_cond = "eq";
      }
      ...
      $str_hide_idnumber = (in_array($idnumber_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_firstname = (in_array($firstname_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_secondname = (in_array($secondname_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_placebirth = (in_array($placebirth_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_idnumber = ('bw' == $idnumber_cond) ? $display_aberto : $display_fechado;
      $str_display_firstname = ('bw' == $firstname_cond) ? $display_aberto : $display_fechado;
      $str_display_secondname = ('bw' == $secondname_cond) ? $display_aberto : $display_fechado;
      ...
      $str_display_placebirth = ('bw' == $placebirth_cond) ? $display_aberto : $display_fechado;

      if (!isset($idnumber) || $idnumber == "")
      {
          $idnumber = "";
      }
      if (isset($idnumber) && !empty($idnumber))
      {
      ...
      if (!isset($placebirth) || $placebirth == "")
      {
          $placebirth = "";
      }
      if (isset($placebirth) && !empty($placebirth))
      {
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idnumber_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idnumber'])) ? $this->New_label['idnumber'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_IdNumber'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idnumber_cond" name="idnumber_cond" onChange="nm_campos_between(document.getElementById('id_vis_idnumber'), this, 'idnumber')">
       <OPTION value="qp" <?php if ("qp" == $idnumber_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $idnumber_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idnumber_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idnumber" <?php echo $str_hide_idnumber?> valign="top">
 ...
 $nmgp_tab_label .= "idnumber?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $idnumber;
      }
?>
<INPUT  type="text" id="SC_idnumber" name="idnumber" value="<?php echo NM_encode_input($idnumber) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idnumber" name="idnumber_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_firstname_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['firstname'])) ? $this->New_label['firstname'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_FirstName'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_firstname_cond" name="firstname_cond" onChange="nm_campos_between(document.getElementById('id_vis_firstname'), this, 'firstname')">
       ...
       <OPTION value="ii" <?php if ("ii" == $firstname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_firstname" name="firstname_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_secondname_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['secondname'])) ? $this->New_label['secondname'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_SecondName'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_secondname_cond" name="secondname_cond" onChange="nm_campos_between(document.getElementById('id_vis_secondname'), this, 'secondname')">
       <OPTION value="qp" <?php if ("qp" == $secondname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $secondname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $secondname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $secondname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_secondname" <?php echo $str_hide_secondname?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['secondname'])) ? $this->New_label['secondname'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_SecondName'] . "";
 $nmgp_tab_label .= "secondname?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $secondname;
      }
?>
<INPUT  type="text" id="SC_secondname" name="secondname" value="<?php echo NM_encode_input($secondname) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_secondname" name="secondname_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_gender_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['gender'])) ? $this->New_label['gender'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_Gender'] . ""; ?></TD>
...
<?php
 ...
 <OPTION value=""><?php echo $this->Ini->Nm_lang['lang_form_seleccione'] ?></option>
 ...
 <OPTION value="F##@@<?php echo $this->Ini->Nm_lang['lang_femenino'] ?>"<?php if ($gender == "F") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_femenino'] ?></option>
      ...
      <TD id='SC_issuedate_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['issuedate'])) ? $this->New_label['issuedate'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_IssueDate'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_issuedate_cond" name="issuedate_cond" onChange="nm_campos_between(document.getElementById('id_vis_issuedate'), this, 'issuedate')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_issuedate" <?php echo $str_hide_issuedate?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_issuedate_dia" name="issuedate_dia" value="<?php echo NM_encode_input($issuedate_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_issuedate_mes" name="issuedate_mes" value="<?php echo NM_encode_input($issuedate_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_issuedate_ano" name="issuedate_ano" value="<?php echo NM_encode_input($issuedate_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_issuedate"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_issuedate"  <?php echo $str_display_issuedate; ?> class="scFilterFieldFontOdd">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_issuedate_input_2_dia" name="issuedate_input_2_dia" value="<?php echo NM_encode_input($issuedate_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_issuedate_input_2_mes" name="issuedate_input_2_mes" value="<?php echo NM_encode_input($issuedate_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_issuedate_input_2_ano" name="issuedate_input_2_ano" value="<?php echo NM_encode_input($issuedate_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
      ...
      <TD id='SC_birthdate_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['birthdate'])) ? $this->New_label['birthdate'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_BirthDate'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_birthdate_cond" name="birthdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_birthdate'), this, 'birthdate')">
...
?>
        <SPAN id="id_css_birthdate"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_birthdate"  <?php echo $str_display_birthdate; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>
         <BR>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_birthdate_input_2_dia" name="birthdate_input_2_dia" value="<?php echo NM_encode_input($birthdate_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_birthdate_input_2_mes" name="birthdate_input_2_mes" value="<?php echo NM_encode_input($birthdate_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_birthdate_input_2_ano" name="birthdate_input_2_ano" value="<?php echo NM_encode_input($birthdate_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
      ...
      <TD id='SC_placebirth_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['placebirth'])) ? $this->New_label['placebirth'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_PlaceBirth'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_placebirth_cond" name="placebirth_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_placebirth" <?php echo $str_hide_placebirth?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['placebirth'])) ? $this->New_label['placebirth'] : "" . $this->Ini->Nm_lang['lang_ado_records_fld_PlaceBirth'] . "";
 $nmgp_tab_label .= "placebirth?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $placebirth;
      }
?>
<INPUT  type="text" id="SC_placebirth" name="placebirth" value="<?php echo NM_encode_input($placebirth) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_placebirth" name="placebirth_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_ado_records_bck_140123_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_bck_140123']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_ado_records_bck_140123']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idnumber_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_idnumber'), document.F1.idnumber_cond, 'idnumber');
   document.F1.idnumber.value = "";
   document.F1.idnumber_autocomp.value = "";
   ...
   document.F1.secondname_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_secondname'), document.F1.secondname_cond, 'secondname');
   document.F1.secondname.value = "";
   document.F1.secondname_autocomp.value = "";
   ...
   document.F1.placebirth_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_placebirth'), document.F1.placebirth_cond, 'placebirth');
   document.F1.placebirth.value = "";
   document.F1.placebirth_autocomp.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_birthdate_dia').bind('change', function() {sc_grid_ado_records_bck_140123_valida_dia(this)});
    $('#SC_birthdate_input_2_dia').bind('change', function() {sc_grid_ado_records_bck_140123_valida_dia(this)});
    $('#SC_birthdate_input_2_mes').bind('change', function() {sc_grid_ado_records_bck_140123_valida_mes(this)});
    $('#SC_birthdate_mes').bind('change', function() {sc_grid_ado_records_bck_140123_valida_mes(this)});
    $('#SC_issuedate_dia').bind('change', function() {sc_grid_ado_records_bck_140123_valida_dia(this)});
    $('#SC_issuedate_input_2_dia').bind('change', function() {sc_grid_ado_records_bck_140123_valida_dia(this)});
    $('#SC_issuedate_input_2_mes').bind('change', function() {sc_grid_ado_records_bck_140123_valida_mes(this)});
    $('#SC_issuedate_mes').bind('change', function() {sc_grid_ado_records_bck_140123_valida_mes(this)});
 }
 function sc_grid_ado_records_bck_140123_valida_dia(obj)
 {
 ...
 function sc_grid_ado_records_bck_140123_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_ado_records_bck_140123/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idnumber_cond'] = 'cond';
      $tp_fields['SC_idnumber'] = 'text_aut';
      $tp_fields['id_ac_idnumber'] = 'text_aut';
      $tp_fields['SC_firstname_cond'] = 'cond';
      $tp_fields['SC_firstname'] = 'text_aut';
      $tp_fields['id_ac_firstname'] = 'text_aut';
      $tp_fields['SC_secondname_cond'] = 'cond';
      $tp_fields['SC_secondname'] = 'text_aut';
      $tp_fields['id_ac_secondname'] = 'text_aut';
      ...
      $tp_fields['SC_placebirth_cond'] = 'cond';
      $tp_fields['SC_placebirth'] = 'text_aut';
      $tp_fields['id_ac_placebirth'] = 'text_aut';
   ...
   {
      global $idnumber_cond, $idnumber, $idnumber_autocomp,
             $firstname_cond, $firstname, $firstname_autocomp,
             $secondname_cond, $secondname, $secondname_autocomp,
             $gender_cond, $gender,
             $issuedate_cond, $issuedate, $issuedate_dia, $issuedate_mes, $issuedate_ano, $issuedate_input_2_dia, $issuedate_input_2_mes, $issuedate_input_2_ano,
             $birthdate_cond, $birthdate, $birthdate_dia, $birthdate_mes, $birthdate_ano, $birthdate_input_2_dia, $birthdate_input_2_mes, $birthdate_input_2_ano,
             $placebirth_cond, $placebirth, $placebirth_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($idnumber_autocomp) && empty($idnumber))
      {
          $idnumber = $idnumber_autocomp;
      }
      if (!empty($firstname_autocomp) && empty($firstname))
      {
          $firstname = $firstname_autocomp;
      }
      if (!empty($secondname_autocomp) && empty($secondname))
      {
          $secondname = $secondname_autocomp;
      }
      if (!empty($placebirth_autocomp) && empty($placebirth))
      {
          $placebirth = $placebirth_autocomp;
      }
      $idnumber_cond_salva = $idnumber_cond; 
      if (!isset($idnumber_input_2) || $idnumber_input_2 == "")
      {
          $idnumber_input_2 = $idnumber;
      }
      ...
      $secondname_cond_salva = $secondname_cond; 
      if (!isset($secondname_input_2) || $secondname_input_2 == "")
      {
          $secondname_input_2 = $secondname;
      }
      ...
      $placebirth_cond_salva = $placebirth_cond; 
      if (!isset($placebirth_input_2) || $placebirth_input_2 == "")
      {
          $placebirth_input_2 = $placebirth;
      }
      $tmp_pos = strpos($gender, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $gender;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['psq_check_ret']['gender'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['idnumber'] = $idnumber; 
      if (is_array($idnumber) && !empty($idnumber))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0] = $idnumber;
      }
      elseif ($idnumber_cond_salva == "nu" || $idnumber_cond_salva == "nn" || $idnumber_cond_salva == "ep" || $idnumber_cond_salva == "ne" || !empty($idnumber))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0][0] = $idnumber;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['idnumber_cond'] = $idnumber_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['cmp'] = "idnumber"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['opc'] = $idnumber_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq']['idnumber'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['firstname'] = $firstname; 
      if (is_array($firstname) && !empty($firstname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0] = $firstname;
      }
      elseif ($firstname_cond_salva == "nu" || $firstname_cond_salva == "nn" || $firstname_cond_salva == "ep" || $firstname_cond_salva == "ne" || !empty($firstname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0][0] = $firstname;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['firstname_cond'] = $firstname_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['cmp'] = "firstname"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['opc'] = $firstname_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq']['firstname'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['secondname'] = $secondname; 
      if (is_array($secondname) && !empty($secondname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0] = $secondname;
      }
      elseif ($secondname_cond_salva == "nu" || $secondname_cond_salva == "nn" || $secondname_cond_salva == "ep" || $secondname_cond_salva == "ne" || !empty($secondname))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0][0] = $secondname;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['secondname_cond'] = $secondname_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['cmp'] = "secondname"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['opc'] = $secondname_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq']['secondname'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['gender'] = $gender; 
      if (is_array($gender) && !empty($gender))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0] = $gender;
      }
      elseif ($gender_cond_salva == "nu" || $gender_cond_salva == "nn" || $gender_cond_salva == "ep" || $gender_cond_salva == "ne" || !empty($gender))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0][0] = $gender;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['gender_cond'] = $gender_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['cmp'] = "gender"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['opc'] = $gender_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq']['gender'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_dia'] = $issuedate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_mes'] = $issuedate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_ano'] = $issuedate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_input_2_dia'] = $issuedate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_input_2_mes'] = $issuedate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_input_2_ano'] = $issuedate_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $issuedate_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $issuedate_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $issuedate_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $issuedate_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $issuedate_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $issuedate_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_cond'] = $issuedate_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['cmp'] = "issuedate"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['opc'] = $issuedate_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq']['issuedate'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_dia'] = $birthdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_mes'] = $birthdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_ano'] = $birthdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_input_2_dia'] = $birthdate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_input_2_mes'] = $birthdate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_input_2_ano'] = $birthdate_input_2_ano; 
      if (!empty($birthdate_dia) || !empty($birthdate_mes) || !empty($birthdate_ano) || $birthdate_cond_salva == "nu" || $birthdate_cond_salva == "nn" || $birthdate_cond_salva == "ep" || $birthdate_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $birthdate_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $birthdate_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $birthdate_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $birthdate_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $birthdate_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $birthdate_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_cond'] = $birthdate_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['cmp'] = "birthdate"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['opc'] = $birthdate_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq']['birthdate'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['placebirth'] = $placebirth; 
      if (is_array($placebirth) && !empty($placebirth))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0] = $placebirth;
      }
      elseif ($placebirth_cond_salva == "nu" || $placebirth_cond_salva == "nn" || $placebirth_cond_salva == "ep" || $placebirth_cond_salva == "ne" || !empty($placebirth))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['val'][0][0] = $placebirth;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['placebirth_cond'] = $placebirth_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['cmp'] = "placebirth"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid]['opc'] = $placebirth_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq']['placebirth'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($idnumber != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idnumber'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['idnumber'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['idnumber'] = $idnumber;
      }
      $nmgp_def_dados = array();
    if ($firstname != '') {
      $firstname_look = substr($this->Db->qstr($firstname), 1, -1); 
    ...
    if ($secondname != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['secondname'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['secondname'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['secondname'] = $secondname;
      }
      $Conteudo = $gender;
    ...
    if ($placebirth != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['placebirth'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['placebirth'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['placebirth'] = $placebirth;
      }

      //----- $idnumber
      $this->Date_part = false;
      if (isset($idnumber) || $idnumber_cond == "nu" || $idnumber_cond == "nn" || $idnumber_cond == "ep" || $idnumber_cond == "ne")
      {
         $this->monta_condicao("IdNumber", $idnumber_cond, $idnumber, "", "idnumber");
      }
      ...
      //----- $secondname
      $this->Date_part = false;
      if (isset($secondname) || $secondname_cond == "nu" || $secondname_cond == "nn" || $secondname_cond == "ep" || $secondname_cond == "ne")
      {
         $this->monta_condicao("SecondName", $secondname_cond, $secondname, "", "secondname");
      }
      ...
      if ($issuedate_cond != "bi_TP")
      {
          ...
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATETIME", $issuedate_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $issuedate = $val[0];
          $this->cmp_formatado['issuedate'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['issuedate'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['issuedate'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          if ($issuedate_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['issuedate_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['issuedate_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['issuedate_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq']['issuedate']['label'] = $nmgp_tab_label['issuedate'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq']['issuedate']['descr'] = $nmgp_tab_label['issuedate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq']['issuedate']['hint']  = $nmgp_tab_label['issuedate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      if ($birthdate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate'] = $val[0];
          ...
          if ($birthdate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']['birthdate_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq']['birthdate']['label'] = $nmgp_tab_label['birthdate'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq']['birthdate']['descr'] = $nmgp_tab_label['birthdate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['grid_pesq']['birthdate']['hint']  = $nmgp_tab_label['birthdate'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }

      //----- $placebirth
      $this->Date_part = false;
      if (isset($placebirth) || $placebirth_cond == "nu" || $placebirth_cond == "nn" || $placebirth_cond == "ep" || $placebirth_cond == "ne")
      {
         $this->monta_condicao("PlaceBirth", $placebirth_cond, $placebirth, "", "placebirth");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['cond_pesq'] .= $this->NM_operador;
