...
class grid_ado_records_bck_140123_resumo
{
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_creationip = array();
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_creationip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['arr_total']['creationip'];
      }
      else
      {
          $this->array_total_creationip = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['arr_total']['creationip'] = $this->array_total_creationip;
   ...
   function completeMatrix()
   {
       ...
       {
          $Lab_creationip = "CreationIP";
       }
       else
       {
       $Lab_creationip = "" . $this->Ini->Nm_lang['lang_ado_records_fld_CreationIP'] . "";
       }
       $this->comp_field = array(
           $Lab_creationip,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['labels']['creationip'] = $Lab_creationip; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_order']['CreationIP']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_order']['CreationIP'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_order']['CreationIP'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_display']['CreationIP'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_display']['CreationIP'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_display']['CreationIP'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_display']['CreationIP'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_display']['CreationIP'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_display']['CreationIP'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['summarizing_fields_display']['CreationIP'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_creationip as $i_creationip => $d_creationip) {
           if (!in_array($i_creationip, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_creationip[3] ] = $d_creationip[2];
               $this->comp_label[0][ $d_creationip[3] ] = $d_creationip[2];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'creationip', 'prot' => '@aspass@'),
       );
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['pivot_order_level'] = -1;
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_creationip => $l_creationip) {
           if (isset($this->array_total_creationip[$i_creationip])) {
               $this->comp_group[$i_creationip] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_creationip;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_creationip)),
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_CreationIP("res");
      ...
      ksort($this->array_total_creationip);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_creationip, $quebra_creationip_orig)
   {
      //----- creationip
      if (!isset($this->array_total_creationip[$quebra_creationip_orig]))
      {
         $this->array_total_creationip[$quebra_creationip_orig][0] = 1;
         $this->array_total_creationip[$quebra_creationip_orig][1] = 1;
         $this->array_total_creationip[$quebra_creationip_orig][2] = $quebra_creationip;
         $this->array_total_creationip[$quebra_creationip_orig][3] = $quebra_creationip_orig;
      }
      else
      {
         $this->array_total_creationip[$quebra_creationip_orig][0]++;
         $this->array_total_creationip[$quebra_creationip_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'creationip');
     $campos_order = $this->Ini->Get_date_order_groupby("CreationIP", 'asc', $format, $campos_order);
...
$_SESSION['scriptcase']['grid_ado_records_bck_140123']['contr_erro'] = 'off'; 
            $this->creationip_orig = $this->creationip;
            $this->gender = $this->look_gender ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->creationip, $this->creationip_orig);
            }
   }
//
