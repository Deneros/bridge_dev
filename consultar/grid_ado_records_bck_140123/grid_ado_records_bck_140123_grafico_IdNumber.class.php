...
<?php
   ...
   function inicializa_vars()
   {
      ...
      //---- Label
      $this->label    = array();
      $this->label[0] = "" . $this->Ini->Nm_lang['lang_ado_records_fld_IdNumber'] . "";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['contr_label_graf']['idnumber']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['contr_label_graf']['idnumber']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ado_records_bck_140123']['contr_label_graf']['idnumber'];
      }
   }
