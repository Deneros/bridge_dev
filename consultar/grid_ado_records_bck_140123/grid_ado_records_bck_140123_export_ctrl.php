<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ado_records_bck_140123']['sc_process_barr'] = true;
require_once('../grid_ado_records_bck_140123/index.php');
unset($_SESSION['scriptcase']['grid_ado_records_bck_140123']['sc_process_barr']);
$ExportCtrl = new grid_ado_records_bck_140123_export_control;
$ExportCtrl->Export_barr();

class grid_ado_records_bck_140123_export_control
{
