...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = " #lowerI#";
      $nm_fim_lower = "#lowerF#";
      $Nm_datas[] = "StartingDate";$Nm_datas[] = "StartingDate";$Nm_datas[] = "CreationDate";$Nm_datas[] = "CreationDate";$Nm_datas[] = "BirthDate";$Nm_datas[] = "BirthDate";$Nm_datas[] = "IssueDate";$Nm_datas[] = "IssueDate";$Nm_numeric[] = "record";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idnumber_cond" name="idnumber_cond" onChange="nm_campos_between(document.getElementById('id_vis_idnumber'), this, 'idnumber')">
      ...
      <br><span id="id_hide_idnumber"  <?php echo $str_hide_idnumber?>><?php
      if ($idnumber != "")
      {
      $idnumber_look = substr($this->Db->qstr($idnumber), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_secondname_cond" name="secondname_cond" onChange="nm_campos_between(document.getElementById('id_vis_secondname'), this, 'secondname')">
      ...
      <br><span id="id_hide_secondname"  <?php echo $str_hide_secondname?>><?php
      if ($secondname != "")
      {
      $secondname_look = substr($this->Db->qstr($secondname), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_issuedate_cond" name="issuedate_cond" onChange="nm_campos_between(document.getElementById('id_vis_issuedate'), this, 'issuedate')">
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_issuedate"  <?php echo $str_display_issuedate; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_birthdate_cond" name="birthdate_cond" onChange="nm_campos_between(document.getElementById('id_vis_birthdate'), this, 'birthdate')">
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_birthdate"  <?php echo $str_display_birthdate; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?> 
         <BR>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_placebirth"  <?php echo $str_hide_placebirth?>><?php
      if ($placebirth != "")
      {
      $placebirth_look = substr($this->Db->qstr($placebirth), 1, -1); 
      $nmgp_def_dados = array(); 
