<?php
class pdfreport_ado_records_bck_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_ado_records_bck']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_ado_records_bck", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_bck']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_bck']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_bck']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_bck']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['order_grid'] = $nmgp_order_by;
 ...
 function Pdf_scale()
 {
   ...
   for ($i = 3; $i < 211; $i += 1)
   {
      ...
      if ($NM_cont % 10 == 0)
      {
          ...
          $this->Pdf->Line($i, 272.4, $i, 274.4);
          $this->Pdf->Text($i, 274.4, $NM_num_h);
      }
      elseif ($NM_cont % 5 == 0)
      {
          $this->Pdf->Line($i, 3.5, $i, 5);
          $this->Pdf->Line($i, 272.4, $i, 273.9);
      }
      else
      {
          $this->Pdf->Line($i, 4, $i, 5);
          $this->Pdf->Line($i, 272.4, $i, 273.4);
      }
   }
   $NM_cont = 0;
   for ($i = 3; $i < 275; $i += 1)
   {
      ...
      if ($NM_cont % 10 == 0)
      {
          ...
          $this->Pdf->Line(207.9, $i, 209.9, $i);
          $this->Pdf->Text(210.9, $i, $NM_num_v);
      }
      elseif ($NM_cont % 5 == 0)
      {
          $this->Pdf->Line(3.5, $i, 5, $i);
          $this->Pdf->Line(207.9, $i, 209.4, $i);
      }
      else
      {
          $this->Pdf->Line(4, $i, 5, $i);
          $this->Pdf->Line(207.9, $i, 208.9, $i);
      }
   }
...
// 
 function Pdf_image()
 {
   ...
   $this->Pdf->Image($this->NM_raiz_img . $this->Ini->path_img_global . "/grp__NM__img__NM__logoempresa-397_56.png", "50.000000", "10.000000", "0", "0", '', '', '', false, 300, '', false, false, 0);
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['record'] = "{lang_ado_records_fld_Record}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['uid'] = "{lang_ado_records_fld_Uid}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['startingdate'] = "{lang_ado_records_fld_StartingDate}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['creationdate'] = "{lang_ado_records_fld_CreationDate}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['creationip'] = "{lang_ado_records_fld_CreationIP}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['documenttype'] = "{lang_ado_records_fld_DocumentType}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['idnumber'] = "{lang_ado_records_fld_IdNumber}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['firstname'] = "{lang_ado_records_fld_FirstName}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['secondname'] = "{lang_ado_records_fld_SecondName}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['firstsurname'] = "{lang_ado_records_fld_FirstSurname}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['secondsurname'] = "{lang_ado_records_fld_SecondSurname}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['gender'] = "{lang_ado_records_fld_Gender}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['birthdate'] = "{lang_ado_records_fld_BirthDate}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['placebirth'] = "{lang_ado_records_fld_PlaceBirth}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['transactiontype'] = "{lang_ado_records_fld_TransactionType}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['transactiontypename'] = "{lang_ado_records_fld_TransactionTypeName}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['issuedate'] = "{lang_ado_records_fld_IssueDate}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['adoprojectid'] = "{lang_ado_records_fld_AdoProjectId}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['transactionid'] = "{lang_ado_records_fld_TransactionId}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['productid'] = "{lang_ado_records_fld_ProductId}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['resultcomparationfaces'] = "{lang_ado_records_fld_ResultComparationFaces}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['comparationfacesaproved'] = "{lang_ado_records_fld_ComparationFacesAproved}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['extras'] = "{lang_ado_records_fld_Extras}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['response_ani'] = "{lang_ado_records_fld_Response_ANI}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['labels']['photo'] = "Photo";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_bck']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_bck']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_bck']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_scale();
      $this->Pdf_init();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_bck']['qt_col_grid']) 
      {  
...
$sbRuta = "/var/www/html/bridge_og_ado/Records/".$this->idnumber[$this->nm_grid_colunas] ."/".$this->transactionid[$this->nm_grid_colunas] ."/clientFace.png"; 
$this->photo[$this->nm_grid_colunas]  = $sbRuta;
...
$_SESSION['scriptcase']['pdfreport_ado_records_bck']['contr_erro'] = 'off';
          ...
          { 
              $this->photo[$this->nm_grid_colunas] = $this->Ini->root . $this->Ini->path_imagens . "" . "/" .  $this->photo[$this->nm_grid_colunas];
              $out_photo = $this->Ini->path_imag_temp . "/sc_photo_100100" . $_SESSION['scriptcase']['sc_num_img'] . ".jpg" ;  
              if (is_file($this->photo[$this->nm_grid_colunas])) 
              { 
                  $sc_obj_img = new nm_trata_img($this->photo[$this->nm_grid_colunas]);
            ...
            $cell_Record = array('posx' => '45', 'posy' => '20', 'data' => $this->record[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_Photo = array('posx' => '120', 'posy' => '20', 'data' => $this->photo[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_Uid = array('posx' => '45', 'posy' => '30', 'data' => $this->uid[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_StartingDate = array('posx' => '45', 'posy' => '40', 'data' => $this->startingdate[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_CreationDate = array('posx' => '45', 'posy' => '50', 'data' => $this->creationdate[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_CreationIP = array('posx' => '45', 'posy' => '60', 'data' => $this->creationip[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_IdNumber = array('posx' => '45', 'posy' => '90', 'data' => $this->idnumber[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_39 = array('posx' => '90', 'posy' => '90', 'data' => $this->SC_conv_utf8('' . $this->Ini->Nm_lang['lang_ado_records_fld_IssueDate'] . ''), 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_IssueDate = array('posx' => '120', 'posy' => '90', 'data' => $this->issuedate[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_FirstName = array('posx' => '45', 'posy' => '100', 'data' => $this->firstname[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_32 = array('posx' => '90', 'posy' => '100', 'data' => $this->SC_conv_utf8('' . $this->Ini->Nm_lang['lang_ado_records_fld_SecondName'] . ''), 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_SecondName = array('posx' => '120', 'posy' => '100', 'data' => $this->secondname[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_FirstSurname = array('posx' => '45', 'posy' => '110', 'data' => $this->firstsurname[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_34 = array('posx' => '90', 'posy' => '110', 'data' => $this->SC_conv_utf8('' . $this->Ini->Nm_lang['lang_ado_records_fld_SecondSurname'] . ''), 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_SecondSurname = array('posx' => '120', 'posy' => '110', 'data' => $this->secondsurname[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_Gender = array('posx' => '45', 'posy' => '120', 'data' => $this->gender[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_36 = array('posx' => '90', 'posy' => '120', 'data' => $this->SC_conv_utf8('' . $this->Ini->Nm_lang['lang_ado_records_fld_BirthDate'] . ''), 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_BirthDate = array('posx' => '120', 'posy' => '120', 'data' => $this->birthdate[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_PlaceBirth = array('posx' => '45', 'posy' => '130', 'data' => $this->placebirth[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_38 = array('posx' => '90', 'posy' => '130', 'data' => $this->SC_conv_utf8('' . $this->Ini->Nm_lang['lang_ado_records_fld_TransactionTypeName'] . ''), 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_TransactionTypeName = array('posx' => '120', 'posy' => '130', 'data' => $this->transactiontypename[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_41 = array('posx' => '90', 'posy' => '160', 'data' => $this->SC_conv_utf8('' . $this->Ini->Nm_lang['lang_ado_records_fld_ProductId'] . ''), 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_ProductId = array('posx' => '120', 'posy' => '160', 'data' => $this->productid[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_42 = array('posx' => '10', 'posy' => '170', 'data' => $this->SC_conv_utf8('' . $this->Ini->Nm_lang['lang_ado_records_fld_ResultComparationFaces'] . ''), 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_ResultComparationFaces = array('posx' => '48', 'posy' => '170', 'data' => $this->resultcomparationfaces[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_43 = array('posx' => '90', 'posy' => '170', 'data' => $this->SC_conv_utf8('' . $this->Ini->Nm_lang['lang_ado_records_fld_ComparationFacesSuccesful'] . ''), 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_ComparationFacesAproved = array('posx' => '132', 'posy' => '170', 'data' => $this->comparationfacesaproved[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_44 = array('posx' => '10', 'posy' => '180', 'data' => $this->SC_conv_utf8('' . $this->Ini->Nm_lang['lang_ado_records_fld_Extras'] . ''), 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_Extras = array('posx' => '48', 'posy' => '180', 'data' => $this->extras[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_47 = array('posx' => '10', 'posy' => '190', 'data' => $this->SC_conv_utf8('' . $this->Ini->Nm_lang['lang_ado_records_fld_Response_ANI'] . ''), 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_Response_ANI = array('posx' => '48', 'posy' => '190', 'data' => $this->response_ani[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            if (isset($cell_Photo['data']) && !empty($cell_Photo['data']) && is_file($cell_Photo['data']))
            {
                ...
                {
                    $this->Pdf->Image($cell_Photo['data'], $cell_Photo['posx'], $cell_Photo['posy'], 100, 0);
                }
            }
            ...
            $this->Pdf->SetFont($cell_ResultComparationFaces['font_type'], $cell_ResultComparationFaces['font_style'], $cell_ResultComparationFaces['font_size']);
            $this->pdf_text_color($cell_ResultComparationFaces['data'], $cell_ResultComparationFaces['color_r'], $cell_ResultComparationFaces['color_g'], $cell_ResultComparationFaces['color_b']);
            if (!empty($cell_ResultComparationFaces['posx']) && !empty($cell_ResultComparationFaces['posy']))
            {
                $this->Pdf->SetXY($cell_ResultComparationFaces['posx'], $cell_ResultComparationFaces['posy']);
            }
            elseif (!empty($cell_ResultComparationFaces['posx']))
            {
                $this->Pdf->SetX($cell_ResultComparationFaces['posx']);
            }
            elseif (!empty($cell_ResultComparationFaces['posy']))
            {
                $this->Pdf->SetY($cell_ResultComparationFaces['posy']);
            }
            $this->Pdf->Cell($cell_ResultComparationFaces['width'], 0, $cell_ResultComparationFaces['data'], 0, 0, $cell_ResultComparationFaces['align']);
            ...
            $this->Pdf->SetFont($cell_ComparationFacesAproved['font_type'], $cell_ComparationFacesAproved['font_style'], $cell_ComparationFacesAproved['font_size']);
            $this->pdf_text_color($cell_ComparationFacesAproved['data'], $cell_ComparationFacesAproved['color_r'], $cell_ComparationFacesAproved['color_g'], $cell_ComparationFacesAproved['color_b']);
            if (!empty($cell_ComparationFacesAproved['posx']) && !empty($cell_ComparationFacesAproved['posy']))
            {
                $this->Pdf->SetXY($cell_ComparationFacesAproved['posx'], $cell_ComparationFacesAproved['posy']);
            }
            elseif (!empty($cell_ComparationFacesAproved['posx']))
            {
                $this->Pdf->SetX($cell_ComparationFacesAproved['posx']);
            }
            elseif (!empty($cell_ComparationFacesAproved['posy']))
            {
                $this->Pdf->SetY($cell_ComparationFacesAproved['posy']);
            }
            $this->Pdf->Cell($cell_ComparationFacesAproved['width'], 0, $cell_ComparationFacesAproved['data'], 0, 0, $cell_ComparationFacesAproved['align']);
            ...
            $this->pdf_text_color($cell_Response_ANI['data'], $cell_Response_ANI['color_r'], $cell_Response_ANI['color_g'], $cell_Response_ANI['color_b']);
            ...
            $this->Pdf->Cell($cell_Response_ANI['width'], 0, $cell_Response_ANI['data'], 0, 0, $cell_Response_ANI['align']);
