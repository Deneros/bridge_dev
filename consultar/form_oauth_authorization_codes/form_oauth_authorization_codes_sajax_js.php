  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_oauth_authorization_codes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_oauth_authorization_codes_form();
	}
...
?>
  ...
  function do_ajax_form_oauth_authorization_codes_validate_authorization_code()
  {
    ...
    x_ajax_form_oauth_authorization_codes_validate_authorization_code(var_authorization_code, var_script_case_init, do_ajax_form_oauth_authorization_codes_validate_authorization_code_cb);
  } // do_ajax_form_oauth_authorization_codes_validate_authorization_code

  function do_ajax_form_oauth_authorization_codes_validate_authorization_code_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_authorization_codes_validate_authorization_code_cb

  // ---------- Validate client_id
  function do_ajax_form_oauth_authorization_codes_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldText(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_authorization_codes_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_oauth_authorization_codes_validate_client_id_cb);
  } // do_ajax_form_oauth_authorization_codes_validate_client_id

  function do_ajax_form_oauth_authorization_codes_validate_client_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_authorization_codes_validate_client_id_cb

  // ---------- Validate user_id
  function do_ajax_form_oauth_authorization_codes_validate_user_id()
  {
    var nomeCampo_user_id = "user_id";
    var var_user_id = scAjaxGetFieldText(nomeCampo_user_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_authorization_codes_validate_user_id(var_user_id, var_script_case_init, do_ajax_form_oauth_authorization_codes_validate_user_id_cb);
  } // do_ajax_form_oauth_authorization_codes_validate_user_id

  function do_ajax_form_oauth_authorization_codes_validate_user_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_authorization_codes_validate_user_id_cb

  // ---------- Validate redirect_uri
  function do_ajax_form_oauth_authorization_codes_validate_redirect_uri()
  {
    var nomeCampo_redirect_uri = "redirect_uri";
    var var_redirect_uri = scAjaxGetFieldText(nomeCampo_redirect_uri);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_authorization_codes_validate_redirect_uri(var_redirect_uri, var_script_case_init, do_ajax_form_oauth_authorization_codes_validate_redirect_uri_cb);
  } // do_ajax_form_oauth_authorization_codes_validate_redirect_uri

  function do_ajax_form_oauth_authorization_codes_validate_redirect_uri_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_authorization_codes_validate_redirect_uri_cb

  // ---------- Validate expires
  function do_ajax_form_oauth_authorization_codes_validate_expires()
  {
    var nomeCampo_expires = "expires";
    var var_expires = scAjaxGetFieldText(nomeCampo_expires);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_authorization_codes_validate_expires(var_expires, var_script_case_init, do_ajax_form_oauth_authorization_codes_validate_expires_cb);
  } // do_ajax_form_oauth_authorization_codes_validate_expires

  function do_ajax_form_oauth_authorization_codes_validate_expires_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "expires";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_authorization_codes_validate_expires_cb

  // ---------- Validate scope
  function do_ajax_form_oauth_authorization_codes_validate_scope()
  {
    var nomeCampo_scope = "scope";
    var var_scope = scAjaxGetFieldText(nomeCampo_scope);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_authorization_codes_validate_scope(var_scope, var_script_case_init, do_ajax_form_oauth_authorization_codes_validate_scope_cb);
  } // do_ajax_form_oauth_authorization_codes_validate_scope

  function do_ajax_form_oauth_authorization_codes_validate_scope_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scope";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_authorization_codes_validate_scope_cb

  // ---------- Validate id_token
  function do_ajax_form_oauth_authorization_codes_validate_id_token()
  {
    var nomeCampo_id_token = "id_token";
    var var_id_token = scAjaxGetFieldText(nomeCampo_id_token);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_authorization_codes_validate_id_token(var_id_token, var_script_case_init, do_ajax_form_oauth_authorization_codes_validate_id_token_cb);
  } // do_ajax_form_oauth_authorization_codes_validate_id_token

  function do_ajax_form_oauth_authorization_codes_validate_id_token_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_authorization_codes_validate_id_token_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_oauth_authorization_codes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_oauth_authorization_codes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_oauth_authorization_codes_submit_form(var_authorization_code, var_client_id, var_user_id, var_redirect_uri, var_expires, var_scope, var_id_token, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_oauth_authorization_codes_submit_form_cb);
  } // do_ajax_form_oauth_authorization_codes_submit_form

  function do_ajax_form_oauth_authorization_codes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_oauth_authorization_codes_submit_form_cb_after_alert);
  } // do_ajax_form_oauth_authorization_codes_submit_form_cb
  function do_ajax_form_oauth_authorization_codes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_oauth_authorization_codes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_oauth_authorization_codes_navigate_form()
  {
    perform_ajax_form_oauth_authorization_codes_navigate_form();
  }

  function perform_ajax_form_oauth_authorization_codes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_oauth_authorization_codes_navigate_form(var_authorization_code, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_oauth_authorization_codes_navigate_form_cb);
  } // do_ajax_form_oauth_authorization_codes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_oauth_authorization_codes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_oauth_authorization_codes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_oauth_authorization_codes_navigate_form_cb_after_alert);
  } // do_ajax_form_oauth_authorization_codes_navigate_form_cb
  function do_ajax_form_oauth_authorization_codes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_oauth_authorization_codes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_oauth_authorization_codes_navigate_form_cb_after_alert
  function sc_hide_form_oauth_authorization_codes_form()
  {
