  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_oauth_authorization_codes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_oauth_authorization_codes_mob_form();
	}
...
?>
  ...
  function do_ajax_form_oauth_authorization_codes_mob_validate_authorization_code()
  {
    var nomeCampo_authorization_code = "authorization_code";
    var var_authorization_code = scAjaxGetFieldText(nomeCampo_authorization_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_authorization_codes_mob_validate_authorization_code(var_authorization_code, var_script_case_init, do_ajax_form_oauth_authorization_codes_mob_validate_authorization_code_cb);
  } // do_ajax_form_oauth_authorization_codes_mob_validate_authorization_code

  function do_ajax_form_oauth_authorization_codes_mob_validate_authorization_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "authorization_code";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_authorization_codes_mob_validate_authorization_code_cb

  // ---------- Validate client_id
  function do_ajax_form_oauth_authorization_codes_mob_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldText(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_authorization_codes_mob_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_oauth_authorization_codes_mob_validate_client_id_cb);
  } // do_ajax_form_oauth_authorization_codes_mob_validate_client_id

  function do_ajax_form_oauth_authorization_codes_mob_validate_client_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_authorization_codes_mob_validate_client_id_cb

  // ---------- Validate user_id
  function do_ajax_form_oauth_authorization_codes_mob_validate_user_id()
  {
    var nomeCampo_user_id = "user_id";
    var var_user_id = scAjaxGetFieldText(nomeCampo_user_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_authorization_codes_mob_validate_user_id(var_user_id, var_script_case_init, do_ajax_form_oauth_authorization_codes_mob_validate_user_id_cb);
  } // do_ajax_form_oauth_authorization_codes_mob_validate_user_id

  function do_ajax_form_oauth_authorization_codes_mob_validate_user_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_authorization_codes_mob_validate_user_id_cb

  // ---------- Validate redirect_uri
  function do_ajax_form_oauth_authorization_codes_mob_validate_redirect_uri()
  {
    var nomeCampo_redirect_uri = "redirect_uri";
    var var_redirect_uri = scAjaxGetFieldText(nomeCampo_redirect_uri);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_authorization_codes_mob_validate_redirect_uri(var_redirect_uri, var_script_case_init, do_ajax_form_oauth_authorization_codes_mob_validate_redirect_uri_cb);
  } // do_ajax_form_oauth_authorization_codes_mob_validate_redirect_uri

  function do_ajax_form_oauth_authorization_codes_mob_validate_redirect_uri_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "redirect_uri";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_authorization_codes_mob_validate_redirect_uri_cb

  // ---------- Validate expires
  function do_ajax_form_oauth_authorization_codes_mob_validate_expires()
  {
    var nomeCampo_expires = "expires";
    var var_expires = scAjaxGetFieldText(nomeCampo_expires);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_authorization_codes_mob_validate_expires(var_expires, var_script_case_init, do_ajax_form_oauth_authorization_codes_mob_validate_expires_cb);
  } // do_ajax_form_oauth_authorization_codes_mob_validate_expires

  function do_ajax_form_oauth_authorization_codes_mob_validate_expires_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "expires";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_authorization_codes_mob_validate_expires_cb

  // ---------- Validate scope
  function do_ajax_form_oauth_authorization_codes_mob_validate_scope()
  {
    var nomeCampo_scope = "scope";
    var var_scope = scAjaxGetFieldText(nomeCampo_scope);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_authorization_codes_mob_validate_scope(var_scope, var_script_case_init, do_ajax_form_oauth_authorization_codes_mob_validate_scope_cb);
  } // do_ajax_form_oauth_authorization_codes_mob_validate_scope

  function do_ajax_form_oauth_authorization_codes_mob_validate_scope_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scope";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_authorization_codes_mob_validate_scope_cb

  // ---------- Validate id_token
  function do_ajax_form_oauth_authorization_codes_mob_validate_id_token()
  {
    var nomeCampo_id_token = "id_token";
    var var_id_token = scAjaxGetFieldText(nomeCampo_id_token);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_authorization_codes_mob_validate_id_token(var_id_token, var_script_case_init, do_ajax_form_oauth_authorization_codes_mob_validate_id_token_cb);
  } // do_ajax_form_oauth_authorization_codes_mob_validate_id_token

  function do_ajax_form_oauth_authorization_codes_mob_validate_id_token_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_token";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_authorization_codes_mob_validate_id_token_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_oauth_authorization_codes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_oauth_authorization_codes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_authorization_code = scAjaxGetFieldText("authorization_code");
    var var_client_id = scAjaxGetFieldText("client_id");
    var var_user_id = scAjaxGetFieldText("user_id");
    var var_redirect_uri = scAjaxGetFieldText("redirect_uri");
    var var_expires = scAjaxGetFieldText("expires");
    var var_scope = scAjaxGetFieldText("scope");
    var var_id_token = scAjaxGetFieldText("id_token");
    ...
    scAjaxProcOn();
    x_ajax_form_oauth_authorization_codes_mob_submit_form(var_authorization_code, var_client_id, var_user_id, var_redirect_uri, var_expires, var_scope, var_id_token, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_oauth_authorization_codes_mob_submit_form_cb);
  } // do_ajax_form_oauth_authorization_codes_mob_submit_form

  function do_ajax_form_oauth_authorization_codes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("authorization_code");
      scAjaxHideErrorDisplay("client_id");
      scAjaxHideErrorDisplay("user_id");
      scAjaxHideErrorDisplay("redirect_uri");
      scAjaxHideErrorDisplay("expires");
      scAjaxHideErrorDisplay("scope");
      scAjaxHideErrorDisplay("id_token");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_oauth_authorization_codes_mob_submit_form_cb_after_alert);
  } // do_ajax_form_oauth_authorization_codes_mob_submit_form_cb
  function do_ajax_form_oauth_authorization_codes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_oauth_authorization_codes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_oauth_authorization_codes_mob_navigate_form()
  {
    perform_ajax_form_oauth_authorization_codes_mob_navigate_form();
  }

  function perform_ajax_form_oauth_authorization_codes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("scope");
    scAjaxHideErrorDisplay("id_token");
    var var_authorization_code = document.F2.authorization_code.value;
    ...
    scAjaxProcOn();
    x_ajax_form_oauth_authorization_codes_mob_navigate_form(var_authorization_code, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_oauth_authorization_codes_mob_navigate_form_cb);
  } // do_ajax_form_oauth_authorization_codes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_oauth_authorization_codes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_oauth_authorization_codes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.authorization_code.value = scAjaxGetKeyValue("authorization_code");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_oauth_authorization_codes_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_oauth_authorization_codes_mob_navigate_form_cb
  function do_ajax_form_oauth_authorization_codes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_oauth_authorization_codes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_oauth_authorization_codes_mob_navigate_form_cb_after_alert
  function sc_hide_form_oauth_authorization_codes_mob_form()
  {
  ...
  ajax_field_list[0] = "authorization_code";
  ajax_field_list[1] = "client_id";
  ajax_field_list[2] = "user_id";
  ajax_field_list[3] = "redirect_uri";
  ajax_field_list[4] = "expires";
  ajax_field_list[5] = "scope";
  ajax_field_list[6] = "id_token";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "authorization_code": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_authorization_codes_fld_authorization_code'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "client_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_authorization_codes_fld_client_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "user_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_authorization_codes_fld_user_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "redirect_uri": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_authorization_codes_fld_redirect_uri'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "expires": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_authorization_codes_fld_expires'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scope": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_authorization_codes_fld_scope'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_token": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_authorization_codes_fld_id_token'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "authorization_code": new Array(),
    "client_id": new Array(),
    "user_id": new Array(),
    "redirect_uri": new Array(),
    "expires": new Array(),
    "scope": new Array(),
    "id_token": new Array()
  };
  ajax_field_mult["authorization_code"][1] = "authorization_code";
  ajax_field_mult["client_id"][1] = "client_id";
  ajax_field_mult["user_id"][1] = "user_id";
  ajax_field_mult["redirect_uri"][1] = "redirect_uri";
  ajax_field_mult["expires"][1] = "expires";
  ajax_field_mult["scope"][1] = "scope";
  ajax_field_mult["id_token"][1] = "id_token";

  var ajax_field_id = {
    "authorization_code": new Array("hidden_field_label_authorization_code", "hidden_field_data_authorization_code"),
    ...
    "redirect_uri": new Array("hidden_field_label_redirect_uri", "hidden_field_data_redirect_uri"),
    "expires": new Array("hidden_field_label_expires", "hidden_field_data_expires"),
    "scope": new Array("hidden_field_label_scope", "hidden_field_data_scope"),
    "id_token": new Array("hidden_field_label_id_token", "hidden_field_data_id_token")
  };
