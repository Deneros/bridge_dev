  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_oauth_clients" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_oauth_clients_form();
	}
...
?>
  ...
  // ---------- Validate client_id
  function do_ajax_form_oauth_clients_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldText(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_clients_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_oauth_clients_validate_client_id_cb);
  } // do_ajax_form_oauth_clients_validate_client_id

  function do_ajax_form_oauth_clients_validate_client_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_clients_validate_client_id_cb

  // ---------- Validate client_secret
  function do_ajax_form_oauth_clients_validate_client_secret()
  {
    var nomeCampo_client_secret = "client_secret";
    var var_client_secret = scAjaxGetFieldText(nomeCampo_client_secret);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_clients_validate_client_secret(var_client_secret, var_script_case_init, do_ajax_form_oauth_clients_validate_client_secret_cb);
  } // do_ajax_form_oauth_clients_validate_client_secret

  function do_ajax_form_oauth_clients_validate_client_secret_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_clients_validate_client_secret_cb

  // ---------- Validate redirect_uri
  function do_ajax_form_oauth_clients_validate_redirect_uri()
  {
    var nomeCampo_redirect_uri = "redirect_uri";
    var var_redirect_uri = scAjaxGetFieldText(nomeCampo_redirect_uri);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_clients_validate_redirect_uri(var_redirect_uri, var_script_case_init, do_ajax_form_oauth_clients_validate_redirect_uri_cb);
  } // do_ajax_form_oauth_clients_validate_redirect_uri

  function do_ajax_form_oauth_clients_validate_redirect_uri_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_clients_validate_redirect_uri_cb

  // ---------- Validate grant_types
  function do_ajax_form_oauth_clients_validate_grant_types()
  {
    var nomeCampo_grant_types = "grant_types";
    var var_grant_types = scAjaxGetFieldText(nomeCampo_grant_types);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_clients_validate_grant_types(var_grant_types, var_script_case_init, do_ajax_form_oauth_clients_validate_grant_types_cb);
  } // do_ajax_form_oauth_clients_validate_grant_types

  function do_ajax_form_oauth_clients_validate_grant_types_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_clients_validate_grant_types_cb

  // ---------- Validate scope
  function do_ajax_form_oauth_clients_validate_scope()
  {
    var nomeCampo_scope = "scope";
    var var_scope = scAjaxGetFieldText(nomeCampo_scope);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_clients_validate_scope(var_scope, var_script_case_init, do_ajax_form_oauth_clients_validate_scope_cb);
  } // do_ajax_form_oauth_clients_validate_scope

  function do_ajax_form_oauth_clients_validate_scope_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scope";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_clients_validate_scope_cb

  // ---------- Validate user_id
  function do_ajax_form_oauth_clients_validate_user_id()
  {
    var nomeCampo_user_id = "user_id";
    var var_user_id = scAjaxGetFieldText(nomeCampo_user_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_clients_validate_user_id(var_user_id, var_script_case_init, do_ajax_form_oauth_clients_validate_user_id_cb);
  } // do_ajax_form_oauth_clients_validate_user_id

  function do_ajax_form_oauth_clients_validate_user_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_clients_validate_user_id_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_oauth_clients_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_oauth_clients_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_oauth_clients_submit_form(var_client_id, var_client_secret, var_redirect_uri, var_grant_types, var_scope, var_user_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_oauth_clients_submit_form_cb);
  } // do_ajax_form_oauth_clients_submit_form

  function do_ajax_form_oauth_clients_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_oauth_clients_submit_form_cb_after_alert);
  } // do_ajax_form_oauth_clients_submit_form_cb
  function do_ajax_form_oauth_clients_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_oauth_clients_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_oauth_clients_navigate_form()
  {
    perform_ajax_form_oauth_clients_navigate_form();
  }

  function perform_ajax_form_oauth_clients_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_oauth_clients_navigate_form(var_client_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_oauth_clients_navigate_form_cb);
  } // do_ajax_form_oauth_clients_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_oauth_clients']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_oauth_clients_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_oauth_clients_navigate_form_cb_after_alert);
  } // do_ajax_form_oauth_clients_navigate_form_cb
  function do_ajax_form_oauth_clients_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_oauth_clients_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_oauth_clients_navigate_form_cb_after_alert
  function sc_hide_form_oauth_clients_form()
  {
