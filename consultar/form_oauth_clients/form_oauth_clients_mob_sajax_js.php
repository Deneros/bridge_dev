  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_oauth_clients_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_oauth_clients_mob_form();
	}
...
?>
  ...
  // ---------- Validate client_id
  function do_ajax_form_oauth_clients_mob_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldText(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_clients_mob_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_oauth_clients_mob_validate_client_id_cb);
  } // do_ajax_form_oauth_clients_mob_validate_client_id

  function do_ajax_form_oauth_clients_mob_validate_client_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_clients_mob_validate_client_id_cb

  // ---------- Validate client_secret
  function do_ajax_form_oauth_clients_mob_validate_client_secret()
  {
    var nomeCampo_client_secret = "client_secret";
    var var_client_secret = scAjaxGetFieldText(nomeCampo_client_secret);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_clients_mob_validate_client_secret(var_client_secret, var_script_case_init, do_ajax_form_oauth_clients_mob_validate_client_secret_cb);
  } // do_ajax_form_oauth_clients_mob_validate_client_secret

  function do_ajax_form_oauth_clients_mob_validate_client_secret_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "client_secret";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_clients_mob_validate_client_secret_cb

  // ---------- Validate redirect_uri
  function do_ajax_form_oauth_clients_mob_validate_redirect_uri()
  {
    var nomeCampo_redirect_uri = "redirect_uri";
    var var_redirect_uri = scAjaxGetFieldText(nomeCampo_redirect_uri);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_clients_mob_validate_redirect_uri(var_redirect_uri, var_script_case_init, do_ajax_form_oauth_clients_mob_validate_redirect_uri_cb);
  } // do_ajax_form_oauth_clients_mob_validate_redirect_uri

  function do_ajax_form_oauth_clients_mob_validate_redirect_uri_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_clients_mob_validate_redirect_uri_cb

  // ---------- Validate grant_types
  function do_ajax_form_oauth_clients_mob_validate_grant_types()
  {
    var nomeCampo_grant_types = "grant_types";
    var var_grant_types = scAjaxGetFieldText(nomeCampo_grant_types);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_clients_mob_validate_grant_types(var_grant_types, var_script_case_init, do_ajax_form_oauth_clients_mob_validate_grant_types_cb);
  } // do_ajax_form_oauth_clients_mob_validate_grant_types

  function do_ajax_form_oauth_clients_mob_validate_grant_types_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "grant_types";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_clients_mob_validate_grant_types_cb

  // ---------- Validate scope
  function do_ajax_form_oauth_clients_mob_validate_scope()
  {
    var nomeCampo_scope = "scope";
    var var_scope = scAjaxGetFieldText(nomeCampo_scope);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_clients_mob_validate_scope(var_scope, var_script_case_init, do_ajax_form_oauth_clients_mob_validate_scope_cb);
  } // do_ajax_form_oauth_clients_mob_validate_scope

  function do_ajax_form_oauth_clients_mob_validate_scope_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scope";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_clients_mob_validate_scope_cb

  // ---------- Validate user_id
  function do_ajax_form_oauth_clients_mob_validate_user_id()
  {
    var nomeCampo_user_id = "user_id";
    var var_user_id = scAjaxGetFieldText(nomeCampo_user_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_clients_mob_validate_user_id(var_user_id, var_script_case_init, do_ajax_form_oauth_clients_mob_validate_user_id_cb);
  } // do_ajax_form_oauth_clients_mob_validate_user_id

  function do_ajax_form_oauth_clients_mob_validate_user_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "user_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_clients_mob_validate_user_id_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_oauth_clients_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_oauth_clients_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_client_id = scAjaxGetFieldText("client_id");
    var var_client_secret = scAjaxGetFieldText("client_secret");
    var var_redirect_uri = scAjaxGetFieldText("redirect_uri");
    var var_grant_types = scAjaxGetFieldText("grant_types");
    ...
    scAjaxProcOn();
    x_ajax_form_oauth_clients_mob_submit_form(var_client_id, var_client_secret, var_redirect_uri, var_grant_types, var_scope, var_user_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_oauth_clients_mob_submit_form_cb);
  } // do_ajax_form_oauth_clients_mob_submit_form

  function do_ajax_form_oauth_clients_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("client_secret");
      scAjaxHideErrorDisplay("redirect_uri");
      scAjaxHideErrorDisplay("grant_types");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_oauth_clients_mob_submit_form_cb_after_alert);
  } // do_ajax_form_oauth_clients_mob_submit_form_cb
  function do_ajax_form_oauth_clients_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_oauth_clients_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_oauth_clients_mob_navigate_form()
  {
    perform_ajax_form_oauth_clients_mob_navigate_form();
  }

  function perform_ajax_form_oauth_clients_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_oauth_clients_mob_navigate_form(var_client_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_oauth_clients_mob_navigate_form_cb);
  } // do_ajax_form_oauth_clients_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_oauth_clients_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_oauth_clients_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_oauth_clients_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_oauth_clients_mob_navigate_form_cb
  function do_ajax_form_oauth_clients_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_oauth_clients_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_oauth_clients_mob_navigate_form_cb_after_alert
  function sc_hide_form_oauth_clients_mob_form()
  {
  ...
  ajax_field_list[1] = "client_secret";
  ajax_field_list[2] = "redirect_uri";
  ajax_field_list[3] = "grant_types";
  ajax_field_list[4] = "scope";
  ...
  var ajax_error_list = {
    "client_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_clients_fld_client_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "client_secret": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_clients_fld_client_secret'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "redirect_uri": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_clients_fld_redirect_uri'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "grant_types": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_clients_fld_grant_types'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scope": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_clients_fld_scope'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "user_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_clients_fld_user_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "client_id": new Array(),
    "client_secret": new Array(),
    "redirect_uri": new Array(),
    "grant_types": new Array(),
    "scope": new Array(),
    "user_id": new Array()
  };
  ajax_field_mult["client_id"][1] = "client_id";
  ajax_field_mult["client_secret"][1] = "client_secret";
  ajax_field_mult["redirect_uri"][1] = "redirect_uri";
  ajax_field_mult["grant_types"][1] = "grant_types";
  ...
  var ajax_field_id = {
    ...
    "client_secret": new Array("hidden_field_label_client_secret", "hidden_field_data_client_secret"),
    "redirect_uri": new Array("hidden_field_label_redirect_uri", "hidden_field_data_redirect_uri"),
    "grant_types": new Array("hidden_field_label_grant_types", "hidden_field_data_grant_types"),
