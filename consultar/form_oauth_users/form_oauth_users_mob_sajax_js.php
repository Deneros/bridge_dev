  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_oauth_users_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_oauth_users_mob_form();
	}
...
?>
  ...
  // ---------- Validate username
  function do_ajax_form_oauth_users_mob_validate_username()
  {
    var nomeCampo_username = "username";
    var var_username = scAjaxGetFieldText(nomeCampo_username);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_mob_validate_username(var_username, var_script_case_init, do_ajax_form_oauth_users_mob_validate_username_cb);
  } // do_ajax_form_oauth_users_mob_validate_username

  function do_ajax_form_oauth_users_mob_validate_username_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_mob_validate_username_cb

  // ---------- Validate password
  function do_ajax_form_oauth_users_mob_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_mob_validate_password(var_password, var_script_case_init, do_ajax_form_oauth_users_mob_validate_password_cb);
  } // do_ajax_form_oauth_users_mob_validate_password

  function do_ajax_form_oauth_users_mob_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_mob_validate_password_cb

  // ---------- Validate name
  function do_ajax_form_oauth_users_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_mob_validate_name(var_name, var_script_case_init, do_ajax_form_oauth_users_mob_validate_name_cb);
  } // do_ajax_form_oauth_users_mob_validate_name

  function do_ajax_form_oauth_users_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_mob_validate_name_cb

  // ---------- Validate given_name
  function do_ajax_form_oauth_users_mob_validate_given_name()
  {
    var nomeCampo_given_name = "given_name";
    var var_given_name = scAjaxGetFieldText(nomeCampo_given_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_mob_validate_given_name(var_given_name, var_script_case_init, do_ajax_form_oauth_users_mob_validate_given_name_cb);
  } // do_ajax_form_oauth_users_mob_validate_given_name

  function do_ajax_form_oauth_users_mob_validate_given_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "given_name";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_mob_validate_given_name_cb

  // ---------- Validate family_name
  function do_ajax_form_oauth_users_mob_validate_family_name()
  {
    var nomeCampo_family_name = "family_name";
    var var_family_name = scAjaxGetFieldText(nomeCampo_family_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_mob_validate_family_name(var_family_name, var_script_case_init, do_ajax_form_oauth_users_mob_validate_family_name_cb);
  } // do_ajax_form_oauth_users_mob_validate_family_name

  function do_ajax_form_oauth_users_mob_validate_family_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "family_name";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_mob_validate_family_name_cb

  // ---------- Validate uid
  function do_ajax_form_oauth_users_mob_validate_uid()
  {
    var nomeCampo_uid = "uid";
    var var_uid = scAjaxGetFieldText(nomeCampo_uid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_mob_validate_uid(var_uid, var_script_case_init, do_ajax_form_oauth_users_mob_validate_uid_cb);
  } // do_ajax_form_oauth_users_mob_validate_uid

  function do_ajax_form_oauth_users_mob_validate_uid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_mob_validate_uid_cb

  // ---------- Validate transactionid
  function do_ajax_form_oauth_users_mob_validate_transactionid()
  {
    var nomeCampo_transactionid = "transactionid";
    var var_transactionid = scAjaxGetFieldText(nomeCampo_transactionid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_mob_validate_transactionid(var_transactionid, var_script_case_init, do_ajax_form_oauth_users_mob_validate_transactionid_cb);
  } // do_ajax_form_oauth_users_mob_validate_transactionid

  function do_ajax_form_oauth_users_mob_validate_transactionid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_mob_validate_transactionid_cb

  // ---------- Validate picture
  function do_ajax_form_oauth_users_mob_validate_picture()
  {
    var nomeCampo_picture = "picture";
    var var_picture = scAjaxGetFieldText(nomeCampo_picture);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_mob_validate_picture(var_picture, var_script_case_init, do_ajax_form_oauth_users_mob_validate_picture_cb);
  } // do_ajax_form_oauth_users_mob_validate_picture

  function do_ajax_form_oauth_users_mob_validate_picture_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "picture";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_mob_validate_picture_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_oauth_users_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_oauth_users_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_username = scAjaxGetFieldText("username");
    var var_password = scAjaxGetFieldText("password");
    var var_name = scAjaxGetFieldText("name");
    var var_given_name = scAjaxGetFieldText("given_name");
    var var_family_name = scAjaxGetFieldText("family_name");
    ...
    scAjaxProcOn();
    x_ajax_form_oauth_users_mob_submit_form(var_username, var_password, var_name, var_given_name, var_family_name, var_uid, var_transactionid, var_picture, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_oauth_users_mob_submit_form_cb);
  } // do_ajax_form_oauth_users_mob_submit_form

  function do_ajax_form_oauth_users_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("given_name");
      scAjaxHideErrorDisplay("family_name");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_oauth_users_mob_submit_form_cb_after_alert);
  } // do_ajax_form_oauth_users_mob_submit_form_cb
  function do_ajax_form_oauth_users_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_oauth_users_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_oauth_users_mob_navigate_form()
  {
    perform_ajax_form_oauth_users_mob_navigate_form();
  }

  function perform_ajax_form_oauth_users_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("transactionid");
    scAjaxHideErrorDisplay("picture");
    var var_username = document.F2.username.value;
    ...
    scAjaxProcOn();
    x_ajax_form_oauth_users_mob_navigate_form(var_username, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_oauth_users_mob_navigate_form_cb);
  } // do_ajax_form_oauth_users_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_oauth_users_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_oauth_users_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.username.value = scAjaxGetKeyValue("username");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_oauth_users_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_oauth_users_mob_navigate_form_cb
  function do_ajax_form_oauth_users_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_oauth_users_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_oauth_users_mob_navigate_form_cb_after_alert
  function sc_hide_form_oauth_users_mob_form()
  {
  ...
  ajax_field_list[3] = "given_name";
  ajax_field_list[4] = "family_name";
  ajax_field_list[5] = "uid";
  ajax_field_list[6] = "transactionid";
  ajax_field_list[7] = "picture";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "username": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_users_fld_username'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "password": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_users_fld_password'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "name": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_users_fld_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "given_name": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_users_fld_given_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "family_name": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_users_fld_family_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "uid": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_users_fld_Uid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "transactionid": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_users_fld_TransactionId'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "picture": {"label": "<?php echo $this->Ini->Nm_lang['lang_oauth_users_fld_picture'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "password": new Array(),
    "name": new Array(),
    "given_name": new Array(),
    "family_name": new Array(),
    "uid": new Array(),
  ...
  ajax_field_mult["given_name"][1] = "given_name";
  ajax_field_mult["family_name"][1] = "family_name";
  ...
  var ajax_field_id = {
    ...
    "given_name": new Array("hidden_field_label_given_name", "hidden_field_data_given_name"),
    "family_name": new Array("hidden_field_label_family_name", "hidden_field_data_family_name"),
