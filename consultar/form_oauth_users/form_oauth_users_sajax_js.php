  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_oauth_users" == sTestField)
        {
...
?>
  ...
  // ---------- Validate username
  function do_ajax_form_oauth_users_validate_username()
  {
    var nomeCampo_username = "username";
    var var_username = scAjaxGetFieldText(nomeCampo_username);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_validate_username(var_username, var_script_case_init, do_ajax_form_oauth_users_validate_username_cb);
  } // do_ajax_form_oauth_users_validate_username

  function do_ajax_form_oauth_users_validate_username_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_validate_username_cb

  // ---------- Validate password
  function do_ajax_form_oauth_users_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_validate_password(var_password, var_script_case_init, do_ajax_form_oauth_users_validate_password_cb);
  } // do_ajax_form_oauth_users_validate_password

  function do_ajax_form_oauth_users_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_validate_password_cb

  // ---------- Validate name
  function do_ajax_form_oauth_users_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_validate_name(var_name, var_script_case_init, do_ajax_form_oauth_users_validate_name_cb);
  } // do_ajax_form_oauth_users_validate_name

  function do_ajax_form_oauth_users_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_validate_name_cb

  // ---------- Validate given_name
  function do_ajax_form_oauth_users_validate_given_name()
  {
    var nomeCampo_given_name = "given_name";
    var var_given_name = scAjaxGetFieldText(nomeCampo_given_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_validate_given_name(var_given_name, var_script_case_init, do_ajax_form_oauth_users_validate_given_name_cb);
  } // do_ajax_form_oauth_users_validate_given_name

  function do_ajax_form_oauth_users_validate_given_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_validate_given_name_cb

  // ---------- Validate family_name
  function do_ajax_form_oauth_users_validate_family_name()
  {
    var nomeCampo_family_name = "family_name";
    var var_family_name = scAjaxGetFieldText(nomeCampo_family_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_validate_family_name(var_family_name, var_script_case_init, do_ajax_form_oauth_users_validate_family_name_cb);
  } // do_ajax_form_oauth_users_validate_family_name

  function do_ajax_form_oauth_users_validate_family_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_validate_family_name_cb

  // ---------- Validate uid
  function do_ajax_form_oauth_users_validate_uid()
  {
    var nomeCampo_uid = "uid";
    var var_uid = scAjaxGetFieldText(nomeCampo_uid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_validate_uid(var_uid, var_script_case_init, do_ajax_form_oauth_users_validate_uid_cb);
  } // do_ajax_form_oauth_users_validate_uid

  function do_ajax_form_oauth_users_validate_uid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_validate_uid_cb

  // ---------- Validate transactionid
  function do_ajax_form_oauth_users_validate_transactionid()
  {
    var nomeCampo_transactionid = "transactionid";
    var var_transactionid = scAjaxGetFieldText(nomeCampo_transactionid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_validate_transactionid(var_transactionid, var_script_case_init, do_ajax_form_oauth_users_validate_transactionid_cb);
  } // do_ajax_form_oauth_users_validate_transactionid

  function do_ajax_form_oauth_users_validate_transactionid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_validate_transactionid_cb

  // ---------- Validate picture
  function do_ajax_form_oauth_users_validate_picture()
  {
    var nomeCampo_picture = "picture";
    var var_picture = scAjaxGetFieldText(nomeCampo_picture);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_oauth_users_validate_picture(var_picture, var_script_case_init, do_ajax_form_oauth_users_validate_picture_cb);
  } // do_ajax_form_oauth_users_validate_picture

  function do_ajax_form_oauth_users_validate_picture_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "picture";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_oauth_users_validate_picture_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_oauth_users_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_oauth_users_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_oauth_users_submit_form(var_username, var_password, var_name, var_given_name, var_family_name, var_uid, var_transactionid, var_picture, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_oauth_users_submit_form_cb);
  } // do_ajax_form_oauth_users_submit_form

  function do_ajax_form_oauth_users_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_oauth_users_submit_form_cb_after_alert);
  } // do_ajax_form_oauth_users_submit_form_cb
  function do_ajax_form_oauth_users_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_oauth_users_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_oauth_users_navigate_form()
  {
    perform_ajax_form_oauth_users_navigate_form();
  }

  function perform_ajax_form_oauth_users_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_oauth_users_navigate_form(var_username, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_oauth_users_navigate_form_cb);
  } // do_ajax_form_oauth_users_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_oauth_users']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_oauth_users_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_oauth_users_navigate_form_cb_after_alert);
  } // do_ajax_form_oauth_users_navigate_form_cb
  function do_ajax_form_oauth_users_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_oauth_users_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_oauth_users_navigate_form_cb_after_alert
  function sc_hide_form_oauth_users_form()
  {
