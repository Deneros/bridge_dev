...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_startingdate_hora' + iSeqRow).bind('blur', function() { sc_form_ado_records_admon_startingdate_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_ado_records_admon_startingdate_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_creationdate_hora' + iSeqRow).bind('blur', function() { sc_form_ado_records_admon_creationdate_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_ado_records_admon_creationdate_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_dateofidentification_hora' + iSeqRow).bind('blur', function() { sc_form_ado_records_admon_dateofidentification_onblur(this, iSeqRow) })
                                                       .bind('focus', function() { sc_form_ado_records_admon_dateofidentification_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_dateofdeath_hora' + iSeqRow).bind('blur', function() { sc_form_ado_records_admon_dateofdeath_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_ado_records_admon_dateofdeath_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_marriagedate_hora' + iSeqRow).bind('blur', function() { sc_form_ado_records_admon_marriagedate_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_ado_records_admon_marriagedate_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_issuedate_hora' + iSeqRow).bind('blur', function() { sc_form_ado_records_admon_issuedate_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_ado_records_admon_issuedate_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_ado_records_admon_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_startingdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_ado_records_admon_mob_validate_startingdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creationdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_ado_records_admon_mob_validate_creationdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_birthdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_ado_records_admon_mob_validate_birthdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_dateofidentification" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_ado_records_admon_mob_validate_dateofidentification(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_dateofdeath" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_ado_records_admon_mob_validate_dateofdeath(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_marriagedate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_ado_records_admon_mob_validate_marriagedate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_issuedate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_ado_records_admon_mob_validate_issuedate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_ado_records_admon_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
