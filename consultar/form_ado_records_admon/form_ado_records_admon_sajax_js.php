  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ado_records_admon" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ado_records_admon_form();
	}
...
?>
  ...
  // ---------- Validate record
  function do_ajax_form_ado_records_admon_validate_record()
  {
    var nomeCampo_record = "record";
    var var_record = scAjaxGetFieldHidden(nomeCampo_record);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_record(var_record, var_script_case_init, do_ajax_form_ado_records_admon_validate_record_cb);
  } // do_ajax_form_ado_records_admon_validate_record

  function do_ajax_form_ado_records_admon_validate_record_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_record_cb

  // ---------- Validate uid
  function do_ajax_form_ado_records_admon_validate_uid()
  {
    var nomeCampo_uid = "uid";
    var var_uid = scAjaxGetFieldText(nomeCampo_uid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_uid(var_uid, var_script_case_init, do_ajax_form_ado_records_admon_validate_uid_cb);
  } // do_ajax_form_ado_records_admon_validate_uid

  function do_ajax_form_ado_records_admon_validate_uid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_uid_cb

  // ---------- Validate startingdate
  function do_ajax_form_ado_records_admon_validate_startingdate()
  {
    var nomeCampo_startingdate = "startingdate";
    var var_startingdate = scAjaxGetFieldText(nomeCampo_startingdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_startingdate(var_startingdate, var_script_case_init, do_ajax_form_ado_records_admon_validate_startingdate_cb);
  } // do_ajax_form_ado_records_admon_validate_startingdate

  function do_ajax_form_ado_records_admon_validate_startingdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_startingdate_cb

  // ---------- Validate creationdate
  function do_ajax_form_ado_records_admon_validate_creationdate()
  {
    var nomeCampo_creationdate = "creationdate";
    var var_creationdate = scAjaxGetFieldText(nomeCampo_creationdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_creationdate(var_creationdate, var_script_case_init, do_ajax_form_ado_records_admon_validate_creationdate_cb);
  } // do_ajax_form_ado_records_admon_validate_creationdate

  function do_ajax_form_ado_records_admon_validate_creationdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_creationdate_cb

  // ---------- Validate creationip
  function do_ajax_form_ado_records_admon_validate_creationip()
  {
    var nomeCampo_creationip = "creationip";
    var var_creationip = scAjaxGetFieldText(nomeCampo_creationip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_creationip(var_creationip, var_script_case_init, do_ajax_form_ado_records_admon_validate_creationip_cb);
  } // do_ajax_form_ado_records_admon_validate_creationip

  function do_ajax_form_ado_records_admon_validate_creationip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_creationip_cb

  // ---------- Validate documenttype
  function do_ajax_form_ado_records_admon_validate_documenttype()
  {
    var nomeCampo_documenttype = "documenttype";
    var var_documenttype = scAjaxGetFieldText(nomeCampo_documenttype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_documenttype(var_documenttype, var_script_case_init, do_ajax_form_ado_records_admon_validate_documenttype_cb);
  } // do_ajax_form_ado_records_admon_validate_documenttype

  function do_ajax_form_ado_records_admon_validate_documenttype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_documenttype_cb

  // ---------- Validate idnumber
  function do_ajax_form_ado_records_admon_validate_idnumber()
  {
    var nomeCampo_idnumber = "idnumber";
    var var_idnumber = scAjaxGetFieldText(nomeCampo_idnumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_idnumber(var_idnumber, var_script_case_init, do_ajax_form_ado_records_admon_validate_idnumber_cb);
  } // do_ajax_form_ado_records_admon_validate_idnumber

  function do_ajax_form_ado_records_admon_validate_idnumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_idnumber_cb

  // ---------- Validate firstname
  function do_ajax_form_ado_records_admon_validate_firstname()
  {
    var nomeCampo_firstname = "firstname";
    var var_firstname = scAjaxGetFieldText(nomeCampo_firstname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_firstname(var_firstname, var_script_case_init, do_ajax_form_ado_records_admon_validate_firstname_cb);
  } // do_ajax_form_ado_records_admon_validate_firstname

  function do_ajax_form_ado_records_admon_validate_firstname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_firstname_cb

  // ---------- Validate secondname
  function do_ajax_form_ado_records_admon_validate_secondname()
  {
    var nomeCampo_secondname = "secondname";
    var var_secondname = scAjaxGetFieldText(nomeCampo_secondname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_secondname(var_secondname, var_script_case_init, do_ajax_form_ado_records_admon_validate_secondname_cb);
  } // do_ajax_form_ado_records_admon_validate_secondname

  function do_ajax_form_ado_records_admon_validate_secondname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_secondname_cb

  // ---------- Validate firstsurname
  function do_ajax_form_ado_records_admon_validate_firstsurname()
  {
    var nomeCampo_firstsurname = "firstsurname";
    var var_firstsurname = scAjaxGetFieldText(nomeCampo_firstsurname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_firstsurname(var_firstsurname, var_script_case_init, do_ajax_form_ado_records_admon_validate_firstsurname_cb);
  } // do_ajax_form_ado_records_admon_validate_firstsurname

  function do_ajax_form_ado_records_admon_validate_firstsurname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_firstsurname_cb

  // ---------- Validate secondsurname
  function do_ajax_form_ado_records_admon_validate_secondsurname()
  {
    var nomeCampo_secondsurname = "secondsurname";
    var var_secondsurname = scAjaxGetFieldText(nomeCampo_secondsurname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_secondsurname(var_secondsurname, var_script_case_init, do_ajax_form_ado_records_admon_validate_secondsurname_cb);
  } // do_ajax_form_ado_records_admon_validate_secondsurname

  function do_ajax_form_ado_records_admon_validate_secondsurname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_secondsurname_cb

  // ---------- Validate gender
  function do_ajax_form_ado_records_admon_validate_gender()
  {
    var nomeCampo_gender = "gender";
    var var_gender = scAjaxGetFieldSelect(nomeCampo_gender);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_gender(var_gender, var_script_case_init, do_ajax_form_ado_records_admon_validate_gender_cb);
  } // do_ajax_form_ado_records_admon_validate_gender

  function do_ajax_form_ado_records_admon_validate_gender_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gender";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_gender_cb

  // ---------- Validate birthdate
  function do_ajax_form_ado_records_admon_validate_birthdate()
  {
    var nomeCampo_birthdate = "birthdate";
    var var_birthdate = scAjaxGetFieldText(nomeCampo_birthdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_birthdate(var_birthdate, var_script_case_init, do_ajax_form_ado_records_admon_validate_birthdate_cb);
  } // do_ajax_form_ado_records_admon_validate_birthdate

  function do_ajax_form_ado_records_admon_validate_birthdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_birthdate_cb

  // ---------- Validate street
  function do_ajax_form_ado_records_admon_validate_street()
  {
    var nomeCampo_street = "street";
    var var_street = scAjaxGetFieldText(nomeCampo_street);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_street(var_street, var_script_case_init, do_ajax_form_ado_records_admon_validate_street_cb);
  } // do_ajax_form_ado_records_admon_validate_street

  function do_ajax_form_ado_records_admon_validate_street_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "street";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_street_cb

  // ---------- Validate cedulatecondition
  function do_ajax_form_ado_records_admon_validate_cedulatecondition()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_cedulatecondition(var_cedulatecondition, var_script_case_init, do_ajax_form_ado_records_admon_validate_cedulatecondition_cb);
  } // do_ajax_form_ado_records_admon_validate_cedulatecondition

  function do_ajax_form_ado_records_admon_validate_cedulatecondition_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_cedulatecondition_cb

  // ---------- Validate spouse
  function do_ajax_form_ado_records_admon_validate_spouse()
  {
    var nomeCampo_spouse = "spouse";
    var var_spouse = scAjaxGetFieldText(nomeCampo_spouse);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_spouse(var_spouse, var_script_case_init, do_ajax_form_ado_records_admon_validate_spouse_cb);
  } // do_ajax_form_ado_records_admon_validate_spouse

  function do_ajax_form_ado_records_admon_validate_spouse_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "spouse";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_spouse_cb

  // ---------- Validate home
  function do_ajax_form_ado_records_admon_validate_home()
  {
    var nomeCampo_home = "home";
    var var_home = scAjaxGetFieldText(nomeCampo_home);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_home(var_home, var_script_case_init, do_ajax_form_ado_records_admon_validate_home_cb);
  } // do_ajax_form_ado_records_admon_validate_home

  function do_ajax_form_ado_records_admon_validate_home_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "home";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_home_cb

  // ---------- Validate maritalstatus
  function do_ajax_form_ado_records_admon_validate_maritalstatus()
  {
    var nomeCampo_maritalstatus = "maritalstatus";
    var var_maritalstatus = scAjaxGetFieldText(nomeCampo_maritalstatus);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_maritalstatus(var_maritalstatus, var_script_case_init, do_ajax_form_ado_records_admon_validate_maritalstatus_cb);
  } // do_ajax_form_ado_records_admon_validate_maritalstatus

  function do_ajax_form_ado_records_admon_validate_maritalstatus_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_maritalstatus_cb

  // ---------- Validate dateofidentification
  function do_ajax_form_ado_records_admon_validate_dateofidentification()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_dateofidentification(var_dateofidentification, var_script_case_init, do_ajax_form_ado_records_admon_validate_dateofidentification_cb);
  } // do_ajax_form_ado_records_admon_validate_dateofidentification

  function do_ajax_form_ado_records_admon_validate_dateofidentification_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_dateofidentification_cb

  // ---------- Validate dateofdeath
  function do_ajax_form_ado_records_admon_validate_dateofdeath()
  {
    var nomeCampo_dateofdeath = "dateofdeath";
    var var_dateofdeath = scAjaxGetFieldText(nomeCampo_dateofdeath);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_dateofdeath(var_dateofdeath, var_script_case_init, do_ajax_form_ado_records_admon_validate_dateofdeath_cb);
  } // do_ajax_form_ado_records_admon_validate_dateofdeath

  function do_ajax_form_ado_records_admon_validate_dateofdeath_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_dateofdeath_cb

  // ---------- Validate marriagedate
  function do_ajax_form_ado_records_admon_validate_marriagedate()
  {
    var nomeCampo_marriagedate = "marriagedate";
    var var_marriagedate = scAjaxGetFieldText(nomeCampo_marriagedate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_marriagedate(var_marriagedate, var_script_case_init, do_ajax_form_ado_records_admon_validate_marriagedate_cb);
  } // do_ajax_form_ado_records_admon_validate_marriagedate

  function do_ajax_form_ado_records_admon_validate_marriagedate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_marriagedate_cb

  // ---------- Validate instruction
  function do_ajax_form_ado_records_admon_validate_instruction()
  {
    var nomeCampo_instruction = "instruction";
    var var_instruction = scAjaxGetFieldText(nomeCampo_instruction);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_instruction(var_instruction, var_script_case_init, do_ajax_form_ado_records_admon_validate_instruction_cb);
  } // do_ajax_form_ado_records_admon_validate_instruction

  function do_ajax_form_ado_records_admon_validate_instruction_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_instruction_cb

  // ---------- Validate placebirth
  function do_ajax_form_ado_records_admon_validate_placebirth()
  {
    var nomeCampo_placebirth = "placebirth";
    var var_placebirth = scAjaxGetFieldText(nomeCampo_placebirth);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_placebirth(var_placebirth, var_script_case_init, do_ajax_form_ado_records_admon_validate_placebirth_cb);
  } // do_ajax_form_ado_records_admon_validate_placebirth

  function do_ajax_form_ado_records_admon_validate_placebirth_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_placebirth_cb

  // ---------- Validate nationality
  function do_ajax_form_ado_records_admon_validate_nationality()
  {
    var nomeCampo_nationality = "nationality";
    var var_nationality = scAjaxGetFieldText(nomeCampo_nationality);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_nationality(var_nationality, var_script_case_init, do_ajax_form_ado_records_admon_validate_nationality_cb);
  } // do_ajax_form_ado_records_admon_validate_nationality

  function do_ajax_form_ado_records_admon_validate_nationality_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_nationality_cb

  // ---------- Validate mothername
  function do_ajax_form_ado_records_admon_validate_mothername()
  {
    var nomeCampo_mothername = "mothername";
    var var_mothername = scAjaxGetFieldText(nomeCampo_mothername);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_mothername(var_mothername, var_script_case_init, do_ajax_form_ado_records_admon_validate_mothername_cb);
  } // do_ajax_form_ado_records_admon_validate_mothername

  function do_ajax_form_ado_records_admon_validate_mothername_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_mothername_cb

  // ---------- Validate fathername
  function do_ajax_form_ado_records_admon_validate_fathername()
  {
    var nomeCampo_fathername = "fathername";
    var var_fathername = scAjaxGetFieldText(nomeCampo_fathername);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_fathername(var_fathername, var_script_case_init, do_ajax_form_ado_records_admon_validate_fathername_cb);
  } // do_ajax_form_ado_records_admon_validate_fathername

  function do_ajax_form_ado_records_admon_validate_fathername_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_fathername_cb

  // ---------- Validate housenumber
  function do_ajax_form_ado_records_admon_validate_housenumber()
  {
    var nomeCampo_housenumber = "housenumber";
    var var_housenumber = scAjaxGetFieldText(nomeCampo_housenumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_housenumber(var_housenumber, var_script_case_init, do_ajax_form_ado_records_admon_validate_housenumber_cb);
  } // do_ajax_form_ado_records_admon_validate_housenumber

  function do_ajax_form_ado_records_admon_validate_housenumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_housenumber_cb

  // ---------- Validate profession
  function do_ajax_form_ado_records_admon_validate_profession()
  {
    var nomeCampo_profession = "profession";
    var var_profession = scAjaxGetFieldText(nomeCampo_profession);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_profession(var_profession, var_script_case_init, do_ajax_form_ado_records_admon_validate_profession_cb);
  } // do_ajax_form_ado_records_admon_validate_profession

  function do_ajax_form_ado_records_admon_validate_profession_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_profession_cb

  // ---------- Validate expeditioncity
  function do_ajax_form_ado_records_admon_validate_expeditioncity()
  {
    var nomeCampo_expeditioncity = "expeditioncity";
    var var_expeditioncity = scAjaxGetFieldText(nomeCampo_expeditioncity);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_expeditioncity(var_expeditioncity, var_script_case_init, do_ajax_form_ado_records_admon_validate_expeditioncity_cb);
  } // do_ajax_form_ado_records_admon_validate_expeditioncity

  function do_ajax_form_ado_records_admon_validate_expeditioncity_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_expeditioncity_cb

  // ---------- Validate expeditiondepartment
  function do_ajax_form_ado_records_admon_validate_expeditiondepartment()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_expeditiondepartment(var_expeditiondepartment, var_script_case_init, do_ajax_form_ado_records_admon_validate_expeditiondepartment_cb);
  } // do_ajax_form_ado_records_admon_validate_expeditiondepartment

  function do_ajax_form_ado_records_admon_validate_expeditiondepartment_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_expeditiondepartment_cb

  // ---------- Validate birthcity
  function do_ajax_form_ado_records_admon_validate_birthcity()
  {
    var nomeCampo_birthcity = "birthcity";
    var var_birthcity = scAjaxGetFieldText(nomeCampo_birthcity);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_birthcity(var_birthcity, var_script_case_init, do_ajax_form_ado_records_admon_validate_birthcity_cb);
  } // do_ajax_form_ado_records_admon_validate_birthcity

  function do_ajax_form_ado_records_admon_validate_birthcity_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_birthcity_cb

  // ---------- Validate birthdepartment
  function do_ajax_form_ado_records_admon_validate_birthdepartment()
  {
    var nomeCampo_birthdepartment = "birthdepartment";
    var var_birthdepartment = scAjaxGetFieldText(nomeCampo_birthdepartment);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_birthdepartment(var_birthdepartment, var_script_case_init, do_ajax_form_ado_records_admon_validate_birthdepartment_cb);
  } // do_ajax_form_ado_records_admon_validate_birthdepartment

  function do_ajax_form_ado_records_admon_validate_birthdepartment_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_birthdepartment_cb

  // ---------- Validate transactiontype
  function do_ajax_form_ado_records_admon_validate_transactiontype()
  {
    var nomeCampo_transactiontype = "transactiontype";
    var var_transactiontype = scAjaxGetFieldText(nomeCampo_transactiontype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_transactiontype(var_transactiontype, var_script_case_init, do_ajax_form_ado_records_admon_validate_transactiontype_cb);
  } // do_ajax_form_ado_records_admon_validate_transactiontype

  function do_ajax_form_ado_records_admon_validate_transactiontype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_transactiontype_cb

  // ---------- Validate transactiontypename
  function do_ajax_form_ado_records_admon_validate_transactiontypename()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_transactiontypename(var_transactiontypename, var_script_case_init, do_ajax_form_ado_records_admon_validate_transactiontypename_cb);
  } // do_ajax_form_ado_records_admon_validate_transactiontypename

  function do_ajax_form_ado_records_admon_validate_transactiontypename_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_transactiontypename_cb

  // ---------- Validate issuedate
  function do_ajax_form_ado_records_admon_validate_issuedate()
  {
    var nomeCampo_issuedate = "issuedate";
    var var_issuedate = scAjaxGetFieldText(nomeCampo_issuedate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_issuedate(var_issuedate, var_script_case_init, do_ajax_form_ado_records_admon_validate_issuedate_cb);
  } // do_ajax_form_ado_records_admon_validate_issuedate

  function do_ajax_form_ado_records_admon_validate_issuedate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_issuedate_cb

  // ---------- Validate barcodetext
  function do_ajax_form_ado_records_admon_validate_barcodetext()
  {
    var nomeCampo_barcodetext = "barcodetext";
    var var_barcodetext = scAjaxGetFieldText(nomeCampo_barcodetext);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_barcodetext(var_barcodetext, var_script_case_init, do_ajax_form_ado_records_admon_validate_barcodetext_cb);
  } // do_ajax_form_ado_records_admon_validate_barcodetext

  function do_ajax_form_ado_records_admon_validate_barcodetext_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_barcodetext_cb

  // ---------- Validate ocrtextsideone
  function do_ajax_form_ado_records_admon_validate_ocrtextsideone()
  {
    var nomeCampo_ocrtextsideone = "ocrtextsideone";
    var var_ocrtextsideone = scAjaxGetFieldText(nomeCampo_ocrtextsideone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_ocrtextsideone(var_ocrtextsideone, var_script_case_init, do_ajax_form_ado_records_admon_validate_ocrtextsideone_cb);
  } // do_ajax_form_ado_records_admon_validate_ocrtextsideone

  function do_ajax_form_ado_records_admon_validate_ocrtextsideone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_ocrtextsideone_cb

  // ---------- Validate ocrtextsidetwo
  function do_ajax_form_ado_records_admon_validate_ocrtextsidetwo()
  {
    var nomeCampo_ocrtextsidetwo = "ocrtextsidetwo";
    var var_ocrtextsidetwo = scAjaxGetFieldText(nomeCampo_ocrtextsidetwo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_ocrtextsidetwo(var_ocrtextsidetwo, var_script_case_init, do_ajax_form_ado_records_admon_validate_ocrtextsidetwo_cb);
  } // do_ajax_form_ado_records_admon_validate_ocrtextsidetwo

  function do_ajax_form_ado_records_admon_validate_ocrtextsidetwo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_ocrtextsidetwo_cb

  // ---------- Validate sideonewrongattempts
  function do_ajax_form_ado_records_admon_validate_sideonewrongattempts()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_sideonewrongattempts(var_sideonewrongattempts, var_script_case_init, do_ajax_form_ado_records_admon_validate_sideonewrongattempts_cb);
  } // do_ajax_form_ado_records_admon_validate_sideonewrongattempts

  function do_ajax_form_ado_records_admon_validate_sideonewrongattempts_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_sideonewrongattempts_cb

  // ---------- Validate sidetwowrongattempts
  function do_ajax_form_ado_records_admon_validate_sidetwowrongattempts()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_sidetwowrongattempts(var_sidetwowrongattempts, var_script_case_init, do_ajax_form_ado_records_admon_validate_sidetwowrongattempts_cb);
  } // do_ajax_form_ado_records_admon_validate_sidetwowrongattempts

  function do_ajax_form_ado_records_admon_validate_sidetwowrongattempts_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_sidetwowrongattempts_cb

  // ---------- Validate foundonadoalert
  function do_ajax_form_ado_records_admon_validate_foundonadoalert()
  {
    var nomeCampo_foundonadoalert = "foundonadoalert";
    var var_foundonadoalert = scAjaxGetFieldText(nomeCampo_foundonadoalert);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_foundonadoalert(var_foundonadoalert, var_script_case_init, do_ajax_form_ado_records_admon_validate_foundonadoalert_cb);
  } // do_ajax_form_ado_records_admon_validate_foundonadoalert

  function do_ajax_form_ado_records_admon_validate_foundonadoalert_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_foundonadoalert_cb

  // ---------- Validate adoprojectid
  function do_ajax_form_ado_records_admon_validate_adoprojectid()
  {
    var nomeCampo_adoprojectid = "adoprojectid";
    var var_adoprojectid = scAjaxGetFieldText(nomeCampo_adoprojectid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_adoprojectid(var_adoprojectid, var_script_case_init, do_ajax_form_ado_records_admon_validate_adoprojectid_cb);
  } // do_ajax_form_ado_records_admon_validate_adoprojectid

  function do_ajax_form_ado_records_admon_validate_adoprojectid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_adoprojectid_cb

  // ---------- Validate transactionid
  function do_ajax_form_ado_records_admon_validate_transactionid()
  {
    var nomeCampo_transactionid = "transactionid";
    var var_transactionid = scAjaxGetFieldText(nomeCampo_transactionid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_transactionid(var_transactionid, var_script_case_init, do_ajax_form_ado_records_admon_validate_transactionid_cb);
  } // do_ajax_form_ado_records_admon_validate_transactionid

  function do_ajax_form_ado_records_admon_validate_transactionid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_transactionid_cb

  // ---------- Validate productid
  function do_ajax_form_ado_records_admon_validate_productid()
  {
    var nomeCampo_productid = "productid";
    var var_productid = scAjaxGetFieldText(nomeCampo_productid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_productid(var_productid, var_script_case_init, do_ajax_form_ado_records_admon_validate_productid_cb);
  } // do_ajax_form_ado_records_admon_validate_productid

  function do_ajax_form_ado_records_admon_validate_productid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_productid_cb

  // ---------- Validate comparationfacessuccesful
  function do_ajax_form_ado_records_admon_validate_comparationfacessuccesful()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_comparationfacessuccesful(var_comparationfacessuccesful, var_script_case_init, do_ajax_form_ado_records_admon_validate_comparationfacessuccesful_cb);
  } // do_ajax_form_ado_records_admon_validate_comparationfacessuccesful

  function do_ajax_form_ado_records_admon_validate_comparationfacessuccesful_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_comparationfacessuccesful_cb

  // ---------- Validate facefound
  function do_ajax_form_ado_records_admon_validate_facefound()
  {
    var nomeCampo_facefound = "facefound";
    var var_facefound = scAjaxGetFieldText(nomeCampo_facefound);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_facefound(var_facefound, var_script_case_init, do_ajax_form_ado_records_admon_validate_facefound_cb);
  } // do_ajax_form_ado_records_admon_validate_facefound

  function do_ajax_form_ado_records_admon_validate_facefound_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_facefound_cb

  // ---------- Validate facedocumentfrontfound
  function do_ajax_form_ado_records_admon_validate_facedocumentfrontfound()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_facedocumentfrontfound(var_facedocumentfrontfound, var_script_case_init, do_ajax_form_ado_records_admon_validate_facedocumentfrontfound_cb);
  } // do_ajax_form_ado_records_admon_validate_facedocumentfrontfound

  function do_ajax_form_ado_records_admon_validate_facedocumentfrontfound_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_facedocumentfrontfound_cb

  // ---------- Validate barcodefound
  function do_ajax_form_ado_records_admon_validate_barcodefound()
  {
    var nomeCampo_barcodefound = "barcodefound";
    var var_barcodefound = scAjaxGetFieldText(nomeCampo_barcodefound);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_barcodefound(var_barcodefound, var_script_case_init, do_ajax_form_ado_records_admon_validate_barcodefound_cb);
  } // do_ajax_form_ado_records_admon_validate_barcodefound

  function do_ajax_form_ado_records_admon_validate_barcodefound_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_barcodefound_cb

  // ---------- Validate resultcomparationfaces
  function do_ajax_form_ado_records_admon_validate_resultcomparationfaces()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_resultcomparationfaces(var_resultcomparationfaces, var_script_case_init, do_ajax_form_ado_records_admon_validate_resultcomparationfaces_cb);
  } // do_ajax_form_ado_records_admon_validate_resultcomparationfaces

  function do_ajax_form_ado_records_admon_validate_resultcomparationfaces_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_resultcomparationfaces_cb

  // ---------- Validate comparationfacesaproved
  function do_ajax_form_ado_records_admon_validate_comparationfacesaproved()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_comparationfacesaproved(var_comparationfacesaproved, var_script_case_init, do_ajax_form_ado_records_admon_validate_comparationfacesaproved_cb);
  } // do_ajax_form_ado_records_admon_validate_comparationfacesaproved

  function do_ajax_form_ado_records_admon_validate_comparationfacesaproved_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_comparationfacesaproved_cb

  // ---------- Validate extras
  function do_ajax_form_ado_records_admon_validate_extras()
  {
    var nomeCampo_extras = "extras";
    var var_extras = scAjaxGetFieldText(nomeCampo_extras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_extras(var_extras, var_script_case_init, do_ajax_form_ado_records_admon_validate_extras_cb);
  } // do_ajax_form_ado_records_admon_validate_extras

  function do_ajax_form_ado_records_admon_validate_extras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "extras";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_extras_cb

  // ---------- Validate numberphone
  function do_ajax_form_ado_records_admon_validate_numberphone()
  {
    var nomeCampo_numberphone = "numberphone";
    var var_numberphone = scAjaxGetFieldText(nomeCampo_numberphone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_numberphone(var_numberphone, var_script_case_init, do_ajax_form_ado_records_admon_validate_numberphone_cb);
  } // do_ajax_form_ado_records_admon_validate_numberphone

  function do_ajax_form_ado_records_admon_validate_numberphone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_numberphone_cb

  // ---------- Validate codfingerprint
  function do_ajax_form_ado_records_admon_validate_codfingerprint()
  {
    var nomeCampo_codfingerprint = "codfingerprint";
    var var_codfingerprint = scAjaxGetFieldText(nomeCampo_codfingerprint);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_codfingerprint(var_codfingerprint, var_script_case_init, do_ajax_form_ado_records_admon_validate_codfingerprint_cb);
  } // do_ajax_form_ado_records_admon_validate_codfingerprint

  function do_ajax_form_ado_records_admon_validate_codfingerprint_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_codfingerprint_cb

  // ---------- Validate resultqrcode
  function do_ajax_form_ado_records_admon_validate_resultqrcode()
  {
    var nomeCampo_resultqrcode = "resultqrcode";
    var var_resultqrcode = scAjaxGetFieldText(nomeCampo_resultqrcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_resultqrcode(var_resultqrcode, var_script_case_init, do_ajax_form_ado_records_admon_validate_resultqrcode_cb);
  } // do_ajax_form_ado_records_admon_validate_resultqrcode

  function do_ajax_form_ado_records_admon_validate_resultqrcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_resultqrcode_cb

  // ---------- Validate dactilarcode
  function do_ajax_form_ado_records_admon_validate_dactilarcode()
  {
    var nomeCampo_dactilarcode = "dactilarcode";
    var var_dactilarcode = scAjaxGetFieldText(nomeCampo_dactilarcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_dactilarcode(var_dactilarcode, var_script_case_init, do_ajax_form_ado_records_admon_validate_dactilarcode_cb);
  } // do_ajax_form_ado_records_admon_validate_dactilarcode

  function do_ajax_form_ado_records_admon_validate_dactilarcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_dactilarcode_cb

  // ---------- Validate reponsecontrollist
  function do_ajax_form_ado_records_admon_validate_reponsecontrollist()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_reponsecontrollist(var_reponsecontrollist, var_script_case_init, do_ajax_form_ado_records_admon_validate_reponsecontrollist_cb);
  } // do_ajax_form_ado_records_admon_validate_reponsecontrollist

  function do_ajax_form_ado_records_admon_validate_reponsecontrollist_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_reponsecontrollist_cb

  // ---------- Validate images
  function do_ajax_form_ado_records_admon_validate_images()
  {
    var nomeCampo_images = "images";
    var var_images = scAjaxGetFieldText(nomeCampo_images);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_images(var_images, var_script_case_init, do_ajax_form_ado_records_admon_validate_images_cb);
  } // do_ajax_form_ado_records_admon_validate_images

  function do_ajax_form_ado_records_admon_validate_images_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "images";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_images_cb

  // ---------- Validate signeddocuments
  function do_ajax_form_ado_records_admon_validate_signeddocuments()
  {
    var nomeCampo_signeddocuments = "signeddocuments";
    var var_signeddocuments = scAjaxGetFieldText(nomeCampo_signeddocuments);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_signeddocuments(var_signeddocuments, var_script_case_init, do_ajax_form_ado_records_admon_validate_signeddocuments_cb);
  } // do_ajax_form_ado_records_admon_validate_signeddocuments

  function do_ajax_form_ado_records_admon_validate_signeddocuments_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_signeddocuments_cb

  // ---------- Validate scores
  function do_ajax_form_ado_records_admon_validate_scores()
  {
    var nomeCampo_scores = "scores";
    var var_scores = scAjaxGetFieldText(nomeCampo_scores);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_scores(var_scores, var_script_case_init, do_ajax_form_ado_records_admon_validate_scores_cb);
  } // do_ajax_form_ado_records_admon_validate_scores

  function do_ajax_form_ado_records_admon_validate_scores_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scores";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_scores_cb

  // ---------- Validate response_ani
  function do_ajax_form_ado_records_admon_validate_response_ani()
  {
    var nomeCampo_response_ani = "response_ani";
    var var_response_ani = scAjaxGetFieldText(nomeCampo_response_ani);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_response_ani(var_response_ani, var_script_case_init, do_ajax_form_ado_records_admon_validate_response_ani_cb);
  } // do_ajax_form_ado_records_admon_validate_response_ani

  function do_ajax_form_ado_records_admon_validate_response_ani_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_response_ani_cb

  // ---------- Validate parameters
  function do_ajax_form_ado_records_admon_validate_parameters()
  {
    var nomeCampo_parameters = "parameters";
    var var_parameters = scAjaxGetFieldText(nomeCampo_parameters);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_parameters(var_parameters, var_script_case_init, do_ajax_form_ado_records_admon_validate_parameters_cb);
  } // do_ajax_form_ado_records_admon_validate_parameters

  function do_ajax_form_ado_records_admon_validate_parameters_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_parameters_cb

  // ---------- Validate statesignaturedocument
  function do_ajax_form_ado_records_admon_validate_statesignaturedocument()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_statesignaturedocument(var_statesignaturedocument, var_script_case_init, do_ajax_form_ado_records_admon_validate_statesignaturedocument_cb);
  } // do_ajax_form_ado_records_admon_validate_statesignaturedocument

  function do_ajax_form_ado_records_admon_validate_statesignaturedocument_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_statesignaturedocument_cb

  // ---------- Validate json_response
  function do_ajax_form_ado_records_admon_validate_json_response()
  {
    var nomeCampo_json_response = "json_response";
    var var_json_response = scAjaxGetFieldText(nomeCampo_json_response);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_json_response(var_json_response, var_script_case_init, do_ajax_form_ado_records_admon_validate_json_response_cb);
  } // do_ajax_form_ado_records_admon_validate_json_response

  function do_ajax_form_ado_records_admon_validate_json_response_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_json_response_cb

  // ---------- Validate verifyupdate
  function do_ajax_form_ado_records_admon_validate_verifyupdate()
  {
    var nomeCampo_verifyupdate = "verifyupdate";
    var var_verifyupdate = scAjaxGetFieldText(nomeCampo_verifyupdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_verifyupdate(var_verifyupdate, var_script_case_init, do_ajax_form_ado_records_admon_validate_verifyupdate_cb);
  } // do_ajax_form_ado_records_admon_validate_verifyupdate

  function do_ajax_form_ado_records_admon_validate_verifyupdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_verifyupdate_cb

  // ---------- Validate estadoreg
  function do_ajax_form_ado_records_admon_validate_estadoreg()
  {
    var nomeCampo_estadoreg = "estadoreg";
    var var_estadoreg = scAjaxGetFieldSelect(nomeCampo_estadoreg);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_admon_validate_estadoreg(var_estadoreg, var_script_case_init, do_ajax_form_ado_records_admon_validate_estadoreg_cb);
  } // do_ajax_form_ado_records_admon_validate_estadoreg

  function do_ajax_form_ado_records_admon_validate_estadoreg_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_admon_validate_estadoreg_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_ado_records_admon_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ado_records_admon_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ado_records_admon_submit_form_cb_after_alert);
  } // do_ajax_form_ado_records_admon_submit_form_cb
  function do_ajax_form_ado_records_admon_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ado_records_admon_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ado_records_admon_navigate_form()
  {
    perform_ajax_form_ado_records_admon_navigate_form();
  }

  function perform_ajax_form_ado_records_admon_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_ado_records_admon_navigate_form(var_record, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ado_records_admon_navigate_form_cb);
  } // do_ajax_form_ado_records_admon_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_admon']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ado_records_admon_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ado_records_admon_navigate_form_cb_after_alert);
  } // do_ajax_form_ado_records_admon_navigate_form_cb
  function do_ajax_form_ado_records_admon_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_ado_records_admon_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_ado_records_admon_navigate_form_cb_after_alert
  function sc_hide_form_ado_records_admon_form()
  {
