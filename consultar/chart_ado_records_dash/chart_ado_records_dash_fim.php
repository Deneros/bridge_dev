...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____chart_ado_records_dash"]))
   {
      unset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____chart_ado_records_dash"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_ado_records_dash']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_ado_records_dash']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_ado_records_dash']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_ado_records_dash']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_ado_records_dash']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_ado_records_dash</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_ado_records_dash']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_ado_records_dash']['embutida_filho'] as $ind => $sc_init)
          {
