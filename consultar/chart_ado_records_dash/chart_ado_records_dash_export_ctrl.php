<?php
@session_start() ;
$_SESSION['scriptcase']['chart_ado_records_dash']['sc_process_barr'] = true;
require_once('../chart_ado_records_dash/index.php');
unset($_SESSION['scriptcase']['chart_ado_records_dash']['sc_process_barr']);
$ExportCtrl = new chart_ado_records_dash_export_control;
$ExportCtrl->Export_barr();

class chart_ado_records_dash_export_control
{
