<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_ado_records']['sc_process_barr'] = true;
require_once('../pdfreport_ado_records/index.php');
unset($_SESSION['scriptcase']['pdfreport_ado_records']['sc_process_barr']);
$ExportCtrl = new pdfreport_ado_records_export_control;
$ExportCtrl->Export_barr();

class pdfreport_ado_records_export_control
{
