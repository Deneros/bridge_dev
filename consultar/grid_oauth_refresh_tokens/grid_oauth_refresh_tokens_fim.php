...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_oauth_refresh_tokens"]))
   {
      unset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_oauth_refresh_tokens"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_refresh_tokens']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_oauth_refresh_tokens']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_refresh_tokens']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_oauth_refresh_tokens']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_oauth_refresh_tokens']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_oauth_refresh_tokens</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_refresh_tokens']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_oauth_refresh_tokens']['embutida_filho'] as $ind => $sc_init)
          {
