...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "transactionid";$Nm_numeric[] = "transactionid";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_password_cond" name="password_cond" onChange="nm_campos_between(document.getElementById('id_vis_password'), this, 'password')">
      ...
      <br><span id="id_hide_password"  <?php echo $str_hide_password?>><?php
      if ($password != "")
      {
      $password_look = substr($this->Db->qstr($password), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_given_name_cond" name="given_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_given_name'), this, 'given_name')">
      ...
      <br><span id="id_hide_given_name"  <?php echo $str_hide_given_name?>><?php
      if ($given_name != "")
      {
      $given_name_look = substr($this->Db->qstr($given_name), 1, -1); 
      $nmgp_def_dados = array(); 
