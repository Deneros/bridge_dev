...
<?php
   ...
   $Ord_Cmp = new grid_oauth_users_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_oauth_users_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["username"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['labels']["username"])) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['labels']["username"] : "" . $this->Nm_lang['lang_oauth_users_fld_username'] . "";
   $tab_ger_campos['name'] = "on";
   $tab_def_campos['name'] = "name";
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['labels']["name"] : "" . $this->Nm_lang['lang_oauth_users_fld_name'] . "";
   $tab_ger_campos['given_name'] = "on";
   $tab_def_campos['given_name'] = "given_name";
   $tab_labels["given_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['labels']["given_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['labels']["given_name"] : "" . $this->Nm_lang['lang_oauth_users_fld_given_name'] . "";
   $tab_ger_campos['family_name'] = "on";
   $tab_def_campos['family_name'] = "family_name";
   $tab_labels["family_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['labels']["family_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['labels']["family_name"] : "" . $this->Nm_lang['lang_oauth_users_fld_family_name'] . "";
   $tab_ger_campos['uid'] = "on";
   $tab_def_campos['uid'] = "Uid";
   $tab_labels["uid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['labels']["uid"])) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['labels']["uid"] : "" . $this->Nm_lang['lang_oauth_users_fld_Uid'] . "";
   $tab_ger_campos['transactionid'] = "on";
   $tab_def_campos['transactionid'] = "TransactionId";
   $tab_labels["transactionid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['labels']["transactionid"])) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['labels']["transactionid"] : "" . $this->Nm_lang['lang_oauth_users_fld_TransactionId'] . "";
   $tab_ger_campos['picture'] = "on";
   $tab_def_campos['picture'] = "picture";
   $tab_labels["picture"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['labels']["picture"])) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['labels']["picture"] : "" . $this->Nm_lang['lang_oauth_users_fld_picture'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_oauth_users_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_oauth_users']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
