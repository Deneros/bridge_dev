...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_oauth_users"]))
   {
      unset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_oauth_users"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_users']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_oauth_users']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_users']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_oauth_users']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_oauth_users']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_users']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_oauth_users']['embutida_filho'] as $ind => $sc_init)
          {
