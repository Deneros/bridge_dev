...
<?php
   ...
   $Ord_Cmp = new grid_oauth_scopes_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_oauth_scopes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["scope"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['labels']["scope"])) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['labels']["scope"] : "" . $this->Nm_lang['lang_oauth_scopes_fld_scope'] . "";
   $tab_ger_campos['is_default'] = "on";
   $tab_def_campos['is_default'] = "is_default";
   $tab_labels["is_default"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['labels']["is_default"])) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['labels']["is_default"] : "" . $this->Nm_lang['lang_oauth_scopes_fld_is_default'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_oauth_scopes_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_oauth_scopes']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
