...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = " #lowerI#";
      $nm_fim_lower = "#lowerF#";
      $Nm_numeric[] = "is_default";$Nm_numeric[] = "is_default";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_scope_cond" name="scope_cond" onChange="nm_campos_between(document.getElementById('id_vis_scope'), this, 'scope')">
      ...
      <br><span id="id_hide_scope"  <?php echo $str_hide_scope?>><?php
      if ($scope != "")
      {
      $scope_look = substr($this->Db->qstr($scope), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_is_default_cond" name="is_default_cond" onChange="nm_campos_between(document.getElementById('id_vis_is_default'), this, 'is_default')">
      ...
      <br><span id="id_hide_is_default"  <?php echo $str_hide_is_default?>><INPUT  type="text" id="SC_is_default" name="is_default" value="<?php echo NM_encode_input($is_default) ?>" size=3 alt="{datatype: 'integer', maxLength: 3, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
