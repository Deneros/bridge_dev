...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_oauth_scopes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_oauth_scopes"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_oauth_scopes'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_scopes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_oauth_scopes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_scopes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_oauth_scopes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_oauth_scopes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_scopes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_oauth_scopes']['embutida_filho'] as $ind => $sc_init)
          {
