<?php
class pdfreport_ado_records_logoazul_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_ado_records_logoazul']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_ado_records_logoazul", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_logoazul']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_logoazul']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_logoazul']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_logoazul']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['record'] = "{lang_ado_records_fld_Record}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['uid'] = "{lang_ado_records_fld_Uid}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['startingdate'] = "{lang_ado_records_fld_StartingDate}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['creationdate'] = "{lang_ado_records_fld_CreationDate}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['creationip'] = "{lang_ado_records_fld_CreationIP}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['documenttype'] = "{lang_ado_records_fld_DocumentType}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['idnumber'] = "{lang_ado_records_fld_IdNumber}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['firstname'] = "{lang_ado_records_fld_FirstName}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['secondname'] = "{lang_ado_records_fld_SecondName}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['firstsurname'] = "{lang_ado_records_fld_FirstSurname}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['secondsurname'] = "{lang_ado_records_fld_SecondSurname}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['gender'] = "{lang_ado_records_fld_Gender}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['birthdate'] = "{lang_ado_records_fld_BirthDate}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['placebirth'] = "{lang_ado_records_fld_PlaceBirth}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['transactiontype'] = "{lang_ado_records_fld_TransactionType}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['transactiontypename'] = "{lang_ado_records_fld_TransactionTypeName}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['issuedate'] = "{lang_ado_records_fld_IssueDate}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['adoprojectid'] = "{lang_ado_records_fld_AdoProjectId}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['transactionid'] = "{lang_ado_records_fld_TransactionId}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['productid'] = "{lang_ado_records_fld_ProductId}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['resultcomparationfaces'] = "{lang_ado_records_fld_ResultComparationFaces}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['comparationfacesaproved'] = "{lang_ado_records_fld_ComparationFacesAproved}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['extras'] = "{lang_ado_records_fld_Extras}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['response_ani'] = "{lang_ado_records_fld_Response_ANI}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['labels']['photo'] = "Photo";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_logoazul']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_logoazul']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_logoazul']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_logoazul']['qt_col_grid']) 
      {  
...
$_SESSION['scriptcase']['pdfreport_ado_records_logoazul']['contr_erro'] = 'off';
          ...
          if (!is_file($this->Ini->root  . $this->Ini->path_imag_cab . "/grp__NM__img__NM__logoempresa-397_56_NT.png"))
          { 
              $this->photo[$this->nm_grid_colunas] = "" ;  
          } 
          else 
          { 
              $this->photo[$this->nm_grid_colunas] = $this->NM_raiz_img  . $this->Ini->path_imag_cab . "/grp__NM__img__NM__logoempresa-397_56_NT.png"; 
          } 
