...
class pdfreport_ado_records_logoazul_res_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function grava_arquivo()
   {
      ...
      if ($this->New_Format)
      {
          fwrite($xml_f, "<pdfreport_ado_records_logoazul>\r\n");
      }
      if ($this->Grava_view)
      {
          ...
          if ($this->New_Format)
          {
              fwrite($xml_v, "<pdfreport_ado_records_logoazul>\r\n");
          }
      }
   ...
   function grava_linha($xml_f)
   {
      ...
      foreach ($this->array_linhas as $lines)
      {
          ...
          if (!$this->New_Format)
          {
              $xml_registro = "<pdfreport_ado_records_logoazul";
          }
          foreach ($lines as $columns)
          {
              if (0 <= $columns['level'])
