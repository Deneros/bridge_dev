  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_bolsas_admon_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_bolsas_admon_mob_form();
	}
...
?>
  ...
  // ---------- Validate bolsaid
  function do_ajax_form_bolsas_admon_mob_validate_bolsaid()
  {
    var nomeCampo_bolsaid = "bolsaid";
    var var_bolsaid = scAjaxGetFieldText(nomeCampo_bolsaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_mob_validate_bolsaid(var_bolsaid, var_script_case_init, do_ajax_form_bolsas_admon_mob_validate_bolsaid_cb);
  } // do_ajax_form_bolsas_admon_mob_validate_bolsaid

  function do_ajax_form_bolsas_admon_mob_validate_bolsaid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_mob_validate_bolsaid_cb

  // ---------- Validate clienteid
  function do_ajax_form_bolsas_admon_mob_validate_clienteid()
  {
    var nomeCampo_clienteid = "clienteid";
    var var_clienteid = scAjaxGetFieldText(nomeCampo_clienteid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_mob_validate_clienteid(var_clienteid, var_script_case_init, do_ajax_form_bolsas_admon_mob_validate_clienteid_cb);
  } // do_ajax_form_bolsas_admon_mob_validate_clienteid

  function do_ajax_form_bolsas_admon_mob_validate_clienteid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "clienteid";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_mob_validate_clienteid_cb

  // ---------- Validate cantidad
  function do_ajax_form_bolsas_admon_mob_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_mob_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_bolsas_admon_mob_validate_cantidad_cb);
  } // do_ajax_form_bolsas_admon_mob_validate_cantidad

  function do_ajax_form_bolsas_admon_mob_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_mob_validate_cantidad_cb

  // ---------- Validate saldo
  function do_ajax_form_bolsas_admon_mob_validate_saldo()
  {
    var nomeCampo_saldo = "saldo";
    var var_saldo = scAjaxGetFieldText(nomeCampo_saldo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_mob_validate_saldo(var_saldo, var_script_case_init, do_ajax_form_bolsas_admon_mob_validate_saldo_cb);
  } // do_ajax_form_bolsas_admon_mob_validate_saldo

  function do_ajax_form_bolsas_admon_mob_validate_saldo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "saldo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_mob_validate_saldo_cb

  // ---------- Validate creationfecha
  function do_ajax_form_bolsas_admon_mob_validate_creationfecha()
  {
    var nomeCampo_creationfecha = "creationfecha";
    var var_creationfecha = scAjaxGetFieldHidden(nomeCampo_creationfecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_mob_validate_creationfecha(var_creationfecha, var_script_case_init, do_ajax_form_bolsas_admon_mob_validate_creationfecha_cb);
  } // do_ajax_form_bolsas_admon_mob_validate_creationfecha

  function do_ajax_form_bolsas_admon_mob_validate_creationfecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "creationfecha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_mob_validate_creationfecha_cb

  // ---------- Validate enrollcount
  function do_ajax_form_bolsas_admon_mob_validate_enrollcount()
  {
    var nomeCampo_enrollcount = "enrollcount";
    var var_enrollcount = scAjaxGetFieldText(nomeCampo_enrollcount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_mob_validate_enrollcount(var_enrollcount, var_script_case_init, do_ajax_form_bolsas_admon_mob_validate_enrollcount_cb);
  } // do_ajax_form_bolsas_admon_mob_validate_enrollcount

  function do_ajax_form_bolsas_admon_mob_validate_enrollcount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "enrollcount";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_mob_validate_enrollcount_cb

  // ---------- Validate verifycount
  function do_ajax_form_bolsas_admon_mob_validate_verifycount()
  {
    var nomeCampo_verifycount = "verifycount";
    var var_verifycount = scAjaxGetFieldText(nomeCampo_verifycount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_mob_validate_verifycount(var_verifycount, var_script_case_init, do_ajax_form_bolsas_admon_mob_validate_verifycount_cb);
  } // do_ajax_form_bolsas_admon_mob_validate_verifycount

  function do_ajax_form_bolsas_admon_mob_validate_verifycount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "verifycount";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_mob_validate_verifycount_cb

  // ---------- Validate actualizacionfecha
  function do_ajax_form_bolsas_admon_mob_validate_actualizacionfecha()
  {
    var nomeCampo_actualizacionfecha = "actualizacionfecha";
    var var_actualizacionfecha = scAjaxGetFieldHidden(nomeCampo_actualizacionfecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_mob_validate_actualizacionfecha(var_actualizacionfecha, var_script_case_init, do_ajax_form_bolsas_admon_mob_validate_actualizacionfecha_cb);
  } // do_ajax_form_bolsas_admon_mob_validate_actualizacionfecha

  function do_ajax_form_bolsas_admon_mob_validate_actualizacionfecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "actualizacionfecha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_mob_validate_actualizacionfecha_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_bolsas_admon_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_bolsas_admon_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_bolsaid = scAjaxGetFieldText("bolsaid");
    var var_clienteid = scAjaxGetFieldText("clienteid");
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_saldo = scAjaxGetFieldText("saldo");
    var var_creationfecha = scAjaxGetFieldHidden("creationfecha");
    var var_enrollcount = scAjaxGetFieldText("enrollcount");
    var var_verifycount = scAjaxGetFieldText("verifycount");
    var var_actualizacionfecha = scAjaxGetFieldHidden("actualizacionfecha");
    ...
    scAjaxProcOn();
    x_ajax_form_bolsas_admon_mob_submit_form(var_bolsaid, var_clienteid, var_cantidad, var_saldo, var_creationfecha, var_enrollcount, var_verifycount, var_actualizacionfecha, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_bolsas_admon_mob_submit_form_cb);
  } // do_ajax_form_bolsas_admon_mob_submit_form

  function do_ajax_form_bolsas_admon_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("bolsaid");
      scAjaxHideErrorDisplay("clienteid");
      scAjaxHideErrorDisplay("cantidad");
      scAjaxHideErrorDisplay("saldo");
      scAjaxHideErrorDisplay("creationfecha");
      scAjaxHideErrorDisplay("enrollcount");
      scAjaxHideErrorDisplay("verifycount");
      scAjaxHideErrorDisplay("actualizacionfecha");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_bolsas_admon_mob_submit_form_cb_after_alert);
  } // do_ajax_form_bolsas_admon_mob_submit_form_cb
  function do_ajax_form_bolsas_admon_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_bolsas_admon_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_bolsas_admon_mob_navigate_form()
  {
    perform_ajax_form_bolsas_admon_mob_navigate_form();
  }

  function perform_ajax_form_bolsas_admon_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("verifycount");
    scAjaxHideErrorDisplay("actualizacionfecha");
    var var_bolsaid = document.F2.bolsaid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_bolsas_admon_mob_navigate_form(var_bolsaid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_bolsas_admon_mob_navigate_form_cb);
  } // do_ajax_form_bolsas_admon_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_bolsas_admon_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_bolsas_admon_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.bolsaid.value = scAjaxGetKeyValue("bolsaid");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_bolsas_admon_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_bolsas_admon_mob_navigate_form_cb
  function do_ajax_form_bolsas_admon_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_bolsas_admon_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_bolsas_admon_mob_navigate_form_cb_after_alert
  function sc_hide_form_bolsas_admon_mob_form()
  {
  ...
  ajax_field_list[0] = "bolsaid";
  ajax_field_list[1] = "clienteid";
  ajax_field_list[2] = "cantidad";
  ajax_field_list[3] = "saldo";
  ajax_field_list[4] = "creationfecha";
  ajax_field_list[5] = "enrollcount";
  ajax_field_list[6] = "verifycount";
  ajax_field_list[7] = "actualizacionfecha";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "bolsaid": {"label": "<?php echo $this->Ini->Nm_lang['lang_bolsas_fld_bolsaid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "clienteid": {"label": "<?php echo $this->Ini->Nm_lang['lang_bolsas_fld_clienteid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cantidad": {"label": "<?php echo $this->Ini->Nm_lang['lang_bolsas_fld_cantidad'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "saldo": {"label": "<?php echo $this->Ini->Nm_lang['lang_bolsas_fld_saldo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "creationfecha": {"label": "<?php echo $this->Ini->Nm_lang['lang_bolsas_fld_CreationFecha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "enrollcount": {"label": "<?php echo $this->Ini->Nm_lang['lang_bolsas_fld_EnrollCount'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "verifycount": {"label": "<?php echo $this->Ini->Nm_lang['lang_bolsas_fld_VerifyCount'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "actualizacionfecha": {"label": "<?php echo $this->Ini->Nm_lang['lang_bolsas_fld_ActualizacionFecha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "cantidad": new Array(),
    "saldo": new Array(),
    "creationfecha": new Array(),
    "enrollcount": new Array(),
    "verifycount": new Array(),
    "actualizacionfecha": new Array()
  };
  ajax_field_mult["bolsaid"][1] = "bolsaid";
  ajax_field_mult["clienteid"][1] = "clienteid";
  ajax_field_mult["cantidad"][1] = "cantidad";
  ajax_field_mult["saldo"][1] = "saldo";
  ajax_field_mult["creationfecha"][1] = "creationfecha";
  ajax_field_mult["enrollcount"][1] = "enrollcount";
  ajax_field_mult["verifycount"][1] = "verifycount";
  ajax_field_mult["actualizacionfecha"][1] = "actualizacionfecha";

  var ajax_field_id = {
    "bolsaid": new Array("hidden_field_label_bolsaid", "hidden_field_data_bolsaid"),
    "clienteid": new Array("hidden_field_label_clienteid", "hidden_field_data_clienteid"),
    ...
    "creationfecha": new Array("hidden_field_label_creationfecha", "hidden_field_data_creationfecha"),
    "enrollcount": new Array("hidden_field_label_enrollcount", "hidden_field_data_enrollcount"),
    "verifycount": new Array("hidden_field_label_verifycount", "hidden_field_data_verifycount"),
    "actualizacionfecha": new Array("hidden_field_label_actualizacionfecha", "hidden_field_data_actualizacionfecha")
  };
