  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_bolsas_admon" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_bolsas_admon_form();
	}
...
?>
  ...
  // ---------- Validate bolsaid
  function do_ajax_form_bolsas_admon_validate_bolsaid()
  {
    var nomeCampo_bolsaid = "bolsaid";
    var var_bolsaid = scAjaxGetFieldText(nomeCampo_bolsaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_validate_bolsaid(var_bolsaid, var_script_case_init, do_ajax_form_bolsas_admon_validate_bolsaid_cb);
  } // do_ajax_form_bolsas_admon_validate_bolsaid

  function do_ajax_form_bolsas_admon_validate_bolsaid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_validate_bolsaid_cb

  // ---------- Validate clienteid
  function do_ajax_form_bolsas_admon_validate_clienteid()
  {
    var nomeCampo_clienteid = "clienteid";
    var var_clienteid = scAjaxGetFieldText(nomeCampo_clienteid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_validate_clienteid(var_clienteid, var_script_case_init, do_ajax_form_bolsas_admon_validate_clienteid_cb);
  } // do_ajax_form_bolsas_admon_validate_clienteid

  function do_ajax_form_bolsas_admon_validate_clienteid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_validate_clienteid_cb

  // ---------- Validate cantidad
  function do_ajax_form_bolsas_admon_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_bolsas_admon_validate_cantidad_cb);
  } // do_ajax_form_bolsas_admon_validate_cantidad

  function do_ajax_form_bolsas_admon_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_validate_cantidad_cb

  // ---------- Validate saldo
  function do_ajax_form_bolsas_admon_validate_saldo()
  {
    var nomeCampo_saldo = "saldo";
    var var_saldo = scAjaxGetFieldText(nomeCampo_saldo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_validate_saldo(var_saldo, var_script_case_init, do_ajax_form_bolsas_admon_validate_saldo_cb);
  } // do_ajax_form_bolsas_admon_validate_saldo

  function do_ajax_form_bolsas_admon_validate_saldo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "saldo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_validate_saldo_cb

  // ---------- Validate creationfecha
  function do_ajax_form_bolsas_admon_validate_creationfecha()
  {
    var nomeCampo_creationfecha = "creationfecha";
    var var_creationfecha = scAjaxGetFieldHidden(nomeCampo_creationfecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_validate_creationfecha(var_creationfecha, var_script_case_init, do_ajax_form_bolsas_admon_validate_creationfecha_cb);
  } // do_ajax_form_bolsas_admon_validate_creationfecha

  function do_ajax_form_bolsas_admon_validate_creationfecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_validate_creationfecha_cb

  // ---------- Validate enrollcount
  function do_ajax_form_bolsas_admon_validate_enrollcount()
  {
    var nomeCampo_enrollcount = "enrollcount";
    var var_enrollcount = scAjaxGetFieldText(nomeCampo_enrollcount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_validate_enrollcount(var_enrollcount, var_script_case_init, do_ajax_form_bolsas_admon_validate_enrollcount_cb);
  } // do_ajax_form_bolsas_admon_validate_enrollcount

  function do_ajax_form_bolsas_admon_validate_enrollcount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_validate_enrollcount_cb

  // ---------- Validate verifycount
  function do_ajax_form_bolsas_admon_validate_verifycount()
  {
    var nomeCampo_verifycount = "verifycount";
    var var_verifycount = scAjaxGetFieldText(nomeCampo_verifycount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_validate_verifycount(var_verifycount, var_script_case_init, do_ajax_form_bolsas_admon_validate_verifycount_cb);
  } // do_ajax_form_bolsas_admon_validate_verifycount

  function do_ajax_form_bolsas_admon_validate_verifycount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_validate_verifycount_cb

  // ---------- Validate actualizacionfecha
  function do_ajax_form_bolsas_admon_validate_actualizacionfecha()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bolsas_admon_validate_actualizacionfecha(var_actualizacionfecha, var_script_case_init, do_ajax_form_bolsas_admon_validate_actualizacionfecha_cb);
  } // do_ajax_form_bolsas_admon_validate_actualizacionfecha

  function do_ajax_form_bolsas_admon_validate_actualizacionfecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bolsas_admon_validate_actualizacionfecha_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_bolsas_admon_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_bolsas_admon_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_bolsas_admon_submit_form(var_bolsaid, var_clienteid, var_cantidad, var_saldo, var_creationfecha, var_enrollcount, var_verifycount, var_actualizacionfecha, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_bolsas_admon_submit_form_cb);
  } // do_ajax_form_bolsas_admon_submit_form

  function do_ajax_form_bolsas_admon_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_bolsas_admon_submit_form_cb_after_alert);
  } // do_ajax_form_bolsas_admon_submit_form_cb
  function do_ajax_form_bolsas_admon_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_bolsas_admon_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_bolsas_admon_navigate_form()
  {
    perform_ajax_form_bolsas_admon_navigate_form();
  }

  function perform_ajax_form_bolsas_admon_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_bolsas_admon_navigate_form(var_bolsaid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_bolsas_admon_navigate_form_cb);
  } // do_ajax_form_bolsas_admon_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_bolsas_admon']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_bolsas_admon_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_bolsas_admon_navigate_form_cb_after_alert);
  } // do_ajax_form_bolsas_admon_navigate_form_cb
  function do_ajax_form_bolsas_admon_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_bolsas_admon_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_bolsas_admon_navigate_form_cb_after_alert
  function sc_hide_form_bolsas_admon_form()
  {
