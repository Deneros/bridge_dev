...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_ado_records_tit_dash'] . ""); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_ado_records_tit_dash'] . ""); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['embutida_pdf']))
 {
 ?>
 ...
 <style type="text/css">
  .scTabActive a { font-size: 8px }
  .scTabInactive a { font-size: 8px }
 </style>
<?php
   include_once("../_lib/css/" . $this->Ini->str_schema_all . "_tab.php");
 }
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_ado_records_dash/form_ado_records_dash_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_ado_records_dash_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_ado_records_dash_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    $vertical_center = '';
...
<?php
 include_once("form_ado_records_dash_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_ado_records_dash'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_ado_records_dash'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_record_line" id="hidden_field_data_record" style="<?php echo $sStyleHidden_record; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_record_line" style="padding: 0px">
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { 
 ?>
<span id="id_read_on_record" css_record_line" style="<?php echo $sStyleReadLab_record; ?>"><?php echo $this->form_format_readonly("record", $this->form_encode_input($this->record)); ?></span><span id="id_read_off_record" class="css_read_off_record" style="<?php echo $sStyleReadInp_record; ?>"><input type="hidden" name="record" value="<?php echo $this->form_encode_input($record) . "\">"?><span id="id_ajax_label_record"><?php echo nl2br($record); ?></span>
</span><?php } else { ?>
&nbsp;
<?php } ?>
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_record_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_record_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_startingdate_line" id="hidden_field_data_startingdate" style="<?php echo $sStyleHidden_startingdate; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_startingdate_line" style="padding: 0px"><input type="hidden" name="startingdate" value="<?php echo $this->form_encode_input($startingdate); ?>"><span id="id_ajax_label_startingdate"><?php echo nl2br($startingdate); ?></span>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idnumber_line" id="hidden_field_data_idnumber" style="<?php echo $sStyleHidden_idnumber; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idnumber_line" style="padding: 0px"><input type="hidden" name="idnumber" value="<?php echo $this->form_encode_input($idnumber); ?>"><span id="id_ajax_label_idnumber"><?php echo nl2br($idnumber); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_transactionid_line" id="hidden_field_data_transactionid" style="<?php echo $sStyleHidden_transactionid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_transactionid_line" style="padding: 0px"><input type="hidden" name="transactionid" value="<?php echo $this->form_encode_input($transactionid); ?>"><span id="id_ajax_label_transactionid"><?php echo nl2br($transactionid); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_extras_line" id="hidden_field_data_extras" style="<?php echo $sStyleHidden_extras; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_extras_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="extras" value="<?php echo $this->form_encode_input($extras); ?>"><span id="id_ajax_label_extras"><?php echo nl2br($extras); ?></span>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['run_iframe'] != "R")
{
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['btn_label']['exit'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_ado_records_dash");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_ado_records_dash");
 parent.scAjaxDetailHeight("form_ado_records_dash", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
