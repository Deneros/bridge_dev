  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ado_records_dash_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ado_records_dash_mob_form();
	}
...
?>
  ...
  // ---------- Validate record
  function do_ajax_form_ado_records_dash_mob_validate_record()
  {
    var nomeCampo_record = "record";
    var var_record = scAjaxGetFieldHidden(nomeCampo_record);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_dash_mob_validate_record(var_record, var_script_case_init, do_ajax_form_ado_records_dash_mob_validate_record_cb);
  } // do_ajax_form_ado_records_dash_mob_validate_record

  function do_ajax_form_ado_records_dash_mob_validate_record_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_dash_mob_validate_record_cb

  // ---------- Validate startingdate
  function do_ajax_form_ado_records_dash_mob_validate_startingdate()
  {
    var nomeCampo_startingdate = "startingdate";
    var var_startingdate = scAjaxGetFieldHidden(nomeCampo_startingdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_dash_mob_validate_startingdate(var_startingdate, var_script_case_init, do_ajax_form_ado_records_dash_mob_validate_startingdate_cb);
  } // do_ajax_form_ado_records_dash_mob_validate_startingdate

  function do_ajax_form_ado_records_dash_mob_validate_startingdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_dash_mob_validate_startingdate_cb

  // ---------- Validate idnumber
  function do_ajax_form_ado_records_dash_mob_validate_idnumber()
  {
    var nomeCampo_idnumber = "idnumber";
    var var_idnumber = scAjaxGetFieldHidden(nomeCampo_idnumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_dash_mob_validate_idnumber(var_idnumber, var_script_case_init, do_ajax_form_ado_records_dash_mob_validate_idnumber_cb);
  } // do_ajax_form_ado_records_dash_mob_validate_idnumber

  function do_ajax_form_ado_records_dash_mob_validate_idnumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_dash_mob_validate_idnumber_cb

  // ---------- Validate firstname
  function do_ajax_form_ado_records_dash_mob_validate_firstname()
  {
    var nomeCampo_firstname = "firstname";
    var var_firstname = scAjaxGetFieldHidden(nomeCampo_firstname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_dash_mob_validate_firstname(var_firstname, var_script_case_init, do_ajax_form_ado_records_dash_mob_validate_firstname_cb);
  } // do_ajax_form_ado_records_dash_mob_validate_firstname

  function do_ajax_form_ado_records_dash_mob_validate_firstname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_dash_mob_validate_firstname_cb

  // ---------- Validate firstsurname
  function do_ajax_form_ado_records_dash_mob_validate_firstsurname()
  {
    var nomeCampo_firstsurname = "firstsurname";
    var var_firstsurname = scAjaxGetFieldHidden(nomeCampo_firstsurname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_dash_mob_validate_firstsurname(var_firstsurname, var_script_case_init, do_ajax_form_ado_records_dash_mob_validate_firstsurname_cb);
  } // do_ajax_form_ado_records_dash_mob_validate_firstsurname

  function do_ajax_form_ado_records_dash_mob_validate_firstsurname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_dash_mob_validate_firstsurname_cb

  // ---------- Validate transactiontypename
  function do_ajax_form_ado_records_dash_mob_validate_transactiontypename()
  {
    var nomeCampo_transactiontypename = "transactiontypename";
    var var_transactiontypename = scAjaxGetFieldHidden(nomeCampo_transactiontypename);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_dash_mob_validate_transactiontypename(var_transactiontypename, var_script_case_init, do_ajax_form_ado_records_dash_mob_validate_transactiontypename_cb);
  } // do_ajax_form_ado_records_dash_mob_validate_transactiontypename

  function do_ajax_form_ado_records_dash_mob_validate_transactiontypename_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_dash_mob_validate_transactiontypename_cb

  // ---------- Validate transactionid
  function do_ajax_form_ado_records_dash_mob_validate_transactionid()
  {
    var nomeCampo_transactionid = "transactionid";
    var var_transactionid = scAjaxGetFieldHidden(nomeCampo_transactionid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_dash_mob_validate_transactionid(var_transactionid, var_script_case_init, do_ajax_form_ado_records_dash_mob_validate_transactionid_cb);
  } // do_ajax_form_ado_records_dash_mob_validate_transactionid

  function do_ajax_form_ado_records_dash_mob_validate_transactionid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_dash_mob_validate_transactionid_cb

  // ---------- Validate extras
  function do_ajax_form_ado_records_dash_mob_validate_extras()
  {
    var nomeCampo_extras = "extras";
    var var_extras = scAjaxGetFieldHidden(nomeCampo_extras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ado_records_dash_mob_validate_extras(var_extras, var_script_case_init, do_ajax_form_ado_records_dash_mob_validate_extras_cb);
  } // do_ajax_form_ado_records_dash_mob_validate_extras

  function do_ajax_form_ado_records_dash_mob_validate_extras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "extras";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ado_records_dash_mob_validate_extras_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_ado_records_dash_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ado_records_dash_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_record = scAjaxGetFieldHidden("record");
    var var_startingdate = scAjaxGetFieldHidden("startingdate");
    var var_idnumber = scAjaxGetFieldHidden("idnumber");
    var var_firstname = scAjaxGetFieldHidden("firstname");
    var var_firstsurname = scAjaxGetFieldHidden("firstsurname");
    var var_transactiontypename = scAjaxGetFieldHidden("transactiontypename");
    var var_transactionid = scAjaxGetFieldHidden("transactionid");
    var var_extras = scAjaxGetFieldHidden("extras");
    ...
    scAjaxProcOn();
    x_ajax_form_ado_records_dash_mob_submit_form(var_record, var_startingdate, var_idnumber, var_firstname, var_firstsurname, var_transactiontypename, var_transactionid, var_extras, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ado_records_dash_mob_submit_form_cb);
  } // do_ajax_form_ado_records_dash_mob_submit_form

  function do_ajax_form_ado_records_dash_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ado_records_dash_mob_submit_form_cb_after_alert);
  } // do_ajax_form_ado_records_dash_mob_submit_form_cb
  function do_ajax_form_ado_records_dash_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ado_records_dash_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ado_records_dash_mob_navigate_form()
  {
    perform_ajax_form_ado_records_dash_mob_navigate_form();
  }

  function perform_ajax_form_ado_records_dash_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_ado_records_dash_mob_navigate_form(var_record, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ado_records_dash_mob_navigate_form_cb);
  } // do_ajax_form_ado_records_dash_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ado_records_dash_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ado_records_dash_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ado_records_dash_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_ado_records_dash_mob_navigate_form_cb
  function do_ajax_form_ado_records_dash_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_ado_records_dash_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_ado_records_dash_mob_navigate_form_cb_after_alert
  function sc_hide_form_ado_records_dash_mob_form()
  {
  ...
  ajax_field_list[1] = "startingdate";
  ajax_field_list[2] = "idnumber";
  ajax_field_list[3] = "firstname";
  ajax_field_list[4] = "firstsurname";
  ajax_field_list[5] = "transactiontypename";
  ajax_field_list[6] = "transactionid";
  ajax_field_list[7] = "extras";
  ...
  var ajax_error_list = {
    ...
    "startingdate": {"label": "<?php echo $this->Ini->Nm_lang['lang_ado_records_fld_fecha_dash'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "firstname": {"label": "<?php echo $this->Ini->Nm_lang['lang_ado_records_fld_Name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "firstsurname": {"label": "<?php echo $this->Ini->Nm_lang['lang_ado_records_fld_Surname'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "transactiontypename": {"label": "<?php echo $this->Ini->Nm_lang['lang_ado_records_fld_Type'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "transactionid": {"label": "<?php echo $this->Ini->Nm_lang['lang_ado_records_fld_Transaction'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
