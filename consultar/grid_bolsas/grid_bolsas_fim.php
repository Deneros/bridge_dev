...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_bolsas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_bolsas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_bolsas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_bolsas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_bolsas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_bolsas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_bolsas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_bolsas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_bolsas']['embutida_filho'] as $ind => $sc_init)
          {
