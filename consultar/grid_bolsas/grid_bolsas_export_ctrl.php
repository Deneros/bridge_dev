<?php
@session_start() ;
$_SESSION['scriptcase']['grid_bolsas']['sc_process_barr'] = true;
require_once('../grid_bolsas/index.php');
unset($_SESSION['scriptcase']['grid_bolsas']['sc_process_barr']);
$ExportCtrl = new grid_bolsas_export_control;
$ExportCtrl->Export_barr();

class grid_bolsas_export_control
{
