...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = " #lowerI#";
      $nm_fim_lower = "#lowerF#";
      $Nm_datas[] = "CreationFecha";$Nm_datas[] = "CreationFecha";$Nm_datas[] = "ActualizacionFecha";$Nm_datas[] = "ActualizacionFecha";$Nm_numeric[] = "bolsaid";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "saldo";$Nm_numeric[] = "enrollcount";$Nm_numeric[] = "verifycount";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_saldo"  <?php echo $str_hide_saldo?>><INPUT  type="text" id="SC_saldo" name="saldo" value="<?php echo NM_encode_input($saldo) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_bolsaid_cond" name="bolsaid_cond" onChange="nm_campos_between(document.getElementById('id_vis_bolsaid'), this, 'bolsaid')">
      ...
      <br><span id="id_hide_bolsaid"  <?php echo $str_hide_bolsaid?>><INPUT  type="text" id="SC_bolsaid" name="bolsaid" value="<?php echo NM_encode_input($bolsaid) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_clienteid_cond" name="clienteid_cond" onChange="nm_campos_between(document.getElementById('id_vis_clienteid'), this, 'clienteid')">
      ...
      <br><span id="id_hide_clienteid"  <?php echo $str_hide_clienteid?>><?php
      if ($clienteid != "")
      {
      $clienteid_look = substr($this->Db->qstr($clienteid), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_cantidad_cond" name="cantidad_cond" onChange="nm_campos_between(document.getElementById('id_vis_cantidad'), this, 'cantidad')">
