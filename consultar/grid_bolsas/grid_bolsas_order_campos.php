<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_bolsas']['glo_nm_path_imag_temp'] . "/sc_apl_default_OpenIdConnect.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_bolsas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_bolsas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['bolsaid'] = "on";
   $tab_def_campos['bolsaid'] = "bolsaid";
   $tab_labels["bolsaid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["bolsaid"])) ? $_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["bolsaid"] : "" . $this->Nm_lang['lang_bolsas_fld_bolsaid'] . "";
   $tab_ger_campos['clienteid'] = "on";
   $tab_def_campos['clienteid'] = "clienteid";
   $tab_labels["clienteid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["clienteid"])) ? $_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["clienteid"] : "" . $this->Nm_lang['lang_bolsas_fld_clienteid'] . "";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["cantidad"] : "" . $this->Nm_lang['lang_bolsas_fld_cantidad'] . "";
   $tab_ger_campos['saldo'] = "on";
   $tab_def_campos['saldo'] = "saldo";
   $tab_labels["saldo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["saldo"])) ? $_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["saldo"] : "" . $this->Nm_lang['lang_bolsas_fld_saldo'] . "";
   $tab_ger_campos['enrollcount'] = "on";
   $tab_def_campos['enrollcount'] = "EnrollCount";
   $tab_labels["enrollcount"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["enrollcount"])) ? $_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["enrollcount"] : "" . $this->Nm_lang['lang_bolsas_fld_EnrollCount'] . "";
   $tab_ger_campos['verifycount'] = "on";
   $tab_def_campos['verifycount'] = "VerifyCount";
   $tab_labels["verifycount"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["verifycount"])) ? $_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["verifycount"] : "" . $this->Nm_lang['lang_bolsas_fld_VerifyCount'] . "";
   $tab_ger_campos['creationfecha'] = "on";
   $tab_def_campos['creationfecha'] = "CreationFecha";
   $tab_labels["creationfecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["creationfecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["creationfecha"] : "" . $this->Nm_lang['lang_bolsas_fld_CreationFecha'] . "";
   $tab_ger_campos['actualizacionfecha'] = "on";
   $tab_def_campos['actualizacionfecha'] = "ActualizacionFecha";
   $tab_labels["actualizacionfecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["actualizacionfecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_bolsas']['labels']["actualizacionfecha"] : "" . $this->Nm_lang['lang_bolsas_fld_ActualizacionFecha'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_bolsas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_bolsas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_bolsas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Nm_lang['lang_tbl_bolsas'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_bolsas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_bolsas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
