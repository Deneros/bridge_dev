<?php
@session_start() ;
$_SESSION['scriptcase']['chart_bolsas']['sc_process_barr'] = true;
require_once('../chart_bolsas/index.php');
unset($_SESSION['scriptcase']['chart_bolsas']['sc_process_barr']);
$ExportCtrl = new chart_bolsas_export_control;
$ExportCtrl->Export_barr();

class chart_bolsas_export_control
{
