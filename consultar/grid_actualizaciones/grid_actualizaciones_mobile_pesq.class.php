...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = " #lowerI#";
      $nm_fim_lower = "#lowerF#";
      $Nm_datas[] = "actualizaFecha";$Nm_datas[] = "actualizaFecha";$Nm_numeric[] = "actualizaid";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_actualizaid_cond" name="actualizaid_cond" onChange="nm_campos_between(document.getElementById('id_vis_actualizaid'), this, 'actualizaid')">
      ...
      <br><span id="id_hide_actualizaid"  <?php echo $str_hide_actualizaid?>><INPUT  type="text" id="SC_actualizaid" name="actualizaid" value="<?php echo NM_encode_input($actualizaid) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_oldparameters_cond" name="oldparameters_cond" onChange="nm_campos_between(document.getElementById('id_vis_oldparameters'), this, 'oldparameters')">
      ...
      <br><span id="id_hide_oldparameters"  <?php echo $str_hide_oldparameters?>><INPUT  type="text" id="SC_oldparameters" name="oldparameters" value="<?php echo NM_encode_input($oldparameters) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_currentsql_cond" name="currentsql_cond" onChange="nm_campos_between(document.getElementById('id_vis_currentsql'), this, 'currentsql')">
      ...
      <br><span id="id_hide_currentsql"  <?php echo $str_hide_currentsql?>><INPUT  type="text" id="SC_currentsql" name="currentsql" value="<?php echo NM_encode_input($currentsql) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_transactionid_cond" name="transactionid_cond" onChange="nm_campos_between(document.getElementById('id_vis_transactionid'), this, 'transactionid')">
      ...
      <br><span id="id_hide_transactionid"  <?php echo $str_hide_transactionid?>><?php
      if ($transactionid != "")
      {
      $transactionid_look = substr($this->Db->qstr($transactionid), 1, -1); 
      $nmgp_def_dados = array(); 
