<?php
@session_start() ;
$_SESSION['scriptcase']['grid_actualizaciones']['sc_process_barr'] = true;
require_once('../grid_actualizaciones/index.php');
unset($_SESSION['scriptcase']['grid_actualizaciones']['sc_process_barr']);
$ExportCtrl = new grid_actualizaciones_export_control;
$ExportCtrl->Export_barr();

class grid_actualizaciones_export_control
{
