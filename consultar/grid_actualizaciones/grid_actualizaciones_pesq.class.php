...
class grid_actualizaciones_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_actualizaciones_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_actualizaciones_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_actualizaciones_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_transactionid')
      {
          $transactionid = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_transactionid($transactionid);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      $Nm_datas[] = "actualizaFecha";$Nm_datas[] = "actualizaFecha";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_actualizaciones'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_actualizaciones/grid_actualizaciones_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_actualizaciones_ajax_search.js"></script>
 <script type="text/javascript" src="grid_actualizaciones_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_actualizaciones_message.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_actualizaid_cond#NMF#' + search_get_sel_txt('SC_actualizaid_cond') + '@NMF@';
  str_out += 'SC_actualizaid#NMF#' + search_get_text('SC_actualizaid') + '@NMF@';
  str_out += 'SC_oldparameters_cond#NMF#' + search_get_sel_txt('SC_oldparameters_cond') + '@NMF@';
  str_out += 'SC_oldparameters#NMF#' + search_get_text('SC_oldparameters') + '@NMF@';
  str_out += 'SC_currentsql_cond#NMF#' + search_get_sel_txt('SC_currentsql_cond') + '@NMF@';
  str_out += 'SC_currentsql#NMF#' + search_get_text('SC_currentsql') + '@NMF@';
  str_out += 'SC_transactionid_cond#NMF#' + search_get_sel_txt('SC_transactionid_cond') + '@NMF@';
  str_out += 'SC_transactionid#NMF#' + search_get_text('SC_transactionid') + '@NMF@';
  str_out += 'id_ac_transactionid#NMF#' + search_get_text('id_ac_transactionid') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_transactionid").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_transactionid").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_transactionid",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_transactionid").val(ui.item.value);
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_actualizaciones'] ?></div>
...
<?php
   ...
   {
      global 
             $actualizaid_cond, $actualizaid,
             $oldparameters_cond, $oldparameters,
             $currentsql_cond, $currentsql,
             $transactionid_cond, $transactionid, $transactionid_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $actualizaid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['actualizaid']; 
          $actualizaid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['actualizaid_cond']; 
          $oldparameters = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['oldparameters']; 
          $oldparameters_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['oldparameters_cond']; 
          $currentsql = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['currentsql']; 
          $currentsql_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['currentsql_cond']; 
          $transactionid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['transactionid']; 
          $transactionid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['transactionid_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['NM_operador']; 
          if (strtoupper($actualizaid_cond) != "II" && strtoupper($actualizaid_cond) != "QP" && strtoupper($actualizaid_cond) != "NP" && strtoupper($actualizaid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($actualizaid, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($actualizaid_cond) || empty($actualizaid_cond))
      {
         $actualizaid_cond = "gt";
      }
      if (!isset($oldparameters_cond) || empty($oldparameters_cond))
      {
         $oldparameters_cond = "qp";
      }
      if (!isset($currentsql_cond) || empty($currentsql_cond))
      {
         $currentsql_cond = "qp";
      }
      if (!isset($transactionid_cond) || empty($transactionid_cond))
      {
         $transactionid_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_actualizaid = (in_array($actualizaid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_oldparameters = (in_array($oldparameters_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_currentsql = (in_array($currentsql_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_transactionid = (in_array($transactionid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($actualizaid) || $actualizaid == "")
      {
          $actualizaid = "";
      }
      if (isset($actualizaid) && !empty($actualizaid))
      {
         $tmp_pos = strpos($actualizaid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $actualizaid = substr($actualizaid, 0, $tmp_pos);
         }
      }
      if (!isset($oldparameters) || $oldparameters == "")
      {
          $oldparameters = "";
      }
      if (isset($oldparameters) && !empty($oldparameters))
      {
         $tmp_pos = strpos($oldparameters, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $oldparameters = substr($oldparameters, 0, $tmp_pos);
         }
      }
      if (!isset($currentsql) || $currentsql == "")
      {
          $currentsql = "";
      }
      if (isset($currentsql) && !empty($currentsql))
      {
         $tmp_pos = strpos($currentsql, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $currentsql = substr($currentsql, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($transactionid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $transactionid = substr($transactionid, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_actualizaid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['actualizaid'])) ? $this->New_label['actualizaid'] : "" . $this->Ini->Nm_lang['lang_actualizaciones_fld_actualizaId'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_actualizaid_cond" name="actualizaid_cond" onChange="nm_campos_between(document.getElementById('id_vis_actualizaid'), this, 'actualizaid')">
       <OPTION value="gt" <?php if ("gt" == $actualizaid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $actualizaid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $actualizaid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_actualizaid" <?php echo $str_hide_actualizaid?> valign="top">
 ...
 $nmgp_tab_label .= "actualizaid?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_actualizaid" name="actualizaid" value="<?php echo NM_encode_input($actualizaid) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_oldparameters_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['oldparameters'])) ? $this->New_label['oldparameters'] : "" . $this->Ini->Nm_lang['lang_actualizaciones_fld_oldParameters'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_oldparameters_cond" name="oldparameters_cond" onChange="nm_campos_between(document.getElementById('id_vis_oldparameters'), this, 'oldparameters')">
       <OPTION value="qp" <?php if ("qp" == $oldparameters_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $oldparameters_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $oldparameters_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $oldparameters_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_oldparameters" <?php echo $str_hide_oldparameters?> valign="top">
 ...
 $nmgp_tab_label .= "oldparameters?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_oldparameters" name="oldparameters" value="<?php echo NM_encode_input($oldparameters) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
      ...
      <TD id='SC_currentsql_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['currentsql'])) ? $this->New_label['currentsql'] : "" . $this->Ini->Nm_lang['lang_actualizaciones_fld_currentSQL'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_currentsql_cond" name="currentsql_cond" onChange="nm_campos_between(document.getElementById('id_vis_currentsql'), this, 'currentsql')">
       <OPTION value="qp" <?php if ("qp" == $currentsql_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $currentsql_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $currentsql_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $currentsql_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_currentsql" <?php echo $str_hide_currentsql?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['currentsql'])) ? $this->New_label['currentsql'] : "" . $this->Ini->Nm_lang['lang_actualizaciones_fld_currentSQL'] . "";
 $nmgp_tab_label .= "currentsql?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_currentsql" name="currentsql" value="<?php echo NM_encode_input($currentsql) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
      ...
      <TD id='SC_transactionid_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['transactionid'])) ? $this->New_label['transactionid'] : "" . $this->Ini->Nm_lang['lang_actualizaciones_fld_TransactionId'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_transactionid_cond" name="transactionid_cond" onChange="nm_campos_between(document.getElementById('id_vis_transactionid'), this, 'transactionid')">
       <OPTION value="qp" <?php if ("qp" == $transactionid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $transactionid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $transactionid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $transactionid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_transactionid" <?php echo $str_hide_transactionid?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 ...
 $nmgp_tab_label .= "transactionid?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $transactionid;
      }
?>
<INPUT  type="text" id="SC_transactionid" name="transactionid" value="<?php echo NM_encode_input($transactionid) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_transactionid" name="transactionid_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_actualizaciones_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_actualizaciones']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_actualizaciones']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.actualizaid_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_actualizaid'), document.F1.actualizaid_cond, 'actualizaid');
   document.F1.actualizaid.value = "";
   document.F1.oldparameters_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_oldparameters'), document.F1.oldparameters_cond, 'oldparameters');
   document.F1.oldparameters.value = "";
   document.F1.currentsql_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_currentsql'), document.F1.currentsql_cond, 'currentsql');
   document.F1.currentsql.value = "";
   document.F1.transactionid_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_transactionid'), document.F1.transactionid_cond, 'transactionid');
   document.F1.transactionid.value = "";
   document.F1.transactionid_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_actualizaid_cond'] = 'cond';
      $tp_fields['SC_actualizaid'] = 'text';
      $tp_fields['SC_oldparameters_cond'] = 'cond';
      $tp_fields['SC_oldparameters'] = 'text';
      $tp_fields['SC_currentsql_cond'] = 'cond';
      $tp_fields['SC_currentsql'] = 'text';
      $tp_fields['SC_transactionid_cond'] = 'cond';
      $tp_fields['SC_transactionid'] = 'text_aut';
      $tp_fields['id_ac_transactionid'] = 'text_aut';
   ...
   {
      global $actualizaid_cond, $actualizaid,
             $oldparameters_cond, $oldparameters,
             $currentsql_cond, $currentsql,
             $transactionid_cond, $transactionid, $transactionid_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($transactionid_autocomp) && empty($transactionid))
      {
          $transactionid = $transactionid_autocomp;
      }
      $actualizaid_cond_salva = $actualizaid_cond; 
      if (!isset($actualizaid_input_2) || $actualizaid_input_2 == "")
      {
          $actualizaid_input_2 = $actualizaid;
      }
      $oldparameters_cond_salva = $oldparameters_cond; 
      if (!isset($oldparameters_input_2) || $oldparameters_input_2 == "")
      {
          $oldparameters_input_2 = $oldparameters;
      }
      $currentsql_cond_salva = $currentsql_cond; 
      if (!isset($currentsql_input_2) || $currentsql_input_2 == "")
      {
          $currentsql_input_2 = $currentsql;
      }
      $transactionid_cond_salva = $transactionid_cond; 
      if (!isset($transactionid_input_2) || $transactionid_input_2 == "")
      {
          $transactionid_input_2 = $transactionid;
      }
      if ($actualizaid_cond != "in")
      {
          nm_limpa_numero($actualizaid, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['actualizaid'] = $actualizaid; 
      if (is_array($actualizaid) && !empty($actualizaid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['val'][0] = $actualizaid;
      }
      elseif ($actualizaid_cond_salva == "nu" || $actualizaid_cond_salva == "nn" || $actualizaid_cond_salva == "ep" || $actualizaid_cond_salva == "ne" || !empty($actualizaid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['val'][0][0] = $actualizaid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['actualizaid_cond'] = $actualizaid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['cmp'] = "actualizaid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['opc'] = $actualizaid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq']['actualizaid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['oldparameters'] = $oldparameters; 
      if (is_array($oldparameters) && !empty($oldparameters))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['val'][0] = $oldparameters;
      }
      elseif ($oldparameters_cond_salva == "nu" || $oldparameters_cond_salva == "nn" || $oldparameters_cond_salva == "ep" || $oldparameters_cond_salva == "ne" || !empty($oldparameters))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['val'][0][0] = $oldparameters;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['oldparameters_cond'] = $oldparameters_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['cmp'] = "oldparameters"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['opc'] = $oldparameters_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq']['oldparameters'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['currentsql'] = $currentsql; 
      if (is_array($currentsql) && !empty($currentsql))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['val'][0] = $currentsql;
      }
      elseif ($currentsql_cond_salva == "nu" || $currentsql_cond_salva == "nn" || $currentsql_cond_salva == "ep" || $currentsql_cond_salva == "ne" || !empty($currentsql))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['val'][0][0] = $currentsql;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['currentsql_cond'] = $currentsql_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['cmp'] = "currentsql"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['opc'] = $currentsql_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq']['currentsql'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['transactionid'] = $transactionid; 
      if (is_array($transactionid) && !empty($transactionid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['val'][0] = $transactionid;
      }
      elseif ($transactionid_cond_salva == "nu" || $transactionid_cond_salva == "nn" || $transactionid_cond_salva == "ep" || $transactionid_cond_salva == "ne" || !empty($transactionid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['val'][0][0] = $transactionid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['transactionid_cond'] = $transactionid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['cmp'] = "transactionid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid]['opc'] = $transactionid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['grid_pesq']['transactionid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $actualizaid;
      if (strtoupper($actualizaid_cond) != "II" && strtoupper($actualizaid_cond) != "QP" && strtoupper($actualizaid_cond) != "NP" && strtoupper($actualizaid_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['actualizaid'] = $Conteudo;
      $Conteudo = $oldparameters;
      $this->cmp_formatado['oldparameters'] = $Conteudo;
      $Conteudo = $currentsql;
      $this->cmp_formatado['currentsql'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($transactionid != '') {
      $transactionid_look = substr($this->Db->qstr($transactionid), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['transactionid'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['transactionid'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['transactionid'] = $transactionid;
      }

      //----- $actualizaid
      $this->Date_part = false;
      if (isset($actualizaid) || $actualizaid_cond == "nu" || $actualizaid_cond == "nn" || $actualizaid_cond == "ep" || $actualizaid_cond == "ne")
      {
         $this->monta_condicao("actualizaId", $actualizaid_cond, $actualizaid, "", "actualizaid");
      }

      //----- $oldparameters
      $this->Date_part = false;
      if (isset($oldparameters) || $oldparameters_cond == "nu" || $oldparameters_cond == "nn" || $oldparameters_cond == "ep" || $oldparameters_cond == "ne")
      {
         $this->monta_condicao("oldParameters", $oldparameters_cond, $oldparameters, "", "oldparameters");
      }

      //----- $currentsql
      $this->Date_part = false;
      if (isset($currentsql) || $currentsql_cond == "nu" || $currentsql_cond == "nn" || $currentsql_cond == "ep" || $currentsql_cond == "ne")
      {
         $this->monta_condicao("currentSQL", $currentsql_cond, $currentsql, "", "currentsql");
      }

      //----- $transactionid
      $this->Date_part = false;
      if (isset($transactionid) || $transactionid_cond == "nu" || $transactionid_cond == "nn" || $transactionid_cond == "ep" || $transactionid_cond == "ne")
      {
         $this->monta_condicao("TransactionId", $transactionid_cond, $transactionid, "", "transactionid");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_actualizaciones']['cond_pesq'] .= $this->NM_operador;
