...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_actualizaciones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_actualizaciones"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_actualizaciones']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_actualizaciones']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_actualizaciones']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_actualizaciones']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_actualizaciones']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_actualizaciones</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_actualizaciones']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_actualizaciones']['embutida_filho'] as $ind => $sc_init)
          {
