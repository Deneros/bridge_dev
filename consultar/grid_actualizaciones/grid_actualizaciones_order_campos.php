...
<?php
   ...
   $Ord_Cmp = new grid_actualizaciones_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_actualizaciones_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['actualizaid'] = "actualizaId";
   $tab_labels["actualizaid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['labels']["actualizaid"])) ? $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['labels']["actualizaid"] : "" . $this->Nm_lang['lang_actualizaciones_fld_actualizaId'] . "";
   $tab_ger_campos['oldparameters'] = "on";
   $tab_def_campos['oldparameters'] = "oldParameters";
   $tab_labels["oldparameters"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['labels']["oldparameters"])) ? $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['labels']["oldparameters"] : "" . $this->Nm_lang['lang_actualizaciones_fld_oldParameters'] . "";
   $tab_ger_campos['currentsql'] = "on";
   $tab_def_campos['currentsql'] = "currentSQL";
   $tab_labels["currentsql"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['labels']["currentsql"])) ? $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['labels']["currentsql"] : "" . $this->Nm_lang['lang_actualizaciones_fld_currentSQL'] . "";
   $tab_ger_campos['transactionid'] = "on";
   $tab_def_campos['transactionid'] = "TransactionId";
   $tab_labels["transactionid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['labels']["transactionid"])) ? $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['labels']["transactionid"] : "" . $this->Nm_lang['lang_actualizaciones_fld_TransactionId'] . "";
   $tab_ger_campos['actualizafecha'] = "on";
   $tab_def_campos['actualizafecha'] = "actualizaFecha";
   $tab_labels["actualizafecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['labels']["actualizafecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['labels']["actualizafecha"] : "" . $this->Nm_lang['lang_actualizaciones_fld_actualizaFecha'] . "";
   $tab_ger_campos['observacion'] = "on";
   $tab_def_campos['observacion'] = "observacion";
   $tab_labels["observacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['labels']["observacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['labels']["observacion"] : "" . $this->Nm_lang['lang_actualizaciones_fld_observacion'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_actualizaciones_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_actualizaciones']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
