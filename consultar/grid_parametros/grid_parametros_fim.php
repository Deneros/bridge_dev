...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_parametros"]))
   {
      unset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_parametros"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_parametros'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_parametros']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_parametros']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_parametros']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_parametros']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_parametros']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_parametros']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_parametros']['embutida_filho'] as $ind => $sc_init)
          {
