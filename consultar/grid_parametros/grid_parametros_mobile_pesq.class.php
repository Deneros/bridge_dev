...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idparametro_cond" name="idparametro_cond" onChange="nm_campos_between(document.getElementById('id_vis_idparametro'), this, 'idparametro')">
      ...
      <br><span id="id_hide_idparametro"  <?php echo $str_hide_idparametro?>><?php
      if ($idparametro != "")
      {
      $idparametro_look = substr($this->Db->qstr($idparametro), 1, -1); 
      $nmgp_def_dados = array(); 
