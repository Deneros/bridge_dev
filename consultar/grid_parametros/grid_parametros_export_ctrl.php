<?php
@session_start() ;
$_SESSION['scriptcase']['grid_parametros']['sc_process_barr'] = true;
require_once('../grid_parametros/index.php');
unset($_SESSION['scriptcase']['grid_parametros']['sc_process_barr']);
$ExportCtrl = new grid_parametros_export_control;
$ExportCtrl->Export_barr();

class grid_parametros_export_control
{
