<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_ado_records_full']['sc_process_barr'] = true;
require_once('../pdfreport_ado_records_full/index.php');
unset($_SESSION['scriptcase']['pdfreport_ado_records_full']['sc_process_barr']);
$ExportCtrl = new pdfreport_ado_records_full_export_control;
$ExportCtrl->Export_barr();

class pdfreport_ado_records_full_export_control
{
