...
class pdfreport_ado_records_full_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          foreach ($todo as $param)
          {
               ...
               if (1 < sizeof($cadapar))
               {
                   ...
                   {
                       $_SESSION['sc_session'][$script_case_init]['pdfreport_ado_records_full']['opcao'] = $cadapar[1];
                   }
               }
          }
      }
      ...
      { 
          ...
          $this->Arq_zip    = $this->Arquivo . "_pdfreport_ado_records_full.zip";
          $this->Arquivo   .= "_pdfreport_ado_records_full" . $this->Xls_tp;
          $this->Tit_doc    = "pdfreport_ado_records_full" . $this->Xls_tp;
          $this->Tit_zip    = "pdfreport_ado_records_full.zip";
      ...
      require_once($this->Ini->path_aplicacao . "pdfreport_ado_records_full_total.class.php"); 
      $this->Tot = new pdfreport_ado_records_full_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
       $this->Tot->quebra_geral() ; 
      $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['tot_geral'][1];
   }
   //---- 
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['order_grid'];
...
$_SESSION['scriptcase']['pdfreport_ado_records_full']['contr_erro'] = 'off'; 
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['field_order'] as $Cada_col)
         { 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['embutida'])
      { 
      ...
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   function proc_label()
   ...
   function NM_export_creationdate()
   {
      ...
      if (!empty($this->creationdate))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->creationdate, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->creationdate, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- creationip
   ...
   function NM_export_documenttype()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->documenttype, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->documenttype, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- idnumber
   ...
   function NM_export_transactiontype()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->transactiontype, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->transactiontype, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- transactiontypename
   ...
   function NM_export_adoprojectid()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->adoprojectid, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->adoprojectid, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- transactionid
   ...
   function NM_export_resultcomparationfaces()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->resultcomparationfaces, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->resultcomparationfaces, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_comparationfacesaproved()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->comparationfacesaproved, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->comparationfacesaproved, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- extras
   ...
   function NM_export_response_ani()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->response_ani, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->response_ani, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- photo
   function NM_export_photo()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->photo, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->photo, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- record
   ...
   //----- creationdate
   function NM_sub_cons_creationdate()
   {
      if (!empty($this->creationdate))
      {
         if (substr($this->creationdate, 10, 1) == "-") 
         ...
         $this->creationdate = NM_charset_to_utf8($this->creationdate);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->creationdate;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- documenttype
   function NM_sub_cons_documenttype()
   {
         $this->documenttype = html_entity_decode($this->documenttype, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->documenttype = strip_tags($this->documenttype);
         $this->documenttype = NM_charset_to_utf8($this->documenttype);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->documenttype;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- transactiontype
   function NM_sub_cons_transactiontype()
   {
         $this->transactiontype = html_entity_decode($this->transactiontype, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->transactiontype = strip_tags($this->transactiontype);
         $this->transactiontype = NM_charset_to_utf8($this->transactiontype);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->transactiontype;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- adoprojectid
   function NM_sub_cons_adoprojectid()
   {
         $this->adoprojectid = html_entity_decode($this->adoprojectid, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->adoprojectid = strip_tags($this->adoprojectid);
         $this->adoprojectid = NM_charset_to_utf8($this->adoprojectid);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->adoprojectid;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- resultcomparationfaces
   function NM_sub_cons_resultcomparationfaces()
   {
         $this->resultcomparationfaces = html_entity_decode($this->resultcomparationfaces, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->resultcomparationfaces = strip_tags($this->resultcomparationfaces);
         $this->resultcomparationfaces = NM_charset_to_utf8($this->resultcomparationfaces);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->resultcomparationfaces;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- comparationfacesaproved
   function NM_sub_cons_comparationfacesaproved()
   {
         $this->comparationfacesaproved = html_entity_decode($this->comparationfacesaproved, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->comparationfacesaproved = strip_tags($this->comparationfacesaproved);
         $this->comparationfacesaproved = NM_charset_to_utf8($this->comparationfacesaproved);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->comparationfacesaproved;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- response_ani
   function NM_sub_cons_response_ani()
   {
         $this->response_ani = html_entity_decode($this->response_ani, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->response_ani = strip_tags($this->response_ani);
         $this->response_ani = NM_charset_to_utf8($this->response_ani);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->response_ani;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
         $this->photo = NM_charset_to_utf8($this->photo);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->photo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['nolabel'])
       {
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full'][$path_doc_md5][1] = $this->Tit_doc;
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_ado_records'] ?> :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
