<?php
class pdfreport_ado_records_full_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_ado_records_full']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_ado_records_full", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_pesq_filtro'];
   $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
   $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
   $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
   $_SESSION['scriptcase']['contr_link_emb'] = $this->nm_location;
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_full']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_full']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_full']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_full']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_pesq'];  
//----- 
   ...
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['record'] = "{lang_ado_records_fld_Record}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['uid'] = "{lang_ado_records_fld_Uid}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['startingdate'] = "{lang_ado_records_fld_StartingDate}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['creationdate'] = "{lang_ado_records_fld_CreationDate}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['creationip'] = "{lang_ado_records_fld_CreationIP}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['documenttype'] = "{lang_ado_records_fld_DocumentType}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['idnumber'] = "{lang_ado_records_fld_IdNumber}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['firstname'] = "{lang_ado_records_fld_FirstName}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['secondname'] = "{lang_ado_records_fld_SecondName}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['firstsurname'] = "{lang_ado_records_fld_FirstSurname}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['secondsurname'] = "{lang_ado_records_fld_SecondSurname}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['gender'] = "{lang_ado_records_fld_Gender}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['birthdate'] = "{lang_ado_records_fld_BirthDate}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['placebirth'] = "{lang_ado_records_fld_PlaceBirth}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['transactiontype'] = "{lang_ado_records_fld_TransactionType}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['transactiontypename'] = "{lang_ado_records_fld_TransactionTypeName}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['issuedate'] = "{lang_ado_records_fld_IssueDate}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['adoprojectid'] = "{lang_ado_records_fld_AdoProjectId}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['transactionid'] = "{lang_ado_records_fld_TransactionId}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['productid'] = "{lang_ado_records_fld_ProductId}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['resultcomparationfaces'] = "{lang_ado_records_fld_ResultComparationFaces}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['comparationfacesaproved'] = "{lang_ado_records_fld_ComparationFacesAproved}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['extras'] = "{lang_ado_records_fld_Extras}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['response_ani'] = "{lang_ado_records_fld_Response_ANI}";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['labels']['photo'] = "Photo";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_full']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_full']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_ado_records_full']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_ado_records_full']['qt_col_grid']) 
      {  
   ...
   $this->Lookup->lookup_gender($this->look_gender[$this->nm_grid_colunas]); 
          ...
          $_SESSION['scriptcase']['pdfreport_ado_records_full']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['pdfreport_ado_records_full']['contr_erro'] = 'off';
          ...
          $this->photo[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->photo[$this->nm_grid_colunas]);
            ...
            $cell_43 = array('posx' => '95', 'posy' => '170', 'data' => $this->SC_conv_utf8('' . $this->Ini->Nm_lang['lang_ado_records_fld_ComparationFacesSuccesful'] . ''), 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_ComparationFacesAproved = array('posx' => '136', 'posy' => '170', 'data' => $this->comparationfacesaproved[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $sbFoto = "https://verify.portal-id.com/bridge_og_ado/Records/";
            $sbFoto .= $this->idnumber[$this->nm_grid_colunas]."/".$this->transactionid[$this->nm_grid_colunas]."/clientFace.png";
