<?php
include_once('treemenu_admon_session.php');
...
$_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_prod']      = "";
$_SESSION['scriptcase']['treemenu_admon']['glo_nm_perfil']         = "";
$_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_imag_temp'] = "";
$_SESSION['scriptcase']['treemenu_admon']['glo_nm_usa_grupo']      = "";
...
//check prod
if(empty($_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_prod']))
{
   /*check prod*/$_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check tmp
if(empty($_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_imag_temp']))
{
   /*check tmp*/$_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
...
class treemenu_admon_class
{
 ...
 function treemenu_admon_menu()
 {
    global $treemenu_admon_menuData;
...
$nm_versao_sc  = "" ; 
$_SESSION['scriptcase']['treemenu_admon']['contr_erro'] = 'off';
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_treemenu_admon'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_treemenu_admon'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_treemenu_admon'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_prod'] . "/third";
$url_third      = $_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "treemenu_admon/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$path_lib_php   = $str_root . $path_link . "_lib/lib/php";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_imag_temp'];
$menu_largura   = '200';
$menu_mobile_hide          = 'N';
...
if(function_exists('set_php_timezone')) set_php_timezone('treemenu_admon');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/treemenu_admon_erro.php");
}
include_once(dirname(__FILE__) . "/treemenu_admon_erro.class.php"); 
$this->Erro = new treemenu_admon_erro();
$str_path = substr($_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['treemenu_admon']['glo_nm_conexao']);
}
/* Definiciones de las rutas */
$treemenu_admon_menuData          = array();
$treemenu_admon_menuData['path']  = array();
$treemenu_admon_menuData['url']   = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $treemenu_admon_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $treemenu_admon_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $treemenu_admon_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $treemenu_admon_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$treemenu_admon_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$treemenu_admon_menuData['url']['web']   = str_replace("\\", '/', $treemenu_admon_menuData['url']['web']);
$treemenu_admon_menuData['path']['root'] = substr($treemenu_admon_menuData['path']['sys'],  0, -1 * strlen($treemenu_admon_menuData['url']['web']));
$treemenu_admon_menuData['path']['app']  = substr($treemenu_admon_menuData['path']['sys'],  0, strrpos($treemenu_admon_menuData['path']['sys'],  '/'));
$treemenu_admon_menuData['path']['link'] = substr($treemenu_admon_menuData['path']['app'],  0, strrpos($treemenu_admon_menuData['path']['app'],  '/'));
$treemenu_admon_menuData['path']['link'] = substr($treemenu_admon_menuData['path']['link'], 0, strrpos($treemenu_admon_menuData['path']['link'], '/')) . '/';
$treemenu_admon_menuData['path']['app'] .= '/';
$treemenu_admon_menuData['url']['app']   = substr($treemenu_admon_menuData['url']['web'],  0, strrpos($treemenu_admon_menuData['url']['web'],  '/'));
$treemenu_admon_menuData['url']['link']  = substr($treemenu_admon_menuData['url']['app'],  0, strrpos($treemenu_admon_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['treemenu_admon']['glo_nm_usa_grupo'] == "S")
{
    $treemenu_admon_menuData['url']['link']  = substr($treemenu_admon_menuData['url']['link'], 0, strrpos($treemenu_admon_menuData['url']['link'], '/'));
}
$treemenu_admon_menuData['url']['link']  .= '/';
$treemenu_admon_menuData['url']['app']   .= '/';

$_SESSION['scriptcase']['treemenu_admon']['sc_apl_link'] = $treemenu_admon_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['treemenu_admon']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['treemenu_admon']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['treemenu_admon']['actual_lang']) || $_SESSION['scriptcase']['treemenu_admon']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['treemenu_admon']['actual_lang'] = $this->str_lang;
...
if ($_SESSION['scriptcase']['treemenu_admon']['glo_nm_usa_grupo'] != "S")
{
    ...
    $_SESSION['scriptcase']['menu_atual'] = "treemenu_admon";
    $_SESSION['scriptcase']['menu_apls']['treemenu_admon'] = array();
    if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
    {
        foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
        {
            if (isset($_SESSION['scriptcase']['treemenu_admon']['glo_nm_conexao']) && $_SESSION['scriptcase']['treemenu_admon']['glo_nm_conexao'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['treemenu_admon']['glo_nm_conexao'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['treemenu_admon']['glo_nm_perfil']) && $_SESSION['scriptcase']['treemenu_admon']['glo_nm_perfil'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['treemenu_admon']['glo_nm_perfil'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['treemenu_admon']['glo_con_' . $NM_con_orig]))
            {
                $_SESSION['scriptcase']['treemenu_admon']['glo_con_' . $NM_con_orig] = $NM_con_dest;
            }
        }
    }
...
if (isset($_SESSION['scriptcase']['treemenu_admon']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['treemenu_admon']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['treemenu_admon']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['treemenu_admon']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['treemenu_admon']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['treemenu_admon']['session_timeout']);
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['treemenu_admon']['session_timeout']['redir']))
{
...
if (isset($script_case_init))
{
    $_SESSION['sc_session'][1]['treemenu_admon']['init'] = $script_case_init;
}
elseif (!isset($_SESSION['sc_session'][1]['treemenu_admon']['init']))
{
    $_SESSION['sc_session'][1]['treemenu_admon']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['treemenu_admon']['init'];
...
if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'treemenu_admon'))
{
    $_SESSION['sc_session'][1]['treemenu_admon']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_treemenu_admon'] = "javascript:window.close()";
}

/* Menú de configuración de las variables */
$treemenu_admon_menuData['iframe'] = TRUE;

$treemenu_admon_menuData['height'] = '100%';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("blank_principal") . "/blank_principal_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_principal']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['blank_principal'] = "on";
    }
}
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_parametros") . "/grid_parametros_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_parametros']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_parametros'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_bolsas_admon") . "/form_bolsas_admon_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_bolsas_admon']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_bolsas_admon'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_ado_records_admon") . "/grid_ado_records_admon_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ado_records_admon']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_ado_records_admon'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_actualizaciones") . "/grid_actualizaciones_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_actualizaciones']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_actualizaciones'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
<head>
 <title><?php echo $this->Nm_lang['lang_menu_admon'] ?></title>
...
<script type="text/javascript" src="treemenu_admon_message.js"></script>
...
?> 
        ...
        <script  type="text/javascript">
                        ...
                        $(document).ready(function () {
                                ...
                                $('#css3menut').jstree({
                                        'state' : { 'key' : 'treemenu_admon', 'filter' : function (k) { delete k.core.selected; return k; } },
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_treemenu_admon'];
$treemenu_admon_menuData['data'] = array();
$nextLevelToBeWrite = false;
$str_disabled = "N";
$str_link = "treemenu_admon_form_php.php?sc_item_menu=item_5&sc_apl_menu=blank_principal&sc_apl_link=" . urlencode($treemenu_admon_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['treemenu_admon']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_principal']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_principal']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    ...
    $treemenu_admon_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->treemenu_admon_target('_self') . "\"",
        'sc_id'    => "item_5",
...
$treemenu_admon_menuData['data'][] = array(
    'label'    => "" . $this->Nm_lang['lang_menu_config'] . "",
    'level'    => "0",
    'link'     => $str_link,
    'hint'     => "" . $nm_var_hint[1] . "",
    'id'       => "item_1",
...
$str_disabled = "N";
$str_link = "treemenu_admon_form_php.php?sc_item_menu=item_2&sc_apl_menu=grid_parametros&sc_apl_link=" . urlencode($treemenu_admon_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['treemenu_admon']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_parametros']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_parametros']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    ...
    $treemenu_admon_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_parametros'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[2] . "",
        'id'       => "item_2",
...
$str_disabled = "N";
$str_link = "treemenu_admon_form_php.php?sc_item_menu=item_6&sc_apl_menu=form_bolsas_admon&sc_apl_link=" . urlencode($treemenu_admon_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['treemenu_admon']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_bolsas_admon']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_bolsas_admon']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$treemenu_admon_menuData['data'][] = array(
    'label'    => "" . $this->Nm_lang['lang_menu_operaciones'] . "",
    'level'    => "0",
    'link'     => $str_link,
    'hint'     => "" . $nm_var_hint[4] . "",
    'id'       => "item_3",
...
$str_disabled = "N";
$str_link = "treemenu_admon_form_php.php?sc_item_menu=item_4&sc_apl_menu=grid_ado_records_admon&sc_apl_link=" . urlencode($treemenu_admon_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['treemenu_admon']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ado_records_admon']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ado_records_admon']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$str_disabled = "N";
$str_link = "treemenu_admon_form_php.php?sc_item_menu=item_7&sc_apl_menu=grid_actualizaciones&sc_apl_link=" . urlencode($treemenu_admon_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['treemenu_admon']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_actualizaciones']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_actualizaciones']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    ...
    $treemenu_admon_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_menu_actualizaciones'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[6] . "",
        'id'       => "item_7",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['treemenu_admon']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['treemenu_admon']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'treemenu_admon');
    $treemenu_admon_menuData['data'] = $str_menu_usu;
}
if (is_file("treemenu_admon_help.txt"))
{
    $Arq_WebHelp = file("treemenu_admon_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $treemenu_admon_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->treemenu_admon_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'  => "text",
                    'display_position'    => "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['treemenu_admon']) && !empty($_SESSION['scriptcase']['sc_menu_del']['treemenu_admon']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($treemenu_admon_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['treemenu_admon']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($treemenu_admon_menuData['data'][$i_menu]);
       }
    ...
    $treemenu_admon_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['treemenu_admon']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['treemenu_admon']))
{
    $disable_menu = false;
    foreach ($treemenu_admon_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['treemenu_admon']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $treemenu_admon_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
<div class="scMenuTHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scMenuTHeaderFont" style="float: left; text-transform: uppercase;">   <IMG SRC="<?php echo $path_imag_cab ?>/grp__NM__img__NM__logoempresa-230_32.png" BORDER="0"/></div>
    <div class="scMenuTHeaderFont" style="float: right;"></div>
</div></div>
<?php
    $link_default = "";
    if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_principal']) && $_SESSION['scriptcase']['sc_apl_seg']['blank_principal'] == "on") 
    { 
    $_SESSION['scriptcase']['treemenu_admon']['apl_inicial'] = "";
    $link_default = " onclick=\"openMenuItem('iframe_treemenu_admon');\" item-href=\"treemenu_admon_form_php.php?sc_item_menu=treemenu_admon&sc_apl_menu=blank_principal&sc_apl_link=" . urlencode($treemenu_admon_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['treemenu_admon']['glo_nm_usa_grupo'] . "\"  item-target=\"treemenu_admon_iframe\"";
    } 
    else
    { 
        $_SESSION['scriptcase']['treemenu_admon']['apl_inicial'] = ($NM_scr_iframe != "") ? $NM_scr_iframe : "treemenu_admon_pag_ini.php";
    } 
    $_SESSION['scriptcase']['treemenu_admon']['path_link'] = $path_link;
?>
        ...
        <td class="scMenuTTableM" valign="top">
                <table cellpadding=0 cellspacing=0>
                    <tr>
                      ...
                      <?php
                      echo $this->treemenu_admon_escreveMenu($treemenu_admon_menuData['data']);
                      ?>
                            </td>
                    </tr>
                </table>
...
<div class="ui-layout-center">
  <table cellspacing=0 cellpadding=0 style="height: 100%; width: 100%" cellpadding=0 cellspacing=0>
    ...
    $(document).ready(function () {
        ...
        <iframe name="treemenu_admon_iframe" id="iframe_treemenu_admon" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;" src="<?php echo $_SESSION['scriptcase']['treemenu_admon']['apl_inicial']?>"<?php echo $link_default ?>></iframe>
<?php
?>
        </td>
      </tr>
...
Iframe_atual = "treemenu_admon_iframe";
...
<?php
 $seq = 0;
echo "Tab_iframes[" . $seq . "] = \"treemenu_admon\";\r\n";
echo "Tab_labels['treemenu_admon'] = \"\";\r\n";
echo "Tab_hints['treemenu_admon'] = \"\";\r\n";
echo "Tab_abas['treemenu_admon']   = \"none\";\r\n";
echo "Tab_refresh['treemenu_admon']   = \"\";\r\n";
echo "Tab_icons['treemenu_admon'] = \"scriptcase__NM__ico__NM__sc_menu_home_e.png\";\r\n";
echo "Tab_icons_inactive['treemenu_admon'] = \"scriptcase__NM__ico__NM__sc_menu_home_d.png\";\r\n";
echo "Tab_icon_fa['treemenu_admon']   = \"\";\r\n";
echo "Tab_icon_fa_inactive['treemenu_admon']   = \"\";\r\n";
echo "Tab_display['treemenu_admon']   = \"\";\r\n";
echo "Tab_display_position['treemenu_admon']   = \"\";\r\n";
echo "Tab_links['treemenu_admon']   = \"\";\r\n";
         $seq++;
 if(isset($treemenu_admon_menuData['data']) && !empty($treemenu_admon_menuData['data']))
 {
   foreach ($treemenu_admon_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($treemenu_admon_menuData['data_vertical']) && !empty($treemenu_admon_menuData['data_vertical']))
 {
   foreach ($treemenu_admon_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'treemenu_admon_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'treemenu_admon'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_treemenu_admon').hide();
    if (str_id == "")
    {
        $('#iframe_treemenu_admon').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="treemenu_admon_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>');
            }
            ...
            if (Tab_iframes[i] != 'treemenu_admon') 
            {
                Iframe_atual = "treemenu_admon_" + Tab_iframes[i] + '_iframe';
            }
...
{
  str_target_sv = "";
  if (str_id != "iframe_treemenu_admon")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("treemenu_admon_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_treemenu_admon', 'treemenu_admon');
    if (str_target == "treemenu_admon_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        str_target = (str_target_sv != "") ? str_target_sv : str_target;
        mudaIframe(str_id);
        if (str_id != "treemenu_admon")
        {
            $('#links_abas').css('display','');
            $('#id_links_abas').css('display','');
        }
        if (str_id != "treemenu_admon" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    if(str_target != '_blank' && $('#iframe_treemenu_admon').length)
        $('#iframe_treemenu_admon')[0].contentWindow.focus();
  }
}
<?php
if (isset($link_default) && !empty($link_default))
{
    echo "   document.getElementById('iframe_treemenu_admon').click();\r\n";
}
?>
</script>
</body>
...
/* Control de Target */
function treemenu_admon_escreveMenu($arr_menu)
{
    $aMenuItemList = array();
            ...
            <?php
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    ?>
                    <li <?php echo $iconHtml; ?> class="scMenuTItems scMenuTItem" style="<?php echo $li_style; ?>"><a href="javascript:" onclick="openMenuItem('treemenu_admon_<?php echo $aMenuItemList[$i]['id']; ?>'); <?php echo $focusFrame; ?>" item-href="<?php echo $aMenuItemList[$i]['link']; ?>" id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>"<?php echo $aMenuItemList[$i]['target']; ?> class="scMenuTItem"><?php echo $aMenuItemList[$i]['label']; ?></a>
                    <?php
                  }
                }
                if ($aMenuItemList[$i + 1] && $aMenuItemList[$i]['level'] == $aMenuItemList[$i + 1]['level']) {
...
/* Control de Target */
   function treemenu_admon_target($str_target)
   {
       global $treemenu_admon_menuData;
       ...
       elseif ($treemenu_admon_menuData['iframe'])
       {
           return 'treemenu_admon_iframe';
       }
       else
       {
           return $str_target;
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "javascript:parent.nm_out_menu('treemenu_admon_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($treemenu_admon_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['treemenu_admon']['glo_nm_usa_grupo'] . "')";  
               }
               else
               {
                    $str_line['link'] = "treemenu_admon_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($treemenu_admon_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['treemenu_admon']['glo_nm_usa_grupo'] . ""; 
               }
           }
           elseif ($arr_item['target'] == '_parent')
           {
               $str_line['link'] = "javascript:parent.nm_out_menu('" . $_SESSION['scriptcase']['sc_saida_treemenu_admon'] . "')"; 
           }
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->treemenu_admon_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['treemenu_admon']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['treemenu_admon']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['treemenu_admon']['sc_init'][$apl_menu];
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_imag_temp'] . "/sc_apl_default_OpenIdConnect.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['treemenu_admon']['glo_nm_path_imag_temp'] . "/sc_apl_default_OpenIdConnect.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "treemenu_admon") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['treemenu_admon']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['treemenu_admon']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['treemenu_admon']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_OpenIdConnect'])) {
            $_SESSION['scriptcase']['treemenu_admon']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_OpenIdConnect'];
        }
    }
}
...
$contr_treemenu_admon = new treemenu_admon_class;
$contr_treemenu_admon->treemenu_admon_menu();
