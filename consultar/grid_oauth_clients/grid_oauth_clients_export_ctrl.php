<?php
@session_start() ;
$_SESSION['scriptcase']['grid_oauth_clients']['sc_process_barr'] = true;
require_once('../grid_oauth_clients/index.php');
unset($_SESSION['scriptcase']['grid_oauth_clients']['sc_process_barr']);
$ExportCtrl = new grid_oauth_clients_export_control;
$ExportCtrl->Export_barr();

class grid_oauth_clients_export_control
{
