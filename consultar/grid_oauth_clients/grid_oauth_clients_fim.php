...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_oauth_clients"]))
   {
      unset($_SESSION['session_sec_aplicacao']["OpenIdConnect_____grid_oauth_clients"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_oauth_clients'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_clients']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_oauth_clients']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_clients']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_oauth_clients']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_oauth_clients']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_oauth_clients</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_oauth_clients']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_oauth_clients']['embutida_filho'] as $ind => $sc_init)
          {
