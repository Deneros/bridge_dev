...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_grant_types_cond" name="grant_types_cond" onChange="nm_campos_between(document.getElementById('id_vis_grant_types'), this, 'grant_types')">
      ...
      <br><span id="id_hide_grant_types"  <?php echo $str_hide_grant_types?>><?php
      if ($grant_types != "")
      {
      $grant_types_look = substr($this->Db->qstr($grant_types), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_client_secret_cond" name="client_secret_cond" onChange="nm_campos_between(document.getElementById('id_vis_client_secret'), this, 'client_secret')">
      ...
      <br><span id="id_hide_client_secret"  <?php echo $str_hide_client_secret?>><?php
      if ($client_secret != "")
      {
      $client_secret_look = substr($this->Db->qstr($client_secret), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_redirect_uri_cond" name="redirect_uri_cond" onChange="nm_campos_between(document.getElementById('id_vis_redirect_uri'), this, 'redirect_uri')">
      ...
      <br><span id="id_hide_redirect_uri"  <?php echo $str_hide_redirect_uri?>><?php
      if ($redirect_uri != "")
      {
      $redirect_uri_look = substr($this->Db->qstr($redirect_uri), 1, -1); 
      $nmgp_def_dados = array(); 
