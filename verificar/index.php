    ...
    <div class="page-wrap">
       ...
       <!-- Top -->
        ...
        <div class="box box--login-options">
            <center>
                <h1 class="heading">VERIFICACION DE IDENTIFICACION</h1>
                <?php require_once __DIR__.'/../config.php';
                if ($production){ ?>
                <form action="https://adocolumbia.ado-tech.com/Suntic/verificar-persona" method="post">
                <ul class="auth-methods">
                    ...
                    <li style=""><button type="submit" style="" value="submit">Verificar</button></li>
                </ul>
                </form>
                <?php }
                else { ?>
                <form action="https://adocolombia-qa.ado-tech.com/SunticQA/verificar-persona" method="post">
                <ul class="auth-methods">
